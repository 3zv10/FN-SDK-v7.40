...
static_assert(offsetof(AFerretVehicle_C, Hit_ZImpulseMultiplier) == 0x001438, "Member 'AFerretVehicle_C::Hit_ZImpulseMultiplier' has a wrong offset!");
static_assert(offsetof(AFerretVehicle_C, Hit_LateralImpulseMultiplier) == 0x001458, "Member 'AFerretVehicle_C::Hit_LateralImpulseMultiplier' has a wrong offset!");
static_assert(offsetof(AFerretVehicle_C, Hit_MaxImpulseVelocity) == 0x001478, "Member 'AFerretVehicle_C::Hit_MaxImpulseVelocity' has a wrong offset!");
