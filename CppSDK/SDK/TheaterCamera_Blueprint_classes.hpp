...
public:
	...
	float                                         HighestX_Value;                                    // 0x09B4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         HighestY_Value;                                    // 0x09B8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ATheaterCamera_Blueprint_C, HighestX_Value) == 0x0009B4, "Member 'ATheaterCamera_Blueprint_C::HighestX_Value' has a wrong offset!");
static_assert(offsetof(ATheaterCamera_Blueprint_C, HighestY_Value) == 0x0009B8, "Member 'ATheaterCamera_Blueprint_C::HighestY_Value' has a wrong offset!");
...
static_assert(offsetof(ATheaterCamera_Blueprint_C, TileType0_Locs) == 0x0009E0, "Member 'ATheaterCamera_Blueprint_C::TileType0_Locs' has a wrong offset!");
static_assert(offsetof(ATheaterCamera_Blueprint_C, TileType1_Locs) == 0x0009F0, "Member 'ATheaterCamera_Blueprint_C::TileType1_Locs' has a wrong offset!");
static_assert(offsetof(ATheaterCamera_Blueprint_C, TileType2_Locs) == 0x000A00, "Member 'ATheaterCamera_Blueprint_C::TileType2_Locs' has a wrong offset!");
