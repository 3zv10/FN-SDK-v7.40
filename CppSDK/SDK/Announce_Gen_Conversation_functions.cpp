...
void AAnnounce_Gen_Conversation_C::ExecuteUbergraph_Announce_Gen_Conversation(int32 EntryPoint)
{
...
// Parameters:
// const struct FFortConversationSentence& FinishingSentence                                      (BlueprintVisible, BlueprintReadOnly, Parm)
...
void AAnnounce_Gen_Conversation_C::UserConstructionScript()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Announce_Gen_Conversation_C", "UserConstructionScript");
