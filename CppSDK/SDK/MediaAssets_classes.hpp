...
public:
	...
	bool                                          DynamicRateAdjustment;                             // 0x0614(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_638[0x1E8];                                    // 0x0638(0x01E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMediaSoundComponent, Channels) == 0x000610, "Member 'UMediaSoundComponent::Channels' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, DynamicRateAdjustment) == 0x000614, "Member 'UMediaSoundComponent::DynamicRateAdjustment' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, RateAdjustmentFactor) == 0x000618, "Member 'UMediaSoundComponent::RateAdjustmentFactor' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, RateAdjustmentRange) == 0x00061C, "Member 'UMediaSoundComponent::RateAdjustmentRange' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, MediaPlayer) == 0x000630, "Member 'UMediaSoundComponent::MediaPlayer' has a wrong offset!");
...
static_assert(sizeof(UTimeSynchronizableMediaSource) == 0x000040, "Wrong size on UTimeSynchronizableMediaSource");
static_assert(offsetof(UTimeSynchronizableMediaSource, bUseTimeSynchronization) == 0x000038, "Member 'UTimeSynchronizableMediaSource::bUseTimeSynchronization' has a wrong offset!");
