...
static_assert(offsetof(GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned, CallFunc_Conv_VectorToRotator_ReturnValue1) == 0x000128, "Member 'GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned::CallFunc_Conv_VectorToRotator_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned, CallFunc_GetSocketLocation_ReturnValue1) == 0x0001C4, "Member 'GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned::CallFunc_GetSocketLocation_ReturnValue1' has a wrong offset!");
static_assert(offsetof(GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned, CallFunc_Subtract_VectorVector_ReturnValue1) == 0x0001D0, "Member 'GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned::CallFunc_Subtract_VectorVector_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned, CallFunc_K2_SetRelativeLocation_SweepHitResult) == 0x00020C, "Member 'GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned::CallFunc_K2_SetRelativeLocation_SweepHitResult' has a wrong offset!");
