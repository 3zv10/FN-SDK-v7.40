...
static_assert(sizeof(PowerWidget_C_ExecuteUbergraph_PowerWidget) == 0x0002A0, "Wrong size on PowerWidget_C_ExecuteUbergraph_PowerWidget");
...
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, CallFunc_GetContext_ReturnValue) == 0x000208, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, CallFunc_SetState_PassThrough) == 0x000210, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::CallFunc_SetState_PassThrough' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, CallFunc_GetPartyMemberDisplayState_ReturnValue) == 0x000211, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::CallFunc_GetPartyMemberDisplayState_ReturnValue' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, K2Node_SwitchEnum_CmpSuccess) == 0x000212, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, K2Node_Event_IsDesignTime) == 0x000213, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, CallFunc_SetState_PassThrough1) == 0x000214, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::CallFunc_SetState_PassThrough1' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, K2Node_Select_Default) == 0x000215, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, K2Node_MakeStruct_SlateBrush) == 0x000218, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::K2Node_MakeStruct_SlateBrush' has a wrong offset!");
...
static_assert(sizeof(PowerWidget_C_OnPlayerInfoChanged) == 0x000200, "Wrong size on PowerWidget_C_OnPlayerInfoChanged");
...
static_assert(sizeof(PowerWidget_C_GetPowerRatingTooltipWidget) == 0x000070, "Wrong size on PowerWidget_C_GetPowerRatingTooltipWidget");
...
static_assert(offsetof(PowerWidget_C_GetPowerRatingTooltipWidget, K2Node_MakeArray_Array) == 0x000008, "Member 'PowerWidget_C_GetPowerRatingTooltipWidget::K2Node_MakeArray_Array' has a wrong offset!");
...
static_assert(offsetof(PowerWidget_C_GetPowerRatingTooltipWidget, CallFunc_Format_ReturnValue) == 0x000020, "Member 'PowerWidget_C_GetPowerRatingTooltipWidget::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_GetPowerRatingTooltipWidget, CallFunc_GetCurrentInputType_ReturnValue) == 0x000038, "Member 'PowerWidget_C_GetPowerRatingTooltipWidget::CallFunc_GetCurrentInputType_ReturnValue' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_GetPowerRatingTooltipWidget, CallFunc_GetOwningPlayer_ReturnValue) == 0x000040, "Member 'PowerWidget_C_GetPowerRatingTooltipWidget::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_GetPowerRatingTooltipWidget, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000048, "Member 'PowerWidget_C_GetPowerRatingTooltipWidget::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_GetPowerRatingTooltipWidget, CallFunc_MakeLiteralText_ReturnValue) == 0x000050, "Member 'PowerWidget_C_GetPowerRatingTooltipWidget::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_GetPowerRatingTooltipWidget, CallFunc_Create_Basic_Tooltip_Output) == 0x000068, "Member 'PowerWidget_C_GetPowerRatingTooltipWidget::CallFunc_Create_Basic_Tooltip_Output' has a wrong offset!");
...
// 0x0030 (0x0030 - 0x0000)
struct PowerWidget_C_Get_RatingValue_Large final
{
public:
	class FText                                   ReturnValue;                                       // 0x0000(0x0018)(Parm, OutParm, ReturnParm)
	class FText                                   CallFunc_GetText_ReturnValue;                      // 0x0018(0x0018)()
};
static_assert(alignof(PowerWidget_C_Get_RatingValue_Large) == 0x000008, "Wrong alignment on PowerWidget_C_Get_RatingValue_Large");
static_assert(sizeof(PowerWidget_C_Get_RatingValue_Large) == 0x000030, "Wrong size on PowerWidget_C_Get_RatingValue_Large");
static_assert(offsetof(PowerWidget_C_Get_RatingValue_Large, ReturnValue) == 0x000000, "Member 'PowerWidget_C_Get_RatingValue_Large::ReturnValue' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_Get_RatingValue_Large, CallFunc_GetText_ReturnValue) == 0x000018, "Member 'PowerWidget_C_Get_RatingValue_Large::CallFunc_GetText_ReturnValue' has a wrong offset!");
