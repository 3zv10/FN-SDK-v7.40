...
static_assert(sizeof(AB_Pistol_SixShooter_Athena_C) == 0x000DF8, "Wrong size on AB_Pistol_SixShooter_Athena_C");
static_assert(offsetof(AB_Pistol_SixShooter_Athena_C, Reload_QuickReload) == 0x000DE8, "Member 'AB_Pistol_SixShooter_Athena_C::Reload_QuickReload' has a wrong offset!");
static_assert(offsetof(AB_Pistol_SixShooter_Athena_C, Reload_Ammo) == 0x000DF0, "Member 'AB_Pistol_SixShooter_Athena_C::Reload_Ammo' has a wrong offset!");
