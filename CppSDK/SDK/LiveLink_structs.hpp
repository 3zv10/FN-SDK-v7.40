...
static_assert(sizeof(FAnimNode_LiveLinkPose) == 0x000038, "Wrong size on FAnimNode_LiveLinkPose");
static_assert(offsetof(FAnimNode_LiveLinkPose, SubjectName) == 0x000010, "Member 'FAnimNode_LiveLinkPose::SubjectName' has a wrong offset!");
static_assert(offsetof(FAnimNode_LiveLinkPose, RetargetAsset) == 0x000018, "Member 'FAnimNode_LiveLinkPose::RetargetAsset' has a wrong offset!");
static_assert(offsetof(FAnimNode_LiveLinkPose, CurrentRetargetAsset) == 0x000020, "Member 'FAnimNode_LiveLinkPose::CurrentRetargetAsset' has a wrong offset!");
...
static_assert(sizeof(FLiveLinkInstanceProxy) == 0x0006D0, "Wrong size on FLiveLinkInstanceProxy");
...
static_assert(sizeof(FMovieSceneLiveLinkTemplateData) == 0x0000C8, "Wrong size on FMovieSceneLiveLinkTemplateData");
...
static_assert(sizeof(FMovieSceneLiveLinkSectionTemplate) == 0x000110, "Wrong size on FMovieSceneLiveLinkSectionTemplate");
