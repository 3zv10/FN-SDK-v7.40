...
public:
	...
	TDelegate<void(class FName PlaylistName, const struct FGameplayTagContainer& PlaylistContextTags)> K2Node_CreateDelegate_OutputDelegate1; // 0x0220(0x0010)(ZeroConstructor, NoDestructor)
