...
static_assert(offsetof(ItemDescriptionDetailWidget_C_ExecuteUbergraph_ItemDescriptionDetailWidget, Temp_bool_Variable1) == 0x000098, "Member 'ItemDescriptionDetailWidget_C_ExecuteUbergraph_ItemDescriptionDetailWidget::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(ItemDescriptionDetailWidget_C_ExecuteUbergraph_ItemDescriptionDetailWidget, K2Node_Select1_Default) == 0x00009A, "Member 'ItemDescriptionDetailWidget_C_ExecuteUbergraph_ItemDescriptionDetailWidget::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(offsetof(ItemDescriptionDetailWidget_C_UpdateQuantityTextBlock, CallFunc_GetNumInStack_ReturnValue) == 0x000000, "Member 'ItemDescriptionDetailWidget_C_UpdateQuantityTextBlock::CallFunc_GetNumInStack_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemDescriptionDetailWidget_C_UpdateQuantityTextBlock, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x000005, "Member 'ItemDescriptionDetailWidget_C_UpdateQuantityTextBlock::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemDescriptionDetailWidget_C_UpdateQuantityTextBlock, CallFunc_Format_ReturnValue) == 0x000070, "Member 'ItemDescriptionDetailWidget_C_UpdateQuantityTextBlock::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemDescriptionDetailWidget_C_UpdateQuantityTextBlock, CallFunc_IsValid_ReturnValue) == 0x000088, "Member 'ItemDescriptionDetailWidget_C_UpdateQuantityTextBlock::CallFunc_IsValid_ReturnValue' has a wrong offset!");
