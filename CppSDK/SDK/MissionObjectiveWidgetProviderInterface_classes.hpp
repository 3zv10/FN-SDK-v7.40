...
static_assert(alignof(IMissionObjectiveWidgetProviderInterface_C) == 0x000001, "Wrong alignment on IMissionObjectiveWidgetProviderInterface_C");
static_assert(sizeof(IMissionObjectiveWidgetProviderInterface_C) == 0x000001, "Wrong size on IMissionObjectiveWidgetProviderInterface_C");
