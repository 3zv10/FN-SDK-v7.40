...
static_assert(alignof(UGCN_C_LightningStrike_C) == 0x000008, "Wrong alignment on UGCN_C_LightningStrike_C");
static_assert(sizeof(UGCN_C_LightningStrike_C) == 0x0001A0, "Wrong size on UGCN_C_LightningStrike_C");
