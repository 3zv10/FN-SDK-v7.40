...
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_GetHitResult_ReturnValue) == 0x0000C4, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_GetHitResult_ReturnValue' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_bBlockingHit) == 0x00014C, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_bBlockingHit' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_bInitialOverlap) == 0x00014D, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_bInitialOverlap' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_Time) == 0x000150, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_Time' has a wrong offset!");
static_assert(offsetof(ThrowingStarTest_C_OnExecute, CallFunc_BreakHitResult_Distance) == 0x000154, "Member 'ThrowingStarTest_C_OnExecute::CallFunc_BreakHitResult_Distance' has a wrong offset!");
