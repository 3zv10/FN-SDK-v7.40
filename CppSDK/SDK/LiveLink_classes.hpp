...
static_assert(sizeof(UMovieSceneLiveLinkSection) == 0x0001A8, "Wrong size on UMovieSceneLiveLinkSection");
...
static_assert(offsetof(UMovieSceneLiveLinkSection, PropertyFloatChannels) == 0x000198, "Member 'UMovieSceneLiveLinkSection::PropertyFloatChannels' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneLiveLinkTrack) == 0x000080, "Wrong size on UMovieSceneLiveLinkTrack");
