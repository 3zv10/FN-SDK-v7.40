...
static_assert(offsetof(B_Rifle_Sniper_Heavy_Athena_C_CalculateTraceDistance, CallFunc_Add_VectorVector_ReturnValue1) == 0x000074, "Member 'B_Rifle_Sniper_Heavy_Athena_C_CalculateTraceDistance::CallFunc_Add_VectorVector_ReturnValue1' has a wrong offset!");
static_assert(offsetof(B_Rifle_Sniper_Heavy_Athena_C_CalculateTraceDistance, CallFunc_Add_VectorVector_ReturnValue2) == 0x000080, "Member 'B_Rifle_Sniper_Heavy_Athena_C_CalculateTraceDistance::CallFunc_Add_VectorVector_ReturnValue2' has a wrong offset!");
static_assert(offsetof(B_Rifle_Sniper_Heavy_Athena_C_CalculateTraceDistance, CallFunc_Add_VectorVector_ReturnValue3) == 0x00008C, "Member 'B_Rifle_Sniper_Heavy_Athena_C_CalculateTraceDistance::CallFunc_Add_VectorVector_ReturnValue3' has a wrong offset!");
static_assert(offsetof(B_Rifle_Sniper_Heavy_Athena_C_CalculateTraceDistance, CallFunc_Add_VectorVector_ReturnValue4) == 0x000098, "Member 'B_Rifle_Sniper_Heavy_Athena_C_CalculateTraceDistance::CallFunc_Add_VectorVector_ReturnValue4' has a wrong offset!");
static_assert(offsetof(B_Rifle_Sniper_Heavy_Athena_C_CalculateTraceDistance, CallFunc_Add_VectorVector_ReturnValue5) == 0x0000A4, "Member 'B_Rifle_Sniper_Heavy_Athena_C_CalculateTraceDistance::CallFunc_Add_VectorVector_ReturnValue5' has a wrong offset!");
