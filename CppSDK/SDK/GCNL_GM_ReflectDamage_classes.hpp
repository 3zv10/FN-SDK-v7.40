...
static_assert(sizeof(AGCNL_GM_ReflectDamage_C) == 0x000438, "Wrong size on AGCNL_GM_ReflectDamage_C");
static_assert(offsetof(AGCNL_GM_ReflectDamage_C, UberGraphFrame) == 0x000428, "Member 'AGCNL_GM_ReflectDamage_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCNL_GM_ReflectDamage_C, ParticleMeshLength) == 0x000430, "Member 'AGCNL_GM_ReflectDamage_C::ParticleMeshLength' has a wrong offset!");
