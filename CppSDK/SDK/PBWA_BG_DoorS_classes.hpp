...
static_assert(alignof(APBWA_BG_DoorS_C) == 0x000008, "Wrong alignment on APBWA_BG_DoorS_C");
static_assert(sizeof(APBWA_BG_DoorS_C) == 0x000CE8, "Wrong size on APBWA_BG_DoorS_C");
