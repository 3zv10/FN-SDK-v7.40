...
public:
	...
	bool                                          bOverrideQuantity;                                 // 0x0289(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
...
static_assert(offsetof(UItemCountOverCost_C, bOverrideQuantity) == 0x000289, "Member 'UItemCountOverCost_C::bOverrideQuantity' has a wrong offset!");
