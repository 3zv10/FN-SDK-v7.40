...
void UItemInspectUpgradeCallout_C::SetButtonsEnabled(bool bIsEnabled_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ItemInspectUpgradeCallout_C", "SetButtonsEnabled");

	Params::ItemInspectUpgradeCallout_C_SetButtonsEnabled Parms{};
