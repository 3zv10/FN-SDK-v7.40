...
static_assert(alignof(Rewards_Header_C_FadeInSubHeader) == 0x000008, "Wrong alignment on Rewards_Header_C_FadeInSubHeader");
static_assert(sizeof(Rewards_Header_C_FadeInSubHeader) == 0x000028, "Wrong size on Rewards_Header_C_FadeInSubHeader");
...
static_assert(offsetof(Rewards_Header_C_FadeInSubHeader, CallFunc_GetRenderOpacity_ReturnValue) == 0x000010, "Member 'Rewards_Header_C_FadeInSubHeader::CallFunc_GetRenderOpacity_ReturnValue' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_FadeInSubHeader, CallFunc_PlayAnimation_ReturnValue) == 0x000018, "Member 'Rewards_Header_C_FadeInSubHeader::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_FadeInSubHeader, CallFunc_BooleanAND_ReturnValue) == 0x000020, "Member 'Rewards_Header_C_FadeInSubHeader::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(Rewards_Header_C_PopulateFromRewardType) == 0x000188, "Wrong size on Rewards_Header_C_PopulateFromRewardType");
...
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_SwitchEnum1_CmpSuccess) == 0x000021, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_SwitchEnum1_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_DynamicCast_AsFort_Reward_Item_Cache_Data) == 0x000028, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_DynamicCast_AsFort_Reward_Item_Cache_Data' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_DynamicCast_bSuccess) == 0x000030, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, CallFunc_IsValid_ReturnValue) == 0x000031, "Member 'Rewards_Header_C_PopulateFromRewardType::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, CallFunc_GetDisplayName_ReturnValue) == 0x000038, "Member 'Rewards_Header_C_PopulateFromRewardType::CallFunc_GetDisplayName_ReturnValue' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_MakeStruct_FormatArgumentData) == 0x000050, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_MakeArray_Array) == 0x000090, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, CallFunc_Format_ReturnValue) == 0x0000A0, "Member 'Rewards_Header_C_PopulateFromRewardType::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_MakeStruct_FormatArgumentData1) == 0x0000B8, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_MakeArray_Array1) == 0x0000F8, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_MakeArray_Array1' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_MakeStruct_FormatArgumentData2) == 0x000108, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_MakeStruct_FormatArgumentData2' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, CallFunc_Format_ReturnValue1) == 0x000148, "Member 'Rewards_Header_C_PopulateFromRewardType::CallFunc_Format_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_MakeArray_Array2) == 0x000160, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_MakeArray_Array2' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, CallFunc_Format_ReturnValue2) == 0x000170, "Member 'Rewards_Header_C_PopulateFromRewardType::CallFunc_Format_ReturnValue2' has a wrong offset!");
...
static_assert(alignof(Rewards_Header_C_SkipFadeInSubHeaderAnimation) == 0x000001, "Wrong alignment on Rewards_Header_C_SkipFadeInSubHeaderAnimation");
static_assert(sizeof(Rewards_Header_C_SkipFadeInSubHeaderAnimation) == 0x000001, "Wrong size on Rewards_Header_C_SkipFadeInSubHeaderAnimation");
static_assert(offsetof(Rewards_Header_C_SkipFadeInSubHeaderAnimation, CallFunc_IsAnimationPlaying_ReturnValue) == 0x000000, "Member 'Rewards_Header_C_SkipFadeInSubHeaderAnimation::CallFunc_IsAnimationPlaying_ReturnValue' has a wrong offset!");
