...
static_assert(sizeof(UGA_Athena_TowerGrenadeWithTrajectory_C) == 0x000C68, "Wrong size on UGA_Athena_TowerGrenadeWithTrajectory_C");
static_assert(offsetof(UGA_Athena_TowerGrenadeWithTrajectory_C, UberGraphFrame_GA_Athena_TowerGrenadeWithTrajectory_C) == 0x000C38, "Member 'UGA_Athena_TowerGrenadeWithTrajectory_C::UberGraphFrame_GA_Athena_TowerGrenadeWithTrajectory_C' has a wrong offset!");
static_assert(offsetof(UGA_Athena_TowerGrenadeWithTrajectory_C, ProjectileTrajectoryRed) == 0x000C40, "Member 'UGA_Athena_TowerGrenadeWithTrajectory_C::ProjectileTrajectoryRed' has a wrong offset!");
static_assert(offsetof(UGA_Athena_TowerGrenadeWithTrajectory_C, TrajectoryIndicatorRedClass) == 0x000C48, "Member 'UGA_Athena_TowerGrenadeWithTrajectory_C::TrajectoryIndicatorRedClass' has a wrong offset!");
static_assert(offsetof(UGA_Athena_TowerGrenadeWithTrajectory_C, ObjectiveStat) == 0x000C50, "Member 'UGA_Athena_TowerGrenadeWithTrajectory_C::ObjectiveStat' has a wrong offset!");
static_assert(offsetof(UGA_Athena_TowerGrenadeWithTrajectory_C, QuestItemUsePortafort) == 0x000C60, "Member 'UGA_Athena_TowerGrenadeWithTrajectory_C::QuestItemUsePortafort' has a wrong offset!");
