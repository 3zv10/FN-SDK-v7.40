...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GA_Athena_UtilityGrenade_WithTrajectory_C">();
	}
...
static_assert(sizeof(UGA_Athena_UtilityGrenade_WithTrajectory_C) == 0x000C38, "Wrong size on UGA_Athena_UtilityGrenade_WithTrajectory_C");
