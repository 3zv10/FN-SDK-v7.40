...
static_assert(alignof(AGC_Husk_Slow_C) == 0x000008, "Wrong alignment on AGC_Husk_Slow_C");
static_assert(sizeof(AGC_Husk_Slow_C) == 0x0004A0, "Wrong size on AGC_Husk_Slow_C");
static_assert(offsetof(AGC_Husk_Slow_C, UberGraphFrame) == 0x000428, "Member 'AGC_Husk_Slow_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGC_Husk_Slow_C, Chains) == 0x000430, "Member 'AGC_Husk_Slow_C::Chains' has a wrong offset!");
static_assert(offsetof(AGC_Husk_Slow_C, Cuff_r) == 0x000438, "Member 'AGC_Husk_Slow_C::Cuff_r' has a wrong offset!");
static_assert(offsetof(AGC_Husk_Slow_C, Cuff_l) == 0x000440, "Member 'AGC_Husk_Slow_C::Cuff_l' has a wrong offset!");
static_assert(offsetof(AGC_Husk_Slow_C, CuffLock_Lock_Control_756030714F08FF79667CC399F84C6DB9) == 0x000448, "Member 'AGC_Husk_Slow_C::CuffLock_Lock_Control_756030714F08FF79667CC399F84C6DB9' has a wrong offset!");
static_assert(offsetof(AGC_Husk_Slow_C, CuffLock_Rotation_Control_756030714F08FF79667CC399F84C6DB9) == 0x00044C, "Member 'AGC_Husk_Slow_C::CuffLock_Rotation_Control_756030714F08FF79667CC399F84C6DB9' has a wrong offset!");
static_assert(offsetof(AGC_Husk_Slow_C, CuffLock__Direction_756030714F08FF79667CC399F84C6DB9) == 0x000450, "Member 'AGC_Husk_Slow_C::CuffLock__Direction_756030714F08FF79667CC399F84C6DB9' has a wrong offset!");
static_assert(offsetof(AGC_Husk_Slow_C, CuffLock) == 0x000458, "Member 'AGC_Husk_Slow_C::CuffLock' has a wrong offset!");
static_assert(offsetof(AGC_Husk_Slow_C, My_Target) == 0x000460, "Member 'AGC_Husk_Slow_C::My_Target' has a wrong offset!");
static_assert(offsetof(AGC_Husk_Slow_C, Cuff_L_MID) == 0x000468, "Member 'AGC_Husk_Slow_C::Cuff_L_MID' has a wrong offset!");
static_assert(offsetof(AGC_Husk_Slow_C, Cuff_R_MID) == 0x000470, "Member 'AGC_Husk_Slow_C::Cuff_R_MID' has a wrong offset!");
static_assert(offsetof(AGC_Husk_Slow_C, Activate_Time_Scale) == 0x000478, "Member 'AGC_Husk_Slow_C::Activate_Time_Scale' has a wrong offset!");
static_assert(offsetof(AGC_Husk_Slow_C, Chains_MID) == 0x000480, "Member 'AGC_Husk_Slow_C::Chains_MID' has a wrong offset!");
static_assert(offsetof(AGC_Husk_Slow_C, Shackle_Scale) == 0x000488, "Member 'AGC_Husk_Slow_C::Shackle_Scale' has a wrong offset!");
static_assert(offsetof(AGC_Husk_Slow_C, Mesh_from_Pawn) == 0x000498, "Member 'AGC_Husk_Slow_C::Mesh_from_Pawn' has a wrong offset!");
