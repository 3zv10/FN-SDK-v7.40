...
void UCreativeMyIslandModal_C::SetUpOnClosedDelegates()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CreativeMyIslandModal_C", "SetUpOnClosedDelegates");
...
void UCreativeMyIslandModal_C::BndEvt__Description_K2Node_ComponentBoundEvent_7_CommonButtonClicked__DelegateSignature(class UCommonButton* Button)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CreativeMyIslandModal_C", "BndEvt__Description_K2Node_ComponentBoundEvent_7_CommonButtonClicked__DelegateSignature");

	Params::CreativeMyIslandModal_C_BndEvt__Description_K2Node_ComponentBoundEvent_7_CommonButtonClicked__DelegateSignature Parms{};
...
void UCreativeMyIslandModal_C::PassInputModeToActivePanel(bool bUsingGamepad)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CreativeMyIslandModal_C", "PassInputModeToActivePanel");

	Params::CreativeMyIslandModal_C_PassInputModeToActivePanel Parms{};
