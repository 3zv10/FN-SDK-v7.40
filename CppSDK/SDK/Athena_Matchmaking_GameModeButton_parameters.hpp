...
static_assert(offsetof(Athena_Matchmaking_GameModeButton_C_SetupGameModeButton, bIsEnabled_0) == 0x000008, "Member 'Athena_Matchmaking_GameModeButton_C_SetupGameModeButton::bIsEnabled_0' has a wrong offset!");
