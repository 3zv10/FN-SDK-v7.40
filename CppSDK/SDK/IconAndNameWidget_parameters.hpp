...
static_assert(offsetof(IconAndNameWidget_C_ExecuteUbergraph_IconAndNameWidget, Temp_byte_Variable1) == 0x000006, "Member 'IconAndNameWidget_C_ExecuteUbergraph_IconAndNameWidget::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(IconAndNameWidget_C_ExecuteUbergraph_IconAndNameWidget, Temp_bool_Variable1) == 0x000007, "Member 'IconAndNameWidget_C_ExecuteUbergraph_IconAndNameWidget::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(IconAndNameWidget_C_ExecuteUbergraph_IconAndNameWidget, Temp_class_Variable1) == 0x000010, "Member 'IconAndNameWidget_C_ExecuteUbergraph_IconAndNameWidget::Temp_class_Variable1' has a wrong offset!");
...
static_assert(offsetof(IconAndNameWidget_C_ExecuteUbergraph_IconAndNameWidget, K2Node_Select1_Default) == 0x000028, "Member 'IconAndNameWidget_C_ExecuteUbergraph_IconAndNameWidget::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(offsetof(IconAndNameWidget_C_Setup_Border, Temp_byte_Variable1) == 0x000002, "Member 'IconAndNameWidget_C_Setup_Border::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(IconAndNameWidget_C_Setup_Text, Temp_byte_Variable1) == 0x000002, "Member 'IconAndNameWidget_C_Setup_Text::Temp_byte_Variable1' has a wrong offset!");
