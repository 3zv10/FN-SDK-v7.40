...
static_assert(offsetof(ChatMessageEntry_C_HandleSelectionStatusChanged, Temp_float_Variable1) == 0x000008, "Member 'ChatMessageEntry_C_HandleSelectionStatusChanged::Temp_float_Variable1' has a wrong offset!");
