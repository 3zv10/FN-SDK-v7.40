...
#include "GCNL_Athena_FestivusFireworks_classes.hpp"
#include "GCNL_Athena_FestivusFireworks_parameters.hpp"
...
void AGCNL_Athena_FestivusFireworks_C::ExecuteUbergraph_GCNL_Athena_FestivusFireworks(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_Athena_FestivusFireworks_C", "ExecuteUbergraph_GCNL_Athena_FestivusFireworks");

	Params::GCNL_Athena_FestivusFireworks_C_ExecuteUbergraph_GCNL_Athena_FestivusFireworks Parms{};
...
void AGCNL_Athena_FestivusFireworks_C::OnRemoval(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_Athena_FestivusFireworks_C", "OnRemoval");

	Params::GCNL_Athena_FestivusFireworks_C_OnRemoval Parms{};
...
void AGCNL_Athena_FestivusFireworks_C::OnLoopingStart(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_Athena_FestivusFireworks_C", "OnLoopingStart");

	Params::GCNL_Athena_FestivusFireworks_C_OnLoopingStart Parms{};
...
void AGCNL_Athena_FestivusFireworks_C::UserConstructionScript()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_Athena_FestivusFireworks_C", "UserConstructionScript");
