...
static_assert(sizeof(APBWA_S1_Solid_C) == 0x000D10, "Wrong size on APBWA_S1_Solid_C");
static_assert(offsetof(APBWA_S1_Solid_C, UberGraphFrame) == 0x000CE8, "Member 'APBWA_S1_Solid_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(APBWA_S1_Solid_C, GnomeWallChance) == 0x000CF0, "Member 'APBWA_S1_Solid_C::GnomeWallChance' has a wrong offset!");
static_assert(offsetof(APBWA_S1_Solid_C, GnomeWallMax) == 0x000CF4, "Member 'APBWA_S1_Solid_C::GnomeWallMax' has a wrong offset!");
static_assert(offsetof(APBWA_S1_Solid_C, Gnomed) == 0x000CF8, "Member 'APBWA_S1_Solid_C::Gnomed' has a wrong offset!");
static_assert(offsetof(APBWA_S1_Solid_C, GnomeMaterial) == 0x000D00, "Member 'APBWA_S1_Solid_C::GnomeMaterial' has a wrong offset!");
static_assert(offsetof(APBWA_S1_Solid_C, GnomeWall) == 0x000D08, "Member 'APBWA_S1_Solid_C::GnomeWall' has a wrong offset!");
