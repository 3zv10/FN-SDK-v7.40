...
// Package: GA_Athena_FragGrenade_WithTrajectory
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GA_Athena_FragGrenade_WithTrajectory_C">();
	}
	static class UGA_Athena_FragGrenade_WithTrajectory_C* GetDefaultObj()
	{
...
static_assert(sizeof(UGA_Athena_FragGrenade_WithTrajectory_C) == 0x000C38, "Wrong size on UGA_Athena_FragGrenade_WithTrajectory_C");
