...
public:
	...
	TDelegate<void(const struct FProjectileEventData& ProjectileData)> K2Node_CreateDelegate_OutputDelegate1; // 0x0014(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(const struct FProjectileEventData& ProjectileData)> K2Node_CreateDelegate_OutputDelegate2; // 0x0078(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(const struct FProjectileEventData& ProjectileData)> K2Node_CreateDelegate_OutputDelegate5; // 0x0298(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(const struct FProjectileEventData& ProjectileData)> K2Node_CreateDelegate_OutputDelegate6; // 0x03D0(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(const struct FProjectileEventData& ProjectileData)> K2Node_CreateDelegate_OutputDelegate7; // 0x03E8(0x0010)(ZeroConstructor, NoDestructor)
