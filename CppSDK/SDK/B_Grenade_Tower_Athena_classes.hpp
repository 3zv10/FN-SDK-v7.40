...
static_assert(alignof(AB_Grenade_Tower_Athena_C) == 0x000008, "Wrong alignment on AB_Grenade_Tower_Athena_C");
static_assert(sizeof(AB_Grenade_Tower_Athena_C) == 0x000988, "Wrong size on AB_Grenade_Tower_Athena_C");
