...
static_assert(offsetof(Lightbox_C_ExecuteUbergraph_Lightbox, Temp_byte_Variable1) == 0x000005, "Member 'Lightbox_C_ExecuteUbergraph_Lightbox::Temp_byte_Variable1' has a wrong offset!");
