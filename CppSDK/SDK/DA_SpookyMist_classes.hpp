...
static_assert(sizeof(ADA_SpookyMist_C) == 0x000A50, "Wrong size on ADA_SpookyMist_C");
static_assert(offsetof(ADA_SpookyMist_C, UberGraphFrame) == 0x000A10, "Member 'ADA_SpookyMist_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ADA_SpookyMist_C, CanCancelAbility) == 0x000A18, "Member 'ADA_SpookyMist_C::CanCancelAbility' has a wrong offset!");
static_assert(offsetof(ADA_SpookyMist_C, CanCancelTimer) == 0x000A20, "Member 'ADA_SpookyMist_C::CanCancelTimer' has a wrong offset!");
static_assert(offsetof(ADA_SpookyMist_C, CancelDelay) == 0x000A28, "Member 'ADA_SpookyMist_C::CancelDelay' has a wrong offset!");
static_assert(offsetof(ADA_SpookyMist_C, PlayerPawn) == 0x000A48, "Member 'ADA_SpookyMist_C::PlayerPawn' has a wrong offset!");
