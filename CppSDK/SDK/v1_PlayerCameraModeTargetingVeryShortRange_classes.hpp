...
static_assert(alignof(Uv1_PlayerCameraModeTargetingVeryShortRange_C) == 0x000010, "Wrong alignment on Uv1_PlayerCameraModeTargetingVeryShortRange_C");
static_assert(sizeof(Uv1_PlayerCameraModeTargetingVeryShortRange_C) == 0x000C50, "Wrong size on Uv1_PlayerCameraModeTargetingVeryShortRange_C");
