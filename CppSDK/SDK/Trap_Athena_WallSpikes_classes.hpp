...
static_assert(sizeof(ATrap_Athena_WallSpikes_C) == 0x000E40, "Wrong size on ATrap_Athena_WallSpikes_C");
static_assert(offsetof(ATrap_Athena_WallSpikes_C, UberGraphFrame_Trap_Athena_WallSpikes_C) == 0x000E38, "Member 'ATrap_Athena_WallSpikes_C::UberGraphFrame_Trap_Athena_WallSpikes_C' has a wrong offset!");
