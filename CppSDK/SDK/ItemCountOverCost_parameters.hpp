...
static_assert(offsetof(ItemCountOverCost_C_Get_Meets_Criteria_Color, CallFunc_HasRequired_bHasRequired) == 0x000024, "Member 'ItemCountOverCost_C_Get_Meets_Criteria_Color::CallFunc_HasRequired_bHasRequired' has a wrong offset!");
static_assert(offsetof(ItemCountOverCost_C_Get_Meets_Criteria_Color, CallFunc_Not_PreBool_ReturnValue) == 0x000025, "Member 'ItemCountOverCost_C_Get_Meets_Criteria_Color::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemCountOverCost_C_Update, Temp_byte_Variable1) == 0x000002, "Member 'ItemCountOverCost_C_Update::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(ItemCountOverCost_C_Update, Temp_bool_Variable1) == 0x000003, "Member 'ItemCountOverCost_C_Update::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(ItemCountOverCost_C_Update, Temp_byte_Variable2) == 0x000004, "Member 'ItemCountOverCost_C_Update::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(ItemCountOverCost_C_Update, Temp_byte_Variable3) == 0x000005, "Member 'ItemCountOverCost_C_Update::Temp_byte_Variable3' has a wrong offset!");
static_assert(offsetof(ItemCountOverCost_C_Update, CallFunc_Calculate_Total_Item_Def_in_Inventory_Count) == 0x000008, "Member 'ItemCountOverCost_C_Update::CallFunc_Calculate_Total_Item_Def_in_Inventory_Count' has a wrong offset!");
static_assert(offsetof(ItemCountOverCost_C_Update, CallFunc_Get_Meets_Criteria_Color_ReturnValue) == 0x00000C, "Member 'ItemCountOverCost_C_Update::CallFunc_Get_Meets_Criteria_Color_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemCountOverCost_C_Update, K2Node_Select1_Default) == 0x000049, "Member 'ItemCountOverCost_C_Update::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(offsetof(ItemCountOverCost_C_Update, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x000070, "Member 'ItemCountOverCost_C_Update::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(ItemCountOverCost_C_Calculate_Total_Item_Def_in_Inventory, CallFunc_Add_IntInt_ReturnValue1) == 0x000050, "Member 'ItemCountOverCost_C_Calculate_Total_Item_Def_in_Inventory::CallFunc_Add_IntInt_ReturnValue1' has a wrong offset!");
...
static_assert(alignof(ItemCountOverCost_C_HasRequired) == 0x000001, "Wrong alignment on ItemCountOverCost_C_HasRequired");
static_assert(sizeof(ItemCountOverCost_C_HasRequired) == 0x000002, "Wrong size on ItemCountOverCost_C_HasRequired");
static_assert(offsetof(ItemCountOverCost_C_HasRequired, bHasRequired) == 0x000000, "Member 'ItemCountOverCost_C_HasRequired::bHasRequired' has a wrong offset!");
static_assert(offsetof(ItemCountOverCost_C_HasRequired, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x000001, "Member 'ItemCountOverCost_C_HasRequired::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
