...
public:
	...
	TArray<class ABP_FortniteLobbyLightSwitcher_C*> CallFunc_GetAllActorsOfClass_OutActors1;         // 0x0040(0x0010)(ZeroConstructor, ReferenceParm)
	class ABP_FortniteLobbyLightSwitcher_C*       CallFunc_Array_Get_Item1;                          // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(SpecialEventsCamera_Blueprint_C_ExecuteUbergraph_SpecialEventsCamera_Blueprint, Temp_int_Loop_Counter_Variable1) == 0x000010, "Member 'SpecialEventsCamera_Blueprint_C_ExecuteUbergraph_SpecialEventsCamera_Blueprint::Temp_int_Loop_Counter_Variable1' has a wrong offset!");
static_assert(offsetof(SpecialEventsCamera_Blueprint_C_ExecuteUbergraph_SpecialEventsCamera_Blueprint, CallFunc_Add_IntInt_ReturnValue1) == 0x000014, "Member 'SpecialEventsCamera_Blueprint_C_ExecuteUbergraph_SpecialEventsCamera_Blueprint::CallFunc_Add_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(SpecialEventsCamera_Blueprint_C_ExecuteUbergraph_SpecialEventsCamera_Blueprint, Temp_int_Array_Index_Variable1) == 0x000018, "Member 'SpecialEventsCamera_Blueprint_C_ExecuteUbergraph_SpecialEventsCamera_Blueprint::Temp_int_Array_Index_Variable1' has a wrong offset!");
...
static_assert(offsetof(SpecialEventsCamera_Blueprint_C_ExecuteUbergraph_SpecialEventsCamera_Blueprint, CallFunc_GetAllActorsOfClass_OutActors1) == 0x000040, "Member 'SpecialEventsCamera_Blueprint_C_ExecuteUbergraph_SpecialEventsCamera_Blueprint::CallFunc_GetAllActorsOfClass_OutActors1' has a wrong offset!");
