...
public:
	...
	UMulticastDelegateProperty_                   OnRecepientVoted;                                  // 0x03D0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	UMulticastDelegateProperty_                   OnVoteLockedOut;                                   // 0x0430(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	UMulticastDelegateProperty_                   OnVoteResultFinished;                              // 0x0458(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	UMulticastDelegateProperty_                   OnMissionActivateNoVote;                           // 0x0478(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(UMissionVotingDetailsPanel_C) == 0x000488, "Wrong size on UMissionVotingDetailsPanel_C");
static_assert(offsetof(UMissionVotingDetailsPanel_C, UberGraphFrame) == 0x000260, "Member 'UMissionVotingDetailsPanel_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, HideVoteResultAnimation) == 0x000268, "Member 'UMissionVotingDetailsPanel_C::HideVoteResultAnimation' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, ShowVoteResultAnimation) == 0x000270, "Member 'UMissionVotingDetailsPanel_C::ShowVoteResultAnimation' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, Open_Timer) == 0x000278, "Member 'UMissionVotingDetailsPanel_C::Open_Timer' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, Close_Details_Panel) == 0x000280, "Member 'UMissionVotingDetailsPanel_C::Close_Details_Panel' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, Open_Details_Panel) == 0x000288, "Member 'UMissionVotingDetailsPanel_C::Open_Details_Panel' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, VoteResultAnimation_UNUSED) == 0x000290, "Member 'UMissionVotingDetailsPanel_C::VoteResultAnimation_UNUSED' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, AvailableBluGlo) == 0x000298, "Member 'UMissionVotingDetailsPanel_C::AvailableBluGlo' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, BluGloCostBox) == 0x0002A0, "Member 'UMissionVotingDetailsPanel_C::BluGloCostBox' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, CounterBackgroundGlow) == 0x0002A8, "Member 'UMissionVotingDetailsPanel_C::CounterBackgroundGlow' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, Image_0) == 0x0002B0, "Member 'UMissionVotingDetailsPanel_C::Image_0' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, Image_1) == 0x0002B8, "Member 'UMissionVotingDetailsPanel_C::Image_1' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, Image_2) == 0x0002C0, "Member 'UMissionVotingDetailsPanel_C::Image_2' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, Image_3) == 0x0002C8, "Member 'UMissionVotingDetailsPanel_C::Image_3' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, InstigatorTimeRemainingImage) == 0x0002D0, "Member 'UMissionVotingDetailsPanel_C::InstigatorTimeRemainingImage' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, InstigatorVoteTimer) == 0x0002D8, "Member 'UMissionVotingDetailsPanel_C::InstigatorVoteTimer' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, NotVotedPanel) == 0x0002E0, "Member 'UMissionVotingDetailsPanel_C::NotVotedPanel' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, NoVoteButton) == 0x0002E8, "Member 'UMissionVotingDetailsPanel_C::NoVoteButton' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, NoVoteCount) == 0x0002F0, "Member 'UMissionVotingDetailsPanel_C::NoVoteCount' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, NoVoteRequiredBox) == 0x0002F8, "Member 'UMissionVotingDetailsPanel_C::NoVoteRequiredBox' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, ObjectiveReadyTimer) == 0x000300, "Member 'UMissionVotingDetailsPanel_C::ObjectiveReadyTimer' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, PanelSwitcher) == 0x000308, "Member 'UMissionVotingDetailsPanel_C::PanelSwitcher' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, PanelTitle) == 0x000310, "Member 'UMissionVotingDetailsPanel_C::PanelTitle' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, PendingVoteDescription) == 0x000318, "Member 'UMissionVotingDetailsPanel_C::PendingVoteDescription' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, PendingVoteTitle) == 0x000320, "Member 'UMissionVotingDetailsPanel_C::PendingVoteTitle' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, ReceipientTimeRemainingImage) == 0x000328, "Member 'UMissionVotingDetailsPanel_C::ReceipientTimeRemainingImage' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, ReceipientVoteTime) == 0x000330, "Member 'UMissionVotingDetailsPanel_C::ReceipientVoteTime' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, RequiredBluGlo) == 0x000338, "Member 'UMissionVotingDetailsPanel_C::RequiredBluGlo' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, StartVoteButton) == 0x000340, "Member 'UMissionVotingDetailsPanel_C::StartVoteButton' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, StartVotePanel) == 0x000348, "Member 'UMissionVotingDetailsPanel_C::StartVotePanel' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, TimeTypeIcon) == 0x000350, "Member 'UMissionVotingDetailsPanel_C::TimeTypeIcon' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, TimeTypeIcon_1) == 0x000358, "Member 'UMissionVotingDetailsPanel_C::TimeTypeIcon_1' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, Vote_Result_Glow) == 0x000360, "Member 'UMissionVotingDetailsPanel_C::Vote_Result_Glow' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, VoteDescription) == 0x000368, "Member 'UMissionVotingDetailsPanel_C::VoteDescription' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, VotedPanel) == 0x000370, "Member 'UMissionVotingDetailsPanel_C::VotedPanel' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, VotedPanelContents) == 0x000378, "Member 'UMissionVotingDetailsPanel_C::VotedPanelContents' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, VoteInstigatorBanner) == 0x000380, "Member 'UMissionVotingDetailsPanel_C::VoteInstigatorBanner' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, VoteInstigatorName) == 0x000388, "Member 'UMissionVotingDetailsPanel_C::VoteInstigatorName' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, VoteName) == 0x000390, "Member 'UMissionVotingDetailsPanel_C::VoteName' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, VoteResult) == 0x000398, "Member 'UMissionVotingDetailsPanel_C::VoteResult' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, VoterList) == 0x0003A0, "Member 'UMissionVotingDetailsPanel_C::VoterList' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, YesVoteButton) == 0x0003A8, "Member 'UMissionVotingDetailsPanel_C::YesVoteButton' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, YesVoteCount) == 0x0003B0, "Member 'UMissionVotingDetailsPanel_C::YesVoteCount' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, CurrentVoteType) == 0x0003B8, "Member 'UMissionVotingDetailsPanel_C::CurrentVoteType' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, IsReceipient) == 0x0003B9, "Member 'UMissionVotingDetailsPanel_C::IsReceipient' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, InstigaterTimerMaterial) == 0x0003C0, "Member 'UMissionVotingDetailsPanel_C::InstigaterTimerMaterial' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, ReceipientTimerMaterial) == 0x0003C8, "Member 'UMissionVotingDetailsPanel_C::ReceipientTimerMaterial' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, OnRecepientVoted) == 0x0003D0, "Member 'UMissionVotingDetailsPanel_C::OnRecepientVoted' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, ReadyUpObjectiveHandle) == 0x0003E0, "Member 'UMissionVotingDetailsPanel_C::ReadyUpObjectiveHandle' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, ReadyTimer) == 0x000400, "Member 'UMissionVotingDetailsPanel_C::ReadyTimer' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, IsMissionReady) == 0x000408, "Member 'UMissionVotingDetailsPanel_C::IsMissionReady' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, VoteDuration) == 0x00040C, "Member 'UMissionVotingDetailsPanel_C::VoteDuration' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, DeadDropMission) == 0x000410, "Member 'UMissionVotingDetailsPanel_C::DeadDropMission' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, OnVoteLockedOut) == 0x000430, "Member 'UMissionVotingDetailsPanel_C::OnVoteLockedOut' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, FailedVoteLockOutDuration) == 0x000440, "Member 'UMissionVotingDetailsPanel_C::FailedVoteLockOutDuration' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, VoteResultAnimationTimer) == 0x000448, "Member 'UMissionVotingDetailsPanel_C::VoteResultAnimationTimer' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, LastVoteResultSuccess) == 0x000450, "Member 'UMissionVotingDetailsPanel_C::LastVoteResultSuccess' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, OnVoteResultFinished) == 0x000458, "Member 'UMissionVotingDetailsPanel_C::OnVoteResultFinished' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, VoteSucceededSound) == 0x000468, "Member 'UMissionVotingDetailsPanel_C::VoteSucceededSound' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, VoteFailedSound) == 0x000470, "Member 'UMissionVotingDetailsPanel_C::VoteFailedSound' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, OnMissionActivateNoVote) == 0x000478, "Member 'UMissionVotingDetailsPanel_C::OnMissionActivateNoVote' has a wrong offset!");
