...
static_assert(offsetof(CreativeServerPipButton_C_ExecuteUbergraph_CreativeServerPipButton, Temp_byte_Variable1) == 0x000005, "Member 'CreativeServerPipButton_C_ExecuteUbergraph_CreativeServerPipButton::Temp_byte_Variable1' has a wrong offset!");
