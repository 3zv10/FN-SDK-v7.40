...
static_assert(sizeof(AStorePinataMaster_Parent_C) == 0x000340, "Wrong size on AStorePinataMaster_Parent_C");
static_assert(offsetof(AStorePinataMaster_Parent_C, UberGraphFrame) == 0x000330, "Member 'AStorePinataMaster_Parent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AStorePinataMaster_Parent_C, PinataSceneRoot) == 0x000338, "Member 'AStorePinataMaster_Parent_C::PinataSceneRoot' has a wrong offset!");
