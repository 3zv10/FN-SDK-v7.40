...
static_assert(offsetof(ATrap_Floor_BouncePad_C, Player_DestructionRange) == 0x000DC0, "Member 'ATrap_Floor_BouncePad_C::Player_DestructionRange' has a wrong offset!");
