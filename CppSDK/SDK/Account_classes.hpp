...
static_assert(sizeof(UOnlineAccountCommon) == 0x000650, "Wrong size on UOnlineAccountCommon");
...
static_assert(offsetof(UOnlineAccountCommon, bAutoCreateHeadlessAccount) == 0x000618, "Member 'UOnlineAccountCommon::bAutoCreateHeadlessAccount' has a wrong offset!");
