...
static_assert(sizeof(GAT_ActiveAbility_C_K2_ShouldAbilityRespondToEvent) == 0x0000F0, "Wrong size on GAT_ActiveAbility_C_K2_ShouldAbilityRespondToEvent");
...
static_assert(offsetof(GAT_ActiveAbility_C_K2_ShouldAbilityRespondToEvent, ReturnValue) == 0x0000E8, "Member 'GAT_ActiveAbility_C_K2_ShouldAbilityRespondToEvent::ReturnValue' has a wrong offset!");
