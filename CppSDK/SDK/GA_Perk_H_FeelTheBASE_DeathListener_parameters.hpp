...
static_assert(offsetof(GA_Perk_H_FeelTheBASE_DeathListener_C_K2_ActivateAbilityFromEvent, EventData_0) == 0x000000, "Member 'GA_Perk_H_FeelTheBASE_DeathListener_C_K2_ActivateAbilityFromEvent::EventData_0' has a wrong offset!");
