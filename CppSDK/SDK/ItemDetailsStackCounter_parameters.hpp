...
static_assert(sizeof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter) == 0x00001C, "Wrong size on ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter");
...
static_assert(offsetof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter, K2Node_CreateDelegate_OutputDelegate) == 0x000004, "Member 'ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter, K2Node_Event_IsDesignTime) == 0x000014, "Member 'ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter, K2Node_CustomEvent_bItemChanged) == 0x000015, "Member 'ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter::K2Node_CustomEvent_bItemChanged' has a wrong offset!");
static_assert(offsetof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter, K2Node_CustomEvent_bAmmoChanged) == 0x000016, "Member 'ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter::K2Node_CustomEvent_bAmmoChanged' has a wrong offset!");
static_assert(offsetof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter, K2Node_CustomEvent_bIngredientsChanged) == 0x000017, "Member 'ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter::K2Node_CustomEvent_bIngredientsChanged' has a wrong offset!");
static_assert(offsetof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter, CallFunc_IsValid_ReturnValue) == 0x000018, "Member 'ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter, CallFunc_IsValid_ReturnValue1) == 0x000019, "Member 'ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(ItemDetailsStackCounter_C_Update_Stack_Count, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x000000, "Member 'ItemDetailsStackCounter_C_Update_Stack_Count::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemDetailsStackCounter_C_Update_Stack_Count, Temp_bool_Variable) == 0x000001, "Member 'ItemDetailsStackCounter_C_Update_Stack_Count::Temp_bool_Variable' has a wrong offset!");
...
static_assert(offsetof(ItemDetailsStackCounter_C_Refresh_Visibility, Temp_byte_Variable1) == 0x000002, "Member 'ItemDetailsStackCounter_C_Refresh_Visibility::Temp_byte_Variable1' has a wrong offset!");
