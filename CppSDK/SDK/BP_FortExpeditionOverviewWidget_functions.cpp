...
void UBP_FortExpeditionOverviewWidget_C::BndEvt__HeaderWithNav_K2Node_ComponentBoundEvent_0_BackButtonPressed__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_FortExpeditionOverviewWidget_C", "BndEvt__HeaderWithNav_K2Node_ComponentBoundEvent_0_BackButtonPressed__DelegateSignature");
...
// Parameters:
// const class FName&                      TabNameID                                              (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EFortExpeditionListSort                 InSortType                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UBP_FortExpeditionOverviewWidget_C::Get_Mcp_Relative_Utc_Now(struct FDateTime* UtcNow)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_FortExpeditionOverviewWidget_C", "Get Mcp Relative Utc Now");

	Params::BP_FortExpeditionOverviewWidget_C_Get_Mcp_Relative_Utc_Now Parms{};
...
void UBP_FortExpeditionOverviewWidget_C::RefreshActiveInputAction()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_FortExpeditionOverviewWidget_C", "RefreshActiveInputAction");
