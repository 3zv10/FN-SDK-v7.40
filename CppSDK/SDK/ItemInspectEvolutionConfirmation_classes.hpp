...
static_assert(sizeof(UItemInspectEvolutionConfirmation_C) == 0x000318, "Wrong size on UItemInspectEvolutionConfirmation_C");
...
static_assert(offsetof(UItemInspectEvolutionConfirmation_C, ConfirmationEvolutionIndex) == 0x000308, "Member 'UItemInspectEvolutionConfirmation_C::ConfirmationEvolutionIndex' has a wrong offset!");
static_assert(offsetof(UItemInspectEvolutionConfirmation_C, ConfirmationItem) == 0x000310, "Member 'UItemInspectEvolutionConfirmation_C::ConfirmationItem' has a wrong offset!");
