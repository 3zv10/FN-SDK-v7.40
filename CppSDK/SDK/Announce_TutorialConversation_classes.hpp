...
static_assert(sizeof(AAnnounce_TutorialConversation_C) == 0x000588, "Wrong size on AAnnounce_TutorialConversation_C");
static_assert(offsetof(AAnnounce_TutorialConversation_C, UberGraphFrame) == 0x000570, "Member 'AAnnounce_TutorialConversation_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AAnnounce_TutorialConversation_C, SentencedIndexedTutorialData) == 0x000578, "Member 'AAnnounce_TutorialConversation_C::SentencedIndexedTutorialData' has a wrong offset!");
