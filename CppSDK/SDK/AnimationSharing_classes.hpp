...
static_assert(alignof(UAnimSharingStateInstance) == 0x000008, "Wrong alignment on UAnimSharingStateInstance");
static_assert(sizeof(UAnimSharingStateInstance) == 0x000290, "Wrong size on UAnimSharingStateInstance");
static_assert(offsetof(UAnimSharingStateInstance, AnimationToPlay) == 0x000268, "Member 'UAnimSharingStateInstance::AnimationToPlay' has a wrong offset!");
static_assert(offsetof(UAnimSharingStateInstance, PermutationTimeOffset) == 0x000270, "Member 'UAnimSharingStateInstance::PermutationTimeOffset' has a wrong offset!");
static_assert(offsetof(UAnimSharingStateInstance, PlayRate) == 0x000274, "Member 'UAnimSharingStateInstance::PlayRate' has a wrong offset!");
static_assert(offsetof(UAnimSharingStateInstance, bStateBool) == 0x000278, "Member 'UAnimSharingStateInstance::bStateBool' has a wrong offset!");
...
static_assert(alignof(UAnimSharingTransitionInstance) == 0x000008, "Wrong alignment on UAnimSharingTransitionInstance");
static_assert(sizeof(UAnimSharingTransitionInstance) == 0x000280, "Wrong size on UAnimSharingTransitionInstance");
static_assert(offsetof(UAnimSharingTransitionInstance, FromComponent) == 0x000268, "Member 'UAnimSharingTransitionInstance::FromComponent' has a wrong offset!");
static_assert(offsetof(UAnimSharingTransitionInstance, ToComponent) == 0x000270, "Member 'UAnimSharingTransitionInstance::ToComponent' has a wrong offset!");
static_assert(offsetof(UAnimSharingTransitionInstance, BlendTime) == 0x000278, "Member 'UAnimSharingTransitionInstance::BlendTime' has a wrong offset!");
static_assert(offsetof(UAnimSharingTransitionInstance, bBlendBool) == 0x00027C, "Member 'UAnimSharingTransitionInstance::bBlendBool' has a wrong offset!");
...
static_assert(alignof(UAnimSharingAdditiveInstance) == 0x000008, "Wrong alignment on UAnimSharingAdditiveInstance");
static_assert(sizeof(UAnimSharingAdditiveInstance) == 0x000280, "Wrong size on UAnimSharingAdditiveInstance");
static_assert(offsetof(UAnimSharingAdditiveInstance, BaseComponent) == 0x000268, "Member 'UAnimSharingAdditiveInstance::BaseComponent' has a wrong offset!");
static_assert(offsetof(UAnimSharingAdditiveInstance, AdditiveAnimation) == 0x000270, "Member 'UAnimSharingAdditiveInstance::AdditiveAnimation' has a wrong offset!");
static_assert(offsetof(UAnimSharingAdditiveInstance, Alpha) == 0x000278, "Member 'UAnimSharingAdditiveInstance::Alpha' has a wrong offset!");
static_assert(offsetof(UAnimSharingAdditiveInstance, bStateBool) == 0x00027C, "Member 'UAnimSharingAdditiveInstance::bStateBool' has a wrong offset!");
...
static_assert(sizeof(UAnimSharingInstance) == 0x000138, "Wrong size on UAnimSharingInstance");
...
static_assert(offsetof(UAnimSharingInstance, StateProcessor) == 0x0000A8, "Member 'UAnimSharingInstance::StateProcessor' has a wrong offset!");
static_assert(offsetof(UAnimSharingInstance, UsedAnimationSequences) == 0x0000E8, "Member 'UAnimSharingInstance::UsedAnimationSequences' has a wrong offset!");
static_assert(offsetof(UAnimSharingInstance, StateEnum) == 0x000108, "Member 'UAnimSharingInstance::StateEnum' has a wrong offset!");
static_assert(offsetof(UAnimSharingInstance, SharingActor) == 0x000110, "Member 'UAnimSharingInstance::SharingActor' has a wrong offset!");
...
static_assert(sizeof(UAnimationSharingManager) == 0x0000B0, "Wrong size on UAnimationSharingManager");
