...
#include "GCN_RiftSpawnerChargeUp_Ice_classes.hpp"
#include "GCN_RiftSpawnerChargeUp_Ice_parameters.hpp"
...
void UGCN_RiftSpawnerChargeUp_Ice_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_RiftSpawnerChargeUp_Ice_C", "OnBurst");

	Params::GCN_RiftSpawnerChargeUp_Ice_C_OnBurst Parms{};
