...
// (Event, Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const class UCommonActivatablePanel*    Panel                                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// Parameters:
// const struct FFortDialogDescription_NUI&Description                                            (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
// Parameters:
// const struct FFortErrorInfo&            Info                                                   (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FFortDialogDescription_NUI&ConfirmationDescription                                (BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FFortErrorInfo&            ErrorInfo                                              (BlueprintVisible, BlueprintReadOnly, Parm)
...
// Parameters:
// struct FFortDialogExternalLatentActionHandle&WaitingDialogHandle                                    (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)
...
bool UUIManager_C::HasActiveModalWidget()
{
	static class UFunction* Func = nullptr;
