...
static_assert(sizeof(Announce_NameHomeBase_C_ExecuteUbergraph_Announce_NameHomeBase) == 0x000048, "Wrong size on Announce_NameHomeBase_C_ExecuteUbergraph_Announce_NameHomeBase");
...
static_assert(offsetof(Announce_NameHomeBase_C_ExecuteUbergraph_Announce_NameHomeBase, CallFunc_GetAllActorsOfClass_OutActors) == 0x000020, "Member 'Announce_NameHomeBase_C_ExecuteUbergraph_Announce_NameHomeBase::CallFunc_GetAllActorsOfClass_OutActors' has a wrong offset!");
static_assert(offsetof(Announce_NameHomeBase_C_ExecuteUbergraph_Announce_NameHomeBase, K2Node_SwitchInteger1_CmpSuccess) == 0x000030, "Member 'Announce_NameHomeBase_C_ExecuteUbergraph_Announce_NameHomeBase::K2Node_SwitchInteger1_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Announce_NameHomeBase_C_ExecuteUbergraph_Announce_NameHomeBase, CallFunc_Array_Get_Item) == 0x000038, "Member 'Announce_NameHomeBase_C_ExecuteUbergraph_Announce_NameHomeBase::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Announce_NameHomeBase_C_ExecuteUbergraph_Announce_NameHomeBase, CallFunc_IsValid_ReturnValue) == 0x000040, "Member 'Announce_NameHomeBase_C_ExecuteUbergraph_Announce_NameHomeBase::CallFunc_IsValid_ReturnValue' has a wrong offset!");
