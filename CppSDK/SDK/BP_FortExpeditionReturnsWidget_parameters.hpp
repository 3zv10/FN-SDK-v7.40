...
static_assert(offsetof(BP_FortExpeditionReturnsWidget_C_ExecuteUbergraph_BP_FortExpeditionReturnsWidget, CallFunc_Get_Mcp_Relative_Utc_Now_UtcNow) == 0x000008, "Member 'BP_FortExpeditionReturnsWidget_C_ExecuteUbergraph_BP_FortExpeditionReturnsWidget::CallFunc_Get_Mcp_Relative_Utc_Now_UtcNow' has a wrong offset!");
...
static_assert(offsetof(BP_FortExpeditionReturnsWidget_C_Set_Expedition_Return_Time, CallFunc_GetRemainingExpeditionDuration_ReturnValue) == 0x000020, "Member 'BP_FortExpeditionReturnsWidget_C_Set_Expedition_Return_Time::CallFunc_GetRemainingExpeditionDuration_ReturnValue' has a wrong offset!");
...
static_assert(alignof(BP_FortExpeditionReturnsWidget_C_Get_Mcp_Relative_Utc_Now) == 0x000008, "Wrong alignment on BP_FortExpeditionReturnsWidget_C_Get_Mcp_Relative_Utc_Now");
static_assert(sizeof(BP_FortExpeditionReturnsWidget_C_Get_Mcp_Relative_Utc_Now) == 0x000028, "Wrong size on BP_FortExpeditionReturnsWidget_C_Get_Mcp_Relative_Utc_Now");
static_assert(offsetof(BP_FortExpeditionReturnsWidget_C_Get_Mcp_Relative_Utc_Now, UtcNow) == 0x000000, "Member 'BP_FortExpeditionReturnsWidget_C_Get_Mcp_Relative_Utc_Now::UtcNow' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionReturnsWidget_C_Get_Mcp_Relative_Utc_Now, CallFunc_GetOwningPlayer_ReturnValue) == 0x000008, "Member 'BP_FortExpeditionReturnsWidget_C_Get_Mcp_Relative_Utc_Now::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionReturnsWidget_C_Get_Mcp_Relative_Utc_Now, K2Node_DynamicCast_AsFort_Player_Controller) == 0x000010, "Member 'BP_FortExpeditionReturnsWidget_C_Get_Mcp_Relative_Utc_Now::K2Node_DynamicCast_AsFort_Player_Controller' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionReturnsWidget_C_Get_Mcp_Relative_Utc_Now, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'BP_FortExpeditionReturnsWidget_C_Get_Mcp_Relative_Utc_Now::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionReturnsWidget_C_Get_Mcp_Relative_Utc_Now, CallFunc_GetMcpRelativeUtcNow_ReturnValue) == 0x000020, "Member 'BP_FortExpeditionReturnsWidget_C_Get_Mcp_Relative_Utc_Now::CallFunc_GetMcpRelativeUtcNow_ReturnValue' has a wrong offset!");
