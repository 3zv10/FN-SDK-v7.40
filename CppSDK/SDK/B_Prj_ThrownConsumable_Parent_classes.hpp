...
static_assert(sizeof(AB_Prj_ThrownConsumable_Parent_C) == 0x0007B0, "Wrong size on AB_Prj_ThrownConsumable_Parent_C");
static_assert(offsetof(AB_Prj_ThrownConsumable_Parent_C, UberGraphFrame) == 0x000798, "Member 'AB_Prj_ThrownConsumable_Parent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_Prj_ThrownConsumable_Parent_C, BouncePawnAgainstPawnGravityScale) == 0x0007A0, "Member 'AB_Prj_ThrownConsumable_Parent_C::BouncePawnAgainstPawnGravityScale' has a wrong offset!");
static_assert(offsetof(AB_Prj_ThrownConsumable_Parent_C, FuseTime) == 0x0007A4, "Member 'AB_Prj_ThrownConsumable_Parent_C::FuseTime' has a wrong offset!");
static_assert(offsetof(AB_Prj_ThrownConsumable_Parent_C, bSimulationRunning) == 0x0007A8, "Member 'AB_Prj_ThrownConsumable_Parent_C::bSimulationRunning' has a wrong offset!");
static_assert(offsetof(AB_Prj_ThrownConsumable_Parent_C, bShouldRestartSimulating) == 0x0007A9, "Member 'AB_Prj_ThrownConsumable_Parent_C::bShouldRestartSimulating' has a wrong offset!");
