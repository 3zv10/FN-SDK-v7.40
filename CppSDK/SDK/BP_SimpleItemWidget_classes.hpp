...
static_assert(sizeof(UBP_SimpleItemWidget_C) == 0x0002E0, "Wrong size on UBP_SimpleItemWidget_C");
...
static_assert(offsetof(UBP_SimpleItemWidget_C, QuantityTextx1) == 0x000248, "Member 'UBP_SimpleItemWidget_C::QuantityTextx1' has a wrong offset!");
...
static_assert(offsetof(UBP_SimpleItemWidget_C, Quantity) == 0x0002D8, "Member 'UBP_SimpleItemWidget_C::Quantity' has a wrong offset!");
