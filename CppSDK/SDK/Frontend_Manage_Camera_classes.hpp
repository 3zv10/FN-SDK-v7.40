...
static_assert(alignof(AFrontend_Manage_Camera_C) == 0x000010, "Wrong alignment on AFrontend_Manage_Camera_C");
static_assert(sizeof(AFrontend_Manage_Camera_C) == 0x0008C0, "Wrong size on AFrontend_Manage_Camera_C");
static_assert(offsetof(AFrontend_Manage_Camera_C, UberGraphFrame) == 0x000880, "Member 'AFrontend_Manage_Camera_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AFrontend_Manage_Camera_C, Arrow) == 0x000888, "Member 'AFrontend_Manage_Camera_C::Arrow' has a wrong offset!");
static_assert(offsetof(AFrontend_Manage_Camera_C, FortEntryMusic) == 0x000890, "Member 'AFrontend_Manage_Camera_C::FortEntryMusic' has a wrong offset!");
static_assert(offsetof(AFrontend_Manage_Camera_C, Fort_Entry_Music_Controller) == 0x000898, "Member 'AFrontend_Manage_Camera_C::Fort_Entry_Music_Controller' has a wrong offset!");
static_assert(offsetof(AFrontend_Manage_Camera_C, CameraHasBeenSelected) == 0x0008A0, "Member 'AFrontend_Manage_Camera_C::CameraHasBeenSelected' has a wrong offset!");
static_assert(offsetof(AFrontend_Manage_Camera_C, CameraHasBeenDeselected) == 0x0008B0, "Member 'AFrontend_Manage_Camera_C::CameraHasBeenDeselected' has a wrong offset!");
