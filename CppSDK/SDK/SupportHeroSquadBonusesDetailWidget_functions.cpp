...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const EFortSupportPerkWidgetState       InState                                                (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void USupportHeroSquadBonusesDetailWidget_C::HandleSquadSlotChanged(class FName SquadName, int32 SlotIndex)
{
	static class UFunction* Func = nullptr;
