...
static_assert(sizeof(URewardsIcon_C) == 0x0002F8, "Wrong size on URewardsIcon_C");
...
static_assert(offsetof(URewardsIcon_C, LazyImageIcon) == 0x000250, "Member 'URewardsIcon_C::LazyImageIcon' has a wrong offset!");
...
static_assert(offsetof(URewardsIcon_C, OriginalMaterial) == 0x0002C8, "Member 'URewardsIcon_C::OriginalMaterial' has a wrong offset!");
static_assert(offsetof(URewardsIcon_C, GiftBoxMat) == 0x0002D0, "Member 'URewardsIcon_C::GiftBoxMat' has a wrong offset!");
