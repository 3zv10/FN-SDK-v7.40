...
static_assert(sizeof(GAT_Athena_Enemy_SneakySnowman_C_ExecuteUbergraph_GAT_Athena_Enemy_SneakySnowman) == 0x000088, "Wrong size on GAT_Athena_Enemy_SneakySnowman_C_ExecuteUbergraph_GAT_Athena_Enemy_SneakySnowman");
...
static_assert(offsetof(GAT_Athena_Enemy_SneakySnowman_C_ExecuteUbergraph_GAT_Athena_Enemy_SneakySnowman, CallFunc_BP_ApplyGameplayEffectToTarget_ReturnValue) == 0x000078, "Member 'GAT_Athena_Enemy_SneakySnowman_C_ExecuteUbergraph_GAT_Athena_Enemy_SneakySnowman::CallFunc_BP_ApplyGameplayEffectToTarget_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GAT_Athena_Enemy_SneakySnowman_C_Remove_Snowman, PlayerPawn_0) == 0x000000, "Member 'GAT_Athena_Enemy_SneakySnowman_C_Remove_Snowman::PlayerPawn_0' has a wrong offset!");
