...
static_assert(sizeof(UFullPartyMemberConnected_C) == 0x000480, "Wrong size on UFullPartyMemberConnected_C");
...
static_assert(offsetof(UFullPartyMemberConnected_C, Dimensions) == 0x000478, "Member 'UFullPartyMemberConnected_C::Dimensions' has a wrong offset!");
