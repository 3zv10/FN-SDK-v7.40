...
static_assert(sizeof(AImagePlate) == 0x000338, "Wrong size on AImagePlate");
static_assert(offsetof(AImagePlate, ImagePlate) == 0x000330, "Member 'AImagePlate::ImagePlate' has a wrong offset!");
...
static_assert(sizeof(UImagePlateComponent) == 0x000640, "Wrong size on UImagePlateComponent");
static_assert(offsetof(UImagePlateComponent, Plate) == 0x000570, "Member 'UImagePlateComponent::Plate' has a wrong offset!");
...
static_assert(sizeof(UImagePlateFrustumComponent) == 0x000570, "Wrong size on UImagePlateFrustumComponent");
...
static_assert(sizeof(UMovieSceneImagePlateTrack) == 0x000080, "Wrong size on UMovieSceneImagePlateTrack");
