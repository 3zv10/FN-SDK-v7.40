...
static_assert(sizeof(ABP_ProjectileTrajectory_AthenaRed_C) == 0x000390, "Wrong size on ABP_ProjectileTrajectory_AthenaRed_C");
static_assert(offsetof(ABP_ProjectileTrajectory_AthenaRed_C, UberGraphFrame_BP_ProjectileTrajectory_AthenaRed_C) == 0x000388, "Member 'ABP_ProjectileTrajectory_AthenaRed_C::UberGraphFrame_BP_ProjectileTrajectory_AthenaRed_C' has a wrong offset!");
