...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GC_Tomato_Hit_Splat_C">();
	}
	static class UGC_Tomato_Hit_Splat_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGC_Tomato_Hit_Splat_C>();
	}
};
static_assert(alignof(UGC_Tomato_Hit_Splat_C) == 0x000008, "Wrong alignment on UGC_Tomato_Hit_Splat_C");
static_assert(sizeof(UGC_Tomato_Hit_Splat_C) == 0x0001A0, "Wrong size on UGC_Tomato_Hit_Splat_C");
