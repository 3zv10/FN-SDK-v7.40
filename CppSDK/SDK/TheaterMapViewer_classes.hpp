...
static_assert(sizeof(ATheaterMapViewer_C) == 0x000488, "Wrong size on ATheaterMapViewer_C");
static_assert(offsetof(ATheaterMapViewer_C, DefaultSceneRoot) == 0x000480, "Member 'ATheaterMapViewer_C::DefaultSceneRoot' has a wrong offset!");
