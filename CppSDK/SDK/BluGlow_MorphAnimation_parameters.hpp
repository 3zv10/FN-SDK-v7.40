...
static_assert(alignof(BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation) == 0x000004, "Wrong alignment on BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation");
static_assert(sizeof(BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation) == 0x0000D8, "Wrong size on BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation");
...
static_assert(offsetof(BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation, CallFunc_Add_IntInt_ReturnValue1) == 0x000008, "Member 'BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation::CallFunc_Add_IntInt_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation, CallFunc_Add_FloatFloat_ReturnValue1) == 0x000028, "Member 'BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation::CallFunc_Add_FloatFloat_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation, CallFunc_Add_FloatFloat_ReturnValue2) == 0x000034, "Member 'BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation::CallFunc_Add_FloatFloat_ReturnValue2' has a wrong offset!");
static_assert(offsetof(BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation, CallFunc_Sin_ReturnValue1) == 0x000038, "Member 'BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation::CallFunc_Sin_ReturnValue1' has a wrong offset!");
static_assert(offsetof(BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation, CallFunc_Add_FloatFloat_ReturnValue3) == 0x00003C, "Member 'BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation::CallFunc_Add_FloatFloat_ReturnValue3' has a wrong offset!");
...
static_assert(offsetof(BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation, CallFunc_K2_AddLocalRotation_SweepHitResult) == 0x00004C, "Member 'BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation::CallFunc_K2_AddLocalRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation, CallFunc_Percent_IntInt_ReturnValue) == 0x0000D4, "Member 'BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation::CallFunc_Percent_IntInt_ReturnValue' has a wrong offset!");
