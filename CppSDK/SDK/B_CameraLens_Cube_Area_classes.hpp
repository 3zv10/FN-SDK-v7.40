...
static_assert(alignof(AB_CameraLens_Cube_Area_C) == 0x000010, "Wrong alignment on AB_CameraLens_Cube_Area_C");
static_assert(sizeof(AB_CameraLens_Cube_Area_C) == 0x000410, "Wrong size on AB_CameraLens_Cube_Area_C");
static_assert(offsetof(AB_CameraLens_Cube_Area_C, UberGraphFrame) == 0x0003F0, "Member 'AB_CameraLens_Cube_Area_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_CameraLens_Cube_Area_C, VelocityActor) == 0x0003F8, "Member 'AB_CameraLens_Cube_Area_C::VelocityActor' has a wrong offset!");
static_assert(offsetof(AB_CameraLens_Cube_Area_C, TargetRot) == 0x000400, "Member 'AB_CameraLens_Cube_Area_C::TargetRot' has a wrong offset!");
