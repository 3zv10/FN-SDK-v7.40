...
{
public:
	class AFortAIPawn*                            Target_0;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(B_BGA_BotTurret_Parent_C_SetTarget, Target_0) == 0x000000, "Member 'B_BGA_BotTurret_Parent_C_SetTarget::Target_0' has a wrong offset!");
