...
static_assert(sizeof(UAnnouncement_Basic_C) == 0x000270, "Wrong size on UAnnouncement_Basic_C");
...
static_assert(offsetof(UAnnouncement_Basic_C, Announcement) == 0x000268, "Member 'UAnnouncement_Basic_C::Announcement' has a wrong offset!");
