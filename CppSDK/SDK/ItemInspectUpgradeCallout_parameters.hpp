...
static_assert(alignof(ItemInspectUpgradeCallout_C_SetButtonsEnabled) == 0x000001, "Wrong alignment on ItemInspectUpgradeCallout_C_SetButtonsEnabled");
static_assert(sizeof(ItemInspectUpgradeCallout_C_SetButtonsEnabled) == 0x000001, "Wrong size on ItemInspectUpgradeCallout_C_SetButtonsEnabled");
static_assert(offsetof(ItemInspectUpgradeCallout_C_SetButtonsEnabled, bIsEnabled_0) == 0x000000, "Member 'ItemInspectUpgradeCallout_C_SetButtonsEnabled::bIsEnabled_0' has a wrong offset!");
