...
static_assert(alignof(UGAT_GenericTriggeredAbility_Perk_C) == 0x000008, "Wrong alignment on UGAT_GenericTriggeredAbility_Perk_C");
static_assert(sizeof(UGAT_GenericTriggeredAbility_Perk_C) == 0x000A70, "Wrong size on UGAT_GenericTriggeredAbility_Perk_C");
static_assert(offsetof(UGAT_GenericTriggeredAbility_Perk_C, UberGraphFrame_GAT_GenericTriggeredAbility_Perk_C) == 0x000A10, "Member 'UGAT_GenericTriggeredAbility_Perk_C::UberGraphFrame_GAT_GenericTriggeredAbility_Perk_C' has a wrong offset!");
static_assert(offsetof(UGAT_GenericTriggeredAbility_Perk_C, StreakCount) == 0x000A18, "Member 'UGAT_GenericTriggeredAbility_Perk_C::StreakCount' has a wrong offset!");
static_assert(offsetof(UGAT_GenericTriggeredAbility_Perk_C, MAP_DamageElement) == 0x000A20, "Member 'UGAT_GenericTriggeredAbility_Perk_C::MAP_DamageElement' has a wrong offset!");
