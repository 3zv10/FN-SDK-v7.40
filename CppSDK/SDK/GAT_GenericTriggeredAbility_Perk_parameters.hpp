...
{
public:
	float                                         PROC_Chance__0_1_;                                 // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(GAT_GenericTriggeredAbility_Perk_C_CalcStreakBreakerThreshold, PROC_Chance__0_1_) == 0x000000, "Member 'GAT_GenericTriggeredAbility_Perk_C_CalcStreakBreakerThreshold::PROC_Chance__0_1_' has a wrong offset!");
