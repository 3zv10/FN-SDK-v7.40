...
static_assert(sizeof(AGCNL_PurpleStuff_C) == 0x000438, "Wrong size on AGCNL_PurpleStuff_C");
static_assert(offsetof(AGCNL_PurpleStuff_C, UberGraphFrame) == 0x000428, "Member 'AGCNL_PurpleStuff_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCNL_PurpleStuff_C, PlayerActor) == 0x000430, "Member 'AGCNL_PurpleStuff_C::PlayerActor' has a wrong offset!");
