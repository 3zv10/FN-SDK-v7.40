...
static_assert(sizeof(UEnvQueryGenerator_ActorsOfClass) == 0x0000C0, "Wrong size on UEnvQueryGenerator_ActorsOfClass");
...
static_assert(offsetof(UEnvQueryGenerator_ActorsOfClass, SearchRadius) == 0x000088, "Member 'UEnvQueryGenerator_ActorsOfClass::SearchRadius' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_ActorsOfClass, SearchCenter) == 0x0000B8, "Member 'UEnvQueryGenerator_ActorsOfClass::SearchCenter' has a wrong offset!");
...
static_assert(sizeof(AAIController) == 0x000440, "Wrong size on AAIController");
static_assert(offsetof(AAIController, PathFollowingComponent) == 0x0003F0, "Member 'AAIController::PathFollowingComponent' has a wrong offset!");
static_assert(offsetof(AAIController, BrainComponent) == 0x0003F8, "Member 'AAIController::BrainComponent' has a wrong offset!");
static_assert(offsetof(AAIController, PerceptionComponent) == 0x000400, "Member 'AAIController::PerceptionComponent' has a wrong offset!");
static_assert(offsetof(AAIController, ActionsComp) == 0x000408, "Member 'AAIController::ActionsComp' has a wrong offset!");
static_assert(offsetof(AAIController, Blackboard) == 0x000410, "Member 'AAIController::Blackboard' has a wrong offset!");
static_assert(offsetof(AAIController, CachedGameplayTasksComponent) == 0x000418, "Member 'AAIController::CachedGameplayTasksComponent' has a wrong offset!");
static_assert(offsetof(AAIController, DefaultNavigationFilterClass) == 0x000420, "Member 'AAIController::DefaultNavigationFilterClass' has a wrong offset!");
static_assert(offsetof(AAIController, ReceiveMoveCompleted) == 0x000428, "Member 'AAIController::ReceiveMoveCompleted' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_128[0x80];                                     // 0x0128(0x0080)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UAIPerceptionComponent, SensesConfig) == 0x0000F8, "Member 'UAIPerceptionComponent::SensesConfig' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, DominantSense) == 0x000108, "Member 'UAIPerceptionComponent::DominantSense' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, AIOwner) == 0x000120, "Member 'UAIPerceptionComponent::AIOwner' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, OnPerceptionUpdated) == 0x0001A8, "Member 'UAIPerceptionComponent::OnPerceptionUpdated' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, OnTargetPerceptionUpdated) == 0x0001B8, "Member 'UAIPerceptionComponent::OnTargetPerceptionUpdated' has a wrong offset!");
...
static_assert(sizeof(UBrainComponent) == 0x000158, "Wrong size on UBrainComponent");
static_assert(offsetof(UBrainComponent, BlackboardComp) == 0x000100, "Member 'UBrainComponent::BlackboardComp' has a wrong offset!");
static_assert(offsetof(UBrainComponent, AIOwner) == 0x000108, "Member 'UBrainComponent::AIOwner' has a wrong offset!");
...
static_assert(sizeof(UBTTask_BlueprintBase) == 0x0000A0, "Wrong size on UBTTask_BlueprintBase");
...
public:
	...
	uint8                                         Pad_188[0x120];                                    // 0x0188(0x0120)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UBehaviorTreeComponent) == 0x0002A8, "Wrong size on UBehaviorTreeComponent");
static_assert(offsetof(UBehaviorTreeComponent, NodeInstances) == 0x000178, "Member 'UBehaviorTreeComponent::NodeInstances' has a wrong offset!");
...
static_assert(sizeof(UAIPerceptionStimuliSourceComponent) == 0x000110, "Wrong size on UAIPerceptionStimuliSourceComponent");
static_assert(offsetof(UAIPerceptionStimuliSourceComponent, RegisterAsSourceForSenses) == 0x000100, "Member 'UAIPerceptionStimuliSourceComponent::RegisterAsSourceForSenses' has a wrong offset!");
...
static_assert(offsetof(UAISystem, DefaultSightCollisionChannel) == 0x00009A, "Member 'UAISystem::DefaultSightCollisionChannel' has a wrong offset!");
...
static_assert(sizeof(UPathFollowingComponent) == 0x0002A0, "Wrong size on UPathFollowingComponent");
static_assert(offsetof(UPathFollowingComponent, MovementComp) == 0x000130, "Member 'UPathFollowingComponent::MovementComp' has a wrong offset!");
static_assert(offsetof(UPathFollowingComponent, MyNavData) == 0x000140, "Member 'UPathFollowingComponent::MyNavData' has a wrong offset!");
...
static_assert(sizeof(UCrowdFollowingComponent) == 0x0002E0, "Wrong size on UCrowdFollowingComponent");
static_assert(offsetof(UCrowdFollowingComponent, CharacterMovement) == 0x0002A8, "Member 'UCrowdFollowingComponent::CharacterMovement' has a wrong offset!");
static_assert(offsetof(UCrowdFollowingComponent, CrowdAgentMoveDirection) == 0x0002B0, "Member 'UCrowdFollowingComponent::CrowdAgentMoveDirection' has a wrong offset!");
...
static_assert(sizeof(ANavLinkProxy) == 0x000380, "Wrong size on ANavLinkProxy");
static_assert(offsetof(ANavLinkProxy, PointLinks) == 0x000340, "Member 'ANavLinkProxy::PointLinks' has a wrong offset!");
static_assert(offsetof(ANavLinkProxy, SegmentLinks) == 0x000350, "Member 'ANavLinkProxy::SegmentLinks' has a wrong offset!");
static_assert(offsetof(ANavLinkProxy, SmartLinkComp) == 0x000360, "Member 'ANavLinkProxy::SmartLinkComp' has a wrong offset!");
static_assert(offsetof(ANavLinkProxy, bSmartLinkIsRelevant) == 0x000368, "Member 'ANavLinkProxy::bSmartLinkIsRelevant' has a wrong offset!");
static_assert(offsetof(ANavLinkProxy, OnSmartLinkReached) == 0x000370, "Member 'ANavLinkProxy::OnSmartLinkReached' has a wrong offset!");
...
static_assert(sizeof(UAISenseConfig_Sight) == 0x000068, "Wrong size on UAISenseConfig_Sight");
...
static_assert(sizeof(UEnvQueryTest) == 0x0001C0, "Wrong size on UEnvQueryTest");
...
static_assert(offsetof(UEnvQueryTest, FloatValueMin) == 0x000080, "Member 'UEnvQueryTest::FloatValueMin' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, FloatValueMax) == 0x0000B0, "Member 'UEnvQueryTest::FloatValueMax' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ScoringEquation) == 0x0000E1, "Member 'UEnvQueryTest::ScoringEquation' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ClampMinType) == 0x0000E2, "Member 'UEnvQueryTest::ClampMinType' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ClampMaxType) == 0x0000E3, "Member 'UEnvQueryTest::ClampMaxType' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, NormalizationType) == 0x0000E4, "Member 'UEnvQueryTest::NormalizationType' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ScoreClampMin) == 0x0000E8, "Member 'UEnvQueryTest::ScoreClampMin' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ScoreClampMax) == 0x000118, "Member 'UEnvQueryTest::ScoreClampMax' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ScoringFactor) == 0x000148, "Member 'UEnvQueryTest::ScoringFactor' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ReferenceValue) == 0x000178, "Member 'UEnvQueryTest::ReferenceValue' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, bDefineReferenceValue) == 0x0001A8, "Member 'UEnvQueryTest::bDefineReferenceValue' has a wrong offset!");
...
static_assert(sizeof(UAISense_Sight) == 0x000158, "Wrong size on UAISense_Sight");
static_assert(offsetof(UAISense_Sight, MaxTracesPerTick) == 0x000130, "Member 'UAISense_Sight::MaxTracesPerTick' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, MinQueriesPerTimeSliceCheck) == 0x000134, "Member 'UAISense_Sight::MinQueriesPerTimeSliceCheck' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, MaxTimeSlicePerTick) == 0x000138, "Member 'UAISense_Sight::MaxTimeSlicePerTick' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, HighImportanceQueryDistanceThreshold) == 0x000140, "Member 'UAISense_Sight::HighImportanceQueryDistanceThreshold' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, MaxQueryImportance) == 0x000148, "Member 'UAISense_Sight::MaxQueryImportance' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, SightLimitQueryImportance) == 0x00014C, "Member 'UAISense_Sight::SightLimitQueryImportance' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryGenerator_OnCircle) == 0x0001E8, "Wrong size on UEnvQueryGenerator_OnCircle");
...
static_assert(offsetof(UEnvQueryGenerator_OnCircle, SpaceBetween) == 0x0000B0, "Member 'UEnvQueryGenerator_OnCircle::SpaceBetween' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, NumberOfPoints) == 0x0000E0, "Member 'UEnvQueryGenerator_OnCircle::NumberOfPoints' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, PointOnCircleSpacingMethod) == 0x000110, "Member 'UEnvQueryGenerator_OnCircle::PointOnCircleSpacingMethod' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, ArcDirection) == 0x000118, "Member 'UEnvQueryGenerator_OnCircle::ArcDirection' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, ArcAngle) == 0x000138, "Member 'UEnvQueryGenerator_OnCircle::ArcAngle' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, AngleRadians) == 0x000168, "Member 'UEnvQueryGenerator_OnCircle::AngleRadians' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, CircleCenter) == 0x000170, "Member 'UEnvQueryGenerator_OnCircle::CircleCenter' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, bIgnoreAnyContextActorsWhenGeneratingCircle) == 0x000178, "Member 'UEnvQueryGenerator_OnCircle::bIgnoreAnyContextActorsWhenGeneratingCircle' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, CircleCenterZOffset) == 0x000180, "Member 'UEnvQueryGenerator_OnCircle::CircleCenterZOffset' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, TraceData) == 0x0001B0, "Member 'UEnvQueryGenerator_OnCircle::TraceData' has a wrong offset!");
...
static_assert(sizeof(UAISenseBlueprintListener) == 0x0000F0, "Wrong size on UAISenseBlueprintListener");
...
static_assert(sizeof(UAISenseEvent_Damage) == 0x000058, "Wrong size on UAISenseEvent_Damage");
...
static_assert(sizeof(UBehaviorTree) == 0x000060, "Wrong size on UBehaviorTree");
static_assert(offsetof(UBehaviorTree, RootNode) == 0x000028, "Member 'UBehaviorTree::RootNode' has a wrong offset!");
static_assert(offsetof(UBehaviorTree, BlackboardAsset) == 0x000030, "Member 'UBehaviorTree::BlackboardAsset' has a wrong offset!");
static_assert(offsetof(UBehaviorTree, RootDecorators) == 0x000038, "Member 'UBehaviorTree::RootDecorators' has a wrong offset!");
static_assert(offsetof(UBehaviorTree, RootDecoratorOps) == 0x000048, "Member 'UBehaviorTree::RootDecoratorOps' has a wrong offset!");
...
static_assert(sizeof(UBlackboardComponent) == 0x0001F0, "Wrong size on UBlackboardComponent");
static_assert(offsetof(UBlackboardComponent, BrainComp) == 0x0000F8, "Member 'UBlackboardComponent::BrainComp' has a wrong offset!");
static_assert(offsetof(UBlackboardComponent, BlackboardAsset) == 0x000100, "Member 'UBlackboardComponent::BlackboardAsset' has a wrong offset!");
static_assert(offsetof(UBlackboardComponent, KeyInstances) == 0x000128, "Member 'UBlackboardComponent::KeyInstances' has a wrong offset!");
...
static_assert(sizeof(UBTDecorator_IsAtLocation) == 0x0000D0, "Wrong size on UBTDecorator_IsAtLocation");
...
static_assert(offsetof(UBTDecorator_IsAtLocation, GeometricDistanceType) == 0x0000C8, "Member 'UBTDecorator_IsAtLocation::GeometricDistanceType' has a wrong offset!");
...
static_assert(sizeof(ADetourCrowdAIController) == 0x000440, "Wrong size on ADetourCrowdAIController");
...
static_assert(sizeof(UEnvQueryGenerator_Cone) == 0x000150, "Wrong size on UEnvQueryGenerator_Cone");
...
static_assert(offsetof(UEnvQueryGenerator_Cone, ConeDegrees) == 0x0000B0, "Member 'UEnvQueryGenerator_Cone::ConeDegrees' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Cone, AngleStep) == 0x0000E0, "Member 'UEnvQueryGenerator_Cone::AngleStep' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Cone, Range) == 0x000110, "Member 'UEnvQueryGenerator_Cone::Range' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Cone, CenterActor) == 0x000140, "Member 'UEnvQueryGenerator_Cone::CenterActor' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryGenerator_Donut) == 0x0001A8, "Wrong size on UEnvQueryGenerator_Donut");
...
static_assert(offsetof(UEnvQueryGenerator_Donut, OuterRadius) == 0x0000B0, "Member 'UEnvQueryGenerator_Donut::OuterRadius' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Donut, NumberOfRings) == 0x0000E0, "Member 'UEnvQueryGenerator_Donut::NumberOfRings' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Donut, PointsPerRing) == 0x000110, "Member 'UEnvQueryGenerator_Donut::PointsPerRing' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Donut, ArcDirection) == 0x000140, "Member 'UEnvQueryGenerator_Donut::ArcDirection' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Donut, ArcAngle) == 0x000160, "Member 'UEnvQueryGenerator_Donut::ArcAngle' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Donut, bUseSpiralPattern) == 0x000190, "Member 'UEnvQueryGenerator_Donut::bUseSpiralPattern' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Donut, Center) == 0x000198, "Member 'UEnvQueryGenerator_Donut::Center' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryGenerator_SimpleGrid) == 0x0000E8, "Wrong size on UEnvQueryGenerator_SimpleGrid");
...
static_assert(offsetof(UEnvQueryGenerator_SimpleGrid, SpaceBetween) == 0x0000B0, "Member 'UEnvQueryGenerator_SimpleGrid::SpaceBetween' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_SimpleGrid, GenerateAround) == 0x0000E0, "Member 'UEnvQueryGenerator_SimpleGrid::GenerateAround' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryGenerator_PathingGrid) == 0x000150, "Wrong size on UEnvQueryGenerator_PathingGrid");
static_assert(offsetof(UEnvQueryGenerator_PathingGrid, PathToItem) == 0x0000E8, "Member 'UEnvQueryGenerator_PathingGrid::PathToItem' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_PathingGrid, NavigationFilter) == 0x000118, "Member 'UEnvQueryGenerator_PathingGrid::NavigationFilter' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_PathingGrid, ScanRangeMultiplier) == 0x000120, "Member 'UEnvQueryGenerator_PathingGrid::ScanRangeMultiplier' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_Distance) == 0x0001D0, "Wrong size on UEnvQueryTest_Distance");
static_assert(offsetof(UEnvQueryTest_Distance, TestMode) == 0x0001C0, "Member 'UEnvQueryTest_Distance::TestMode' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Distance, DistanceTo) == 0x0001C8, "Member 'UEnvQueryTest_Distance::DistanceTo' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_Dot) == 0x000208, "Wrong size on UEnvQueryTest_Dot");
static_assert(offsetof(UEnvQueryTest_Dot, LineA) == 0x0001C0, "Member 'UEnvQueryTest_Dot::LineA' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Dot, LineB) == 0x0001E0, "Member 'UEnvQueryTest_Dot::LineB' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Dot, TestMode) == 0x000200, "Member 'UEnvQueryTest_Dot::TestMode' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Dot, bAbsoluteValue) == 0x000201, "Member 'UEnvQueryTest_Dot::bAbsoluteValue' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_GameplayTags) == 0x000230, "Wrong size on UEnvQueryTest_GameplayTags");
static_assert(offsetof(UEnvQueryTest_GameplayTags, TagQueryToMatch) == 0x0001C0, "Member 'UEnvQueryTest_GameplayTags::TagQueryToMatch' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_GameplayTags, bUpdatedToUseQuery) == 0x000208, "Member 'UEnvQueryTest_GameplayTags::bUpdatedToUseQuery' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_GameplayTags, TagsToMatch) == 0x000209, "Member 'UEnvQueryTest_GameplayTags::TagsToMatch' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_GameplayTags, GameplayTags) == 0x000210, "Member 'UEnvQueryTest_GameplayTags::GameplayTags' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_Overlap) == 0x0001E0, "Wrong size on UEnvQueryTest_Overlap");
static_assert(offsetof(UEnvQueryTest_Overlap, OverlapData) == 0x0001C0, "Member 'UEnvQueryTest_Overlap::OverlapData' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_Pathfinding) == 0x000238, "Wrong size on UEnvQueryTest_Pathfinding");
static_assert(offsetof(UEnvQueryTest_Pathfinding, TestMode) == 0x0001C0, "Member 'UEnvQueryTest_Pathfinding::TestMode' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Pathfinding, Context) == 0x0001C8, "Member 'UEnvQueryTest_Pathfinding::Context' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Pathfinding, PathFromContext) == 0x0001D0, "Member 'UEnvQueryTest_Pathfinding::PathFromContext' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Pathfinding, SkipUnreachable) == 0x000200, "Member 'UEnvQueryTest_Pathfinding::SkipUnreachable' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Pathfinding, FilterClass) == 0x000230, "Member 'UEnvQueryTest_Pathfinding::FilterClass' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_PathfindingBatch) == 0x000268, "Wrong size on UEnvQueryTest_PathfindingBatch");
static_assert(offsetof(UEnvQueryTest_PathfindingBatch, ScanRangeMultiplier) == 0x000238, "Member 'UEnvQueryTest_PathfindingBatch::ScanRangeMultiplier' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_Project) == 0x0001F0, "Wrong size on UEnvQueryTest_Project");
static_assert(offsetof(UEnvQueryTest_Project, ProjectionData) == 0x0001C0, "Member 'UEnvQueryTest_Project::ProjectionData' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_Random) == 0x0001C0, "Wrong size on UEnvQueryTest_Random");
...
static_assert(sizeof(UEnvQueryTest_Trace) == 0x000288, "Wrong size on UEnvQueryTest_Trace");
static_assert(offsetof(UEnvQueryTest_Trace, TraceData) == 0x0001C0, "Member 'UEnvQueryTest_Trace::TraceData' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Trace, TraceFromContext) == 0x0001F0, "Member 'UEnvQueryTest_Trace::TraceFromContext' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Trace, ItemHeightOffset) == 0x000220, "Member 'UEnvQueryTest_Trace::ItemHeightOffset' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Trace, ContextHeightOffset) == 0x000250, "Member 'UEnvQueryTest_Trace::ContextHeightOffset' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Trace, Context) == 0x000280, "Member 'UEnvQueryTest_Trace::Context' has a wrong offset!");
...
static_assert(alignof(UEQSRenderingComponent) == 0x000008, "Wrong alignment on UEQSRenderingComponent");
static_assert(sizeof(UEQSRenderingComponent) == 0x0005B0, "Wrong size on UEQSRenderingComponent");
...
static_assert(sizeof(AEQSTestingPawn) == 0x0007E0, "Wrong size on AEQSTestingPawn");
static_assert(offsetof(AEQSTestingPawn, QueryTemplate) == 0x000750, "Member 'AEQSTestingPawn::QueryTemplate' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryParams) == 0x000758, "Member 'AEQSTestingPawn::QueryParams' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryConfig) == 0x000768, "Member 'AEQSTestingPawn::QueryConfig' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, TimeLimitPerStep) == 0x000778, "Member 'AEQSTestingPawn::TimeLimitPerStep' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, StepToDebugDraw) == 0x00077C, "Member 'AEQSTestingPawn::StepToDebugDraw' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, HighlightMode) == 0x000780, "Member 'AEQSTestingPawn::HighlightMode' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryingMode) == 0x000788, "Member 'AEQSTestingPawn::QueryingMode' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, NavAgentProperties) == 0x000790, "Member 'AEQSTestingPawn::NavAgentProperties' has a wrong offset!");
...
static_assert(sizeof(AGridPathAIController) == 0x000440, "Wrong size on AGridPathAIController");
...
static_assert(sizeof(UGridPathFollowingComponent) == 0x0002D0, "Wrong size on UGridPathFollowingComponent");
static_assert(offsetof(UGridPathFollowingComponent, GridManager) == 0x0002A0, "Member 'UGridPathFollowingComponent::GridManager' has a wrong offset!");
...
static_assert(offsetof(UPawnAction_Move, AcceptableRadius) == 0x0000AC, "Member 'UPawnAction_Move::AcceptableRadius' has a wrong offset!");
static_assert(offsetof(UPawnAction_Move, FilterClass) == 0x0000B0, "Member 'UPawnAction_Move::FilterClass' has a wrong offset!");
...
static_assert(sizeof(UPawnAction_Wait) == 0x0000A8, "Wrong size on UPawnAction_Wait");
...
static_assert(sizeof(UPawnActionsComponent) == 0x000130, "Wrong size on UPawnActionsComponent");
static_assert(offsetof(UPawnActionsComponent, ControlledPawn) == 0x0000F8, "Member 'UPawnActionsComponent::ControlledPawn' has a wrong offset!");
static_assert(offsetof(UPawnActionsComponent, ActionStacks) == 0x000100, "Member 'UPawnActionsComponent::ActionStacks' has a wrong offset!");
static_assert(offsetof(UPawnActionsComponent, ActionEvents) == 0x000110, "Member 'UPawnActionsComponent::ActionEvents' has a wrong offset!");
static_assert(offsetof(UPawnActionsComponent, CurrentAction) == 0x000120, "Member 'UPawnActionsComponent::CurrentAction' has a wrong offset!");
...
static_assert(sizeof(UPawnSensingComponent) == 0x000140, "Wrong size on UPawnSensingComponent");
static_assert(offsetof(UPawnSensingComponent, HearingThreshold) == 0x0000F8, "Member 'UPawnSensingComponent::HearingThreshold' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, LOSHearingThreshold) == 0x0000FC, "Member 'UPawnSensingComponent::LOSHearingThreshold' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, SightRadius) == 0x000100, "Member 'UPawnSensingComponent::SightRadius' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, SensingInterval) == 0x000104, "Member 'UPawnSensingComponent::SensingInterval' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, HearingMaxSoundAge) == 0x000108, "Member 'UPawnSensingComponent::HearingMaxSoundAge' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, OnSeePawn) == 0x000118, "Member 'UPawnSensingComponent::OnSeePawn' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, OnHearNoise) == 0x000128, "Member 'UPawnSensingComponent::OnHearNoise' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, PeripheralVisionAngle) == 0x000138, "Member 'UPawnSensingComponent::PeripheralVisionAngle' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, PeripheralVisionCosine) == 0x00013C, "Member 'UPawnSensingComponent::PeripheralVisionCosine' has a wrong offset!");
