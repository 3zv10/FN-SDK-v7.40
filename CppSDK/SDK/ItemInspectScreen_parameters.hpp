...
static_assert(offsetof(ItemInspectScreen_C_ShouldShowRefundMessage, ShouldShowRefundMessage_0) == 0x000000, "Member 'ItemInspectScreen_C_ShouldShowRefundMessage::ShouldShowRefundMessage_0' has a wrong offset!");
