...
static_assert(sizeof(UGA_Athena_C4_Detonate_C) == 0x000940, "Wrong size on UGA_Athena_C4_Detonate_C");
static_assert(offsetof(UGA_Athena_C4_Detonate_C, UberGraphFrame) == 0x000938, "Member 'UGA_Athena_C4_Detonate_C::UberGraphFrame' has a wrong offset!");
