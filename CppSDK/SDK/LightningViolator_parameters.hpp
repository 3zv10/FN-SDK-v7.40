...
static_assert(sizeof(LightningViolator_C_ExecuteUbergraph_LightningViolator) == 0x000030, "Wrong size on LightningViolator_C_ExecuteUbergraph_LightningViolator");
...
static_assert(offsetof(LightningViolator_C_ExecuteUbergraph_LightningViolator, K2Node_Event_IsDesignTime) == 0x000004, "Member 'LightningViolator_C_ExecuteUbergraph_LightningViolator::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(LightningViolator_C_ExecuteUbergraph_LightningViolator, K2Node_CustomEvent_NewColor) == 0x000008, "Member 'LightningViolator_C_ExecuteUbergraph_LightningViolator::K2Node_CustomEvent_NewColor' has a wrong offset!");
static_assert(offsetof(LightningViolator_C_ExecuteUbergraph_LightningViolator, K2Node_CustomEvent_NewText) == 0x000018, "Member 'LightningViolator_C_ExecuteUbergraph_LightningViolator::K2Node_CustomEvent_NewText' has a wrong offset!");
