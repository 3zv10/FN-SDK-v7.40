...
static_assert(alignof(UGCN_Snowball_Splat_C) == 0x000008, "Wrong alignment on UGCN_Snowball_Splat_C");
static_assert(sizeof(UGCN_Snowball_Splat_C) == 0x0001B0, "Wrong size on UGCN_Snowball_Splat_C");
static_assert(offsetof(UGCN_Snowball_Splat_C, Decal) == 0x0001A0, "Member 'UGCN_Snowball_Splat_C::Decal' has a wrong offset!");
static_assert(offsetof(UGCN_Snowball_Splat_C, NewVar_0) == 0x0001A8, "Member 'UGCN_Snowball_Splat_C::NewVar_0' has a wrong offset!");
