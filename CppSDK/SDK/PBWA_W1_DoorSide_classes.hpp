...
static_assert(alignof(APBWA_W1_DoorSide_C) == 0x000008, "Wrong alignment on APBWA_W1_DoorSide_C");
static_assert(sizeof(APBWA_W1_DoorSide_C) == 0x000CE8, "Wrong size on APBWA_W1_DoorSide_C");
