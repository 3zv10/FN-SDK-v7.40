...
static_assert(sizeof(UGA_BoostJumpPack_Equip_C) == 0x000948, "Wrong size on UGA_BoostJumpPack_Equip_C");
static_assert(offsetof(UGA_BoostJumpPack_Equip_C, UberGraphFrame) == 0x000938, "Member 'UGA_BoostJumpPack_Equip_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_BoostJumpPack_Equip_C, PlayerPawn) == 0x000940, "Member 'UGA_BoostJumpPack_Equip_C::PlayerPawn' has a wrong offset!");
