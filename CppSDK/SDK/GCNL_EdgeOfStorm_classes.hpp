...
static_assert(sizeof(AGCNL_EdgeOfStorm_C) == 0x0008A0, "Wrong size on AGCNL_EdgeOfStorm_C");
static_assert(offsetof(AGCNL_EdgeOfStorm_C, UberGraphFrame) == 0x000880, "Member 'AGCNL_EdgeOfStorm_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCNL_EdgeOfStorm_C, Audio) == 0x000888, "Member 'AGCNL_EdgeOfStorm_C::Audio' has a wrong offset!");
static_assert(offsetof(AGCNL_EdgeOfStorm_C, StormPawn) == 0x000890, "Member 'AGCNL_EdgeOfStorm_C::StormPawn' has a wrong offset!");
static_assert(offsetof(AGCNL_EdgeOfStorm_C, bBoundAudioPercent) == 0x000898, "Member 'AGCNL_EdgeOfStorm_C::bBoundAudioPercent' has a wrong offset!");
static_assert(offsetof(AGCNL_EdgeOfStorm_C, CurrentPlaybackPercent) == 0x00089C, "Member 'AGCNL_EdgeOfStorm_C::CurrentPlaybackPercent' has a wrong offset!");
