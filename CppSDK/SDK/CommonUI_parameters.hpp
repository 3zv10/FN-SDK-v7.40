...
static_assert(offsetof(CommonPopupMenu_SetContextProvider, ContextProvidingObject_0) == 0x000000, "Member 'CommonPopupMenu_SetContextProvider::ContextProvidingObject_0' has a wrong offset!");
...
static_assert(offsetof(CommonTabListWidget_GetTabIdAtIndex, Index_0) == 0x000000, "Member 'CommonTabListWidget_GetTabIdAtIndex::Index_0' has a wrong offset!");
