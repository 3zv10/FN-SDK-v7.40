...
#include "GCN_DanceOff_Point_classes.hpp"
#include "GCN_DanceOff_Point_parameters.hpp"
...
void UGCN_DanceOff_Point_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::GCN_DanceOff_Point_C_OnBurst Parms{};
