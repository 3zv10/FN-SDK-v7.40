...
void ADA_Glider_Item_C::ExecuteUbergraph_DA_Glider_Item(int32 EntryPoint)
{
...
// Function DA_Glider_Item.DA_Glider_Item_C.UserConstructionScript
// (Event, Public, BlueprintCallable, BlueprintEvent)

void ADA_Glider_Item_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DA_Glider_Item_C", "UserConstructionScript");
...
void ADA_Glider_Item_C::RaiseUsageError(const struct FGameplayTagContainer& FailedReason)
{
	static class UFunction* Func = nullptr;
