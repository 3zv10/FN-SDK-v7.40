...
static_assert(offsetof(Fort_Entry_Music_Controller_BP_C_DelayedPlayMusicPack, MusicPackToPlayLater_0) == 0x000000, "Member 'Fort_Entry_Music_Controller_BP_C_DelayedPlayMusicPack::MusicPackToPlayLater_0' has a wrong offset!");
