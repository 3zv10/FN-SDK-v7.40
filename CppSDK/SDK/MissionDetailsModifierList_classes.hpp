...
public:
	...
	class UWrapBox*                               WrapBoxModifiers;                                  // 0x0250(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	TArray<class UFortGameplayModifierItemDefinition*> DebugMods;                                    // 0x0258(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
...
static_assert(sizeof(UMissionDetailsModifierList_C) == 0x000268, "Wrong size on UMissionDetailsModifierList_C");
...
static_assert(offsetof(UMissionDetailsModifierList_C, WrapBoxModifiers) == 0x000250, "Member 'UMissionDetailsModifierList_C::WrapBoxModifiers' has a wrong offset!");
static_assert(offsetof(UMissionDetailsModifierList_C, DebugMods) == 0x000258, "Member 'UMissionDetailsModifierList_C::DebugMods' has a wrong offset!");
