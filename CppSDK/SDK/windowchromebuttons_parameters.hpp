...
static_assert(offsetof(windowchromebuttons_C_ExecuteUbergraph_windowchromebuttons, K2Node_Event_MouseEvent1) == 0x000048, "Member 'windowchromebuttons_C_ExecuteUbergraph_windowchromebuttons::K2Node_Event_MouseEvent1' has a wrong offset!");
...
static_assert(offsetof(windowchromebuttons_C_ExecuteUbergraph_windowchromebuttons, CallFunc_PlayAnimation_ReturnValue1) == 0x000128, "Member 'windowchromebuttons_C_ExecuteUbergraph_windowchromebuttons::CallFunc_PlayAnimation_ReturnValue1' has a wrong offset!");
