...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FRotator&                  PlayerYaw                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// float                                   YawOffset_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AB_BGA_FireworksMortar_Holder_C::SetRotation(const struct FRotator& PlayerYaw, float YawOffset_0)
{
	static class UFunction* Func = nullptr;
...
void AB_BGA_FireworksMortar_Holder_C::ReceiveHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, const struct FVector& HitLocation, const struct FVector& HitNormal_0, const struct FVector& NormalImpulse, const struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;
