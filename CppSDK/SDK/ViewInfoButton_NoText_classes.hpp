...
static_assert(sizeof(UViewInfoButton_NoText_C) == 0x000B38, "Wrong size on UViewInfoButton_NoText_C");
static_assert(offsetof(UViewInfoButton_NoText_C, Content) == 0x000B30, "Member 'UViewInfoButton_NoText_C::Content' has a wrong offset!");
