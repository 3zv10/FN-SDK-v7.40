...
static_assert(sizeof(UMissionStartObjectivePanel_C) == 0x000330, "Wrong size on UMissionStartObjectivePanel_C");
static_assert(offsetof(UMissionStartObjectivePanel_C, UberGraphFrame) == 0x000260, "Member 'UMissionStartObjectivePanel_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, HideLockout) == 0x000268, "Member 'UMissionStartObjectivePanel_C::HideLockout' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, ShowLockout) == 0x000270, "Member 'UMissionStartObjectivePanel_C::ShowLockout' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, ClosePanel) == 0x000278, "Member 'UMissionStartObjectivePanel_C::ClosePanel' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, HoverState_Off) == 0x000280, "Member 'UMissionStartObjectivePanel_C::HoverState_Off' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, HoverState_On) == 0x000288, "Member 'UMissionStartObjectivePanel_C::HoverState_On' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, OpenPanel) == 0x000290, "Member 'UMissionStartObjectivePanel_C::OpenPanel' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, DifficultyRating) == 0x000298, "Member 'UMissionStartObjectivePanel_C::DifficultyRating' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, ImageHighlighted) == 0x0002A0, "Member 'UMissionStartObjectivePanel_C::ImageHighlighted' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, ImageLockout) == 0x0002A8, "Member 'UMissionStartObjectivePanel_C::ImageLockout' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, LockoutText) == 0x0002B0, "Member 'UMissionStartObjectivePanel_C::LockoutText' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, LockoutTimeRemaining) == 0x0002B8, "Member 'UMissionStartObjectivePanel_C::LockoutTimeRemaining' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, RewardsList) == 0x0002C0, "Member 'UMissionStartObjectivePanel_C::RewardsList' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, RewardsWrapper) == 0x0002C8, "Member 'UMissionStartObjectivePanel_C::RewardsWrapper' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, Shadow) == 0x0002D0, "Member 'UMissionStartObjectivePanel_C::Shadow' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, StartObjectiveIcon) == 0x0002D8, "Member 'UMissionStartObjectivePanel_C::StartObjectiveIcon' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, Title) == 0x0002E0, "Member 'UMissionStartObjectivePanel_C::Title' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, List_Item_Index) == 0x0002E8, "Member 'UMissionStartObjectivePanel_C::List_Item_Index' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, RewardListAnimTimer) == 0x0002F0, "Member 'UMissionStartObjectivePanel_C::RewardListAnimTimer' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, PlaySpeed) == 0x0002F8, "Member 'UMissionStartObjectivePanel_C::PlaySpeed' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, LockoutTimer) == 0x000300, "Member 'UMissionStartObjectivePanel_C::LockoutTimer' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, LockoutEndedAnimFinished) == 0x000308, "Member 'UMissionStartObjectivePanel_C::LockoutEndedAnimFinished' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, HidePanelAnimEnded) == 0x000318, "Member 'UMissionStartObjectivePanel_C::HidePanelAnimEnded' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, CurrentVoteType) == 0x000328, "Member 'UMissionStartObjectivePanel_C::CurrentVoteType' has a wrong offset!");
