...
static_assert(alignof(AGCN_Generic_Taunter_C) == 0x000008, "Wrong alignment on AGCN_Generic_Taunter_C");
static_assert(sizeof(AGCN_Generic_Taunter_C) == 0x000428, "Wrong size on AGCN_Generic_Taunter_C");
