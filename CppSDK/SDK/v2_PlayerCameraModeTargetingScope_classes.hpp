...
static_assert(alignof(Uv2_PlayerCameraModeTargetingScope_C) == 0x000010, "Wrong alignment on Uv2_PlayerCameraModeTargetingScope_C");
static_assert(sizeof(Uv2_PlayerCameraModeTargetingScope_C) == 0x000C50, "Wrong size on Uv2_PlayerCameraModeTargetingScope_C");
