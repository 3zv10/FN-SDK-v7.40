...
static_assert(sizeof(UGA_Athena_PlaysetGrenadeWithTrajectory_C) == 0x000C60, "Wrong size on UGA_Athena_PlaysetGrenadeWithTrajectory_C");
static_assert(offsetof(UGA_Athena_PlaysetGrenadeWithTrajectory_C, UberGraphFrame_GA_Athena_PlaysetGrenadeWithTrajectory_C) == 0x000C38, "Member 'UGA_Athena_PlaysetGrenadeWithTrajectory_C::UberGraphFrame_GA_Athena_PlaysetGrenadeWithTrajectory_C' has a wrong offset!");
static_assert(offsetof(UGA_Athena_PlaysetGrenadeWithTrajectory_C, ProjectileTrajectoryRed) == 0x000C40, "Member 'UGA_Athena_PlaysetGrenadeWithTrajectory_C::ProjectileTrajectoryRed' has a wrong offset!");
static_assert(offsetof(UGA_Athena_PlaysetGrenadeWithTrajectory_C, RedIndicatorClass) == 0x000C48, "Member 'UGA_Athena_PlaysetGrenadeWithTrajectory_C::RedIndicatorClass' has a wrong offset!");
static_assert(offsetof(UGA_Athena_PlaysetGrenadeWithTrajectory_C, DefaultPlayset) == 0x000C50, "Member 'UGA_Athena_PlaysetGrenadeWithTrajectory_C::DefaultPlayset' has a wrong offset!");
static_assert(offsetof(UGA_Athena_PlaysetGrenadeWithTrajectory_C, bShouldNotThrow) == 0x000C58, "Member 'UGA_Athena_PlaysetGrenadeWithTrajectory_C::bShouldNotThrow' has a wrong offset!");
static_assert(offsetof(UGA_Athena_PlaysetGrenadeWithTrajectory_C, CanConsume) == 0x000C59, "Member 'UGA_Athena_PlaysetGrenadeWithTrajectory_C::CanConsume' has a wrong offset!");
