...
static_assert(sizeof(UGameMapsSettings) == 0x000118, "Wrong size on UGameMapsSettings");
...
static_assert(offsetof(UGameMapsSettings, SubLevelClassesToStrip) == 0x000088, "Member 'UGameMapsSettings::SubLevelClassesToStrip' has a wrong offset!");
...
static_assert(offsetof(UGameMapsSettings, ServerDefaultMap) == 0x0000B0, "Member 'UGameMapsSettings::ServerDefaultMap' has a wrong offset!");
static_assert(offsetof(UGameMapsSettings, GlobalDefaultGameMode) == 0x0000C8, "Member 'UGameMapsSettings::GlobalDefaultGameMode' has a wrong offset!");
...
static_assert(offsetof(UGameMapsSettings, GameModeMapPrefixes) == 0x0000F8, "Member 'UGameMapsSettings::GameModeMapPrefixes' has a wrong offset!");
static_assert(offsetof(UGameMapsSettings, GameModeClassAliases) == 0x000108, "Member 'UGameMapsSettings::GameModeClassAliases' has a wrong offset!");
