...
static_assert(offsetof(FMovieSceneTangentData, TangentWeightMode) == 0x000008, "Member 'FMovieSceneTangentData::TangentWeightMode' has a wrong offset!");
static_assert(offsetof(FMovieSceneTangentData, ArriveTangentWeight) == 0x00000C, "Member 'FMovieSceneTangentData::ArriveTangentWeight' has a wrong offset!");
static_assert(offsetof(FMovieSceneTangentData, LeaveTangentWeight) == 0x000010, "Member 'FMovieSceneTangentData::LeaveTangentWeight' has a wrong offset!");
...
static_assert(offsetof(FMovieSceneFloatValue, InterpMode) == 0x000004, "Member 'FMovieSceneFloatValue::InterpMode' has a wrong offset!");
static_assert(offsetof(FMovieSceneFloatValue, TangentMode) == 0x000005, "Member 'FMovieSceneFloatValue::TangentMode' has a wrong offset!");
static_assert(offsetof(FMovieSceneFloatValue, Tangent) == 0x000008, "Member 'FMovieSceneFloatValue::Tangent' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneSequenceTransform) == 0x00000C, "Wrong size on FMovieSceneSequenceTransform");
...
static_assert(sizeof(FMovieSceneEditorData) == 0x0000E0, "Wrong size on FMovieSceneEditorData");
...
static_assert(offsetof(FMovieSceneEditorData, ViewStart) == 0x000050, "Member 'FMovieSceneEditorData::ViewStart' has a wrong offset!");
static_assert(offsetof(FMovieSceneEditorData, ViewEnd) == 0x000058, "Member 'FMovieSceneEditorData::ViewEnd' has a wrong offset!");
static_assert(offsetof(FMovieSceneEditorData, WorkStart) == 0x000060, "Member 'FMovieSceneEditorData::WorkStart' has a wrong offset!");
static_assert(offsetof(FMovieSceneEditorData, WorkEnd) == 0x000068, "Member 'FMovieSceneEditorData::WorkEnd' has a wrong offset!");
static_assert(offsetof(FMovieSceneEditorData, MarkedFrames) == 0x000070, "Member 'FMovieSceneEditorData::MarkedFrames' has a wrong offset!");
static_assert(offsetof(FMovieSceneEditorData, WorkingRange) == 0x0000C0, "Member 'FMovieSceneEditorData::WorkingRange' has a wrong offset!");
static_assert(offsetof(FMovieSceneEditorData, ViewRange) == 0x0000D0, "Member 'FMovieSceneEditorData::ViewRange' has a wrong offset!");
...
static_assert(offsetof(FMovieSceneEvaluationMetaData, SubTemplateSerialNumbers) == 0x000020, "Member 'FMovieSceneEvaluationMetaData::SubTemplateSerialNumbers' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneSubSequenceData) == 0x0000A8, "Wrong size on FMovieSceneSubSequenceData");
...
static_assert(offsetof(FMovieSceneSubSequenceData, TickResolution) == 0x000024, "Member 'FMovieSceneSubSequenceData::TickResolution' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, DeterministicSequenceID) == 0x00002C, "Member 'FMovieSceneSubSequenceData::DeterministicSequenceID' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, PlayRange) == 0x000030, "Member 'FMovieSceneSubSequenceData::PlayRange' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, PreRollRange) == 0x000040, "Member 'FMovieSceneSubSequenceData::PreRollRange' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, PostRollRange) == 0x000050, "Member 'FMovieSceneSubSequenceData::PostRollRange' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, HierarchicalBias) == 0x000060, "Member 'FMovieSceneSubSequenceData::HierarchicalBias' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, InstanceData) == 0x000068, "Member 'FMovieSceneSubSequenceData::InstanceData' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, SubSectionSignature) == 0x000088, "Member 'FMovieSceneSubSequenceData::SubSectionSignature' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, OuterToInnerTransform) == 0x000098, "Member 'FMovieSceneSubSequenceData::OuterToInnerTransform' has a wrong offset!");
...
static_assert(offsetof(FMovieSceneEvaluationTemplate, TemplateSerialNumber) == 0x000180, "Member 'FMovieSceneEvaluationTemplate::TemplateSerialNumber' has a wrong offset!");
static_assert(offsetof(FMovieSceneEvaluationTemplate, TemplateLedger) == 0x000188, "Member 'FMovieSceneEvaluationTemplate::TemplateLedger' has a wrong offset!");
static_assert(offsetof(FMovieSceneEvaluationTemplate, TrackFieldData) == 0x000230, "Member 'FMovieSceneEvaluationTemplate::TrackFieldData' has a wrong offset!");
static_assert(offsetof(FMovieSceneEvaluationTemplate, SubSectionFieldData) == 0x000290, "Member 'FMovieSceneEvaluationTemplate::SubSectionFieldData' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_68[0x298];                                     // 0x0068(0x0298)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FMovieSceneRootEvaluationTemplateInstance) == 0x000300, "Wrong size on FMovieSceneRootEvaluationTemplateInstance");
static_assert(offsetof(FMovieSceneRootEvaluationTemplateInstance, DirectorInstances) == 0x000018, "Member 'FMovieSceneRootEvaluationTemplateInstance::DirectorInstances' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneSectionParameters) == 0x000018, "Wrong size on FMovieSceneSectionParameters");
...
static_assert(offsetof(FMovieSceneSectionParameters, StartOffset) == 0x00000C, "Member 'FMovieSceneSectionParameters::StartOffset' has a wrong offset!");
static_assert(offsetof(FMovieSceneSectionParameters, PrerollTime) == 0x000010, "Member 'FMovieSceneSectionParameters::PrerollTime' has a wrong offset!");
static_assert(offsetof(FMovieSceneSectionParameters, PostrollTime) == 0x000014, "Member 'FMovieSceneSectionParameters::PostrollTime' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneSequencePlaybackSettings) == 0x000010, "Wrong size on FMovieSceneSequencePlaybackSettings");
...
static_assert(offsetof(FMovieSceneSequencePlaybackSettings, StartTime) == 0x000008, "Member 'FMovieSceneSequencePlaybackSettings::StartTime' has a wrong offset!");
...
static_assert(offsetof(FMovieSceneSpawnable, Guid) == 0x000040, "Member 'FMovieSceneSpawnable::Guid' has a wrong offset!");
static_assert(offsetof(FMovieSceneSpawnable, Name) == 0x000050, "Member 'FMovieSceneSpawnable::Name' has a wrong offset!");
static_assert(offsetof(FMovieSceneSpawnable, ObjectTemplate) == 0x000060, "Member 'FMovieSceneSpawnable::ObjectTemplate' has a wrong offset!");
static_assert(offsetof(FMovieSceneSpawnable, ChildPossessables) == 0x000068, "Member 'FMovieSceneSpawnable::ChildPossessables' has a wrong offset!");
static_assert(offsetof(FMovieSceneSpawnable, Ownership) == 0x000078, "Member 'FMovieSceneSpawnable::Ownership' has a wrong offset!");
static_assert(offsetof(FMovieSceneSpawnable, LevelName) == 0x00007C, "Member 'FMovieSceneSpawnable::LevelName' has a wrong offset!");
