...
static_assert(offsetof(PlayerBanner_C_SetBannerImage, CallFunc_Conv_StringToName_ReturnValue1) == 0x00004C, "Member 'PlayerBanner_C_SetBannerImage::CallFunc_Conv_StringToName_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(PlayerBanner_C_SetBannerIconId, CallFunc_NotEqual_NameName_ReturnValue1) == 0x0000A0, "Member 'PlayerBanner_C_SetBannerIconId::CallFunc_NotEqual_NameName_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(PlayerBanner_C_SetBannerColorId, CallFunc_GetBannerMID_BannerMID1) == 0x000038, "Member 'PlayerBanner_C_SetBannerColorId::CallFunc_GetBannerMID_BannerMID1' has a wrong offset!");
...
static_assert(offsetof(PlayerBanner_C_SetBannerColorId, CallFunc_NotEqual_NameName_ReturnValue1) == 0x000060, "Member 'PlayerBanner_C_SetBannerColorId::CallFunc_NotEqual_NameName_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(PlayerBanner_C_SetBannerOwner, K2Node_CreateDelegate_OutputDelegate1) == 0x000038, "Member 'PlayerBanner_C_SetBannerOwner::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(PlayerBanner_C_SetBannerOwner, CallFunc_GetContext_ReturnValue1) == 0x000060, "Member 'PlayerBanner_C_SetBannerOwner::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(PlayerBanner_C_ToggleBannerMask, Temp_float_Variable1) == 0x000008, "Member 'PlayerBanner_C_ToggleBannerMask::Temp_float_Variable1' has a wrong offset!");
...
static_assert(sizeof(PlayerBanner_C_SetBannerIconAndColorFromProfile) == 0x000150, "Wrong size on PlayerBanner_C_SetBannerIconAndColorFromProfile");
...
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_GetSubGame_ReturnValue) == 0x0000F0, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_GetSubGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x0000F1, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_Conv_StringToName_ReturnValue) == 0x0000F4, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_Conv_StringToName_ReturnValue1) == 0x0000FC, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_Conv_StringToName_ReturnValue1' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_GetHomeBaseInfoForPlayer_Result) == 0x000108, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_GetHomeBaseInfoForPlayer_Result' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_SetBannerImage_Success) == 0x000148, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_SetBannerImage_Success' has a wrong offset!");
...
static_assert(offsetof(PlayerBanner_C_UnbindDelegates, K2Node_CreateDelegate_OutputDelegate1) == 0x000020, "Member 'PlayerBanner_C_UnbindDelegates::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_UnbindDelegates, CallFunc_GetContext_ReturnValue1) == 0x000030, "Member 'PlayerBanner_C_UnbindDelegates::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
