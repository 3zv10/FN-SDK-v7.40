...
static_assert(sizeof(UFrontEndRewards_ChoiceRewards_C) == 0x000348, "Wrong size on UFrontEndRewards_ChoiceRewards_C");
...
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, ChooseRewardSound) == 0x000338, "Member 'UFrontEndRewards_ChoiceRewards_C::ChooseRewardSound' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, ChooseRewardGivenSound) == 0x000340, "Member 'UFrontEndRewards_ChoiceRewards_C::ChooseRewardGivenSound' has a wrong offset!");
