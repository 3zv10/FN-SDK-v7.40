...
#include "GCN_Twinblast_classes.hpp"
#include "GCN_Twinblast_parameters.hpp"
...
bool UGCN_Twinblast_C::OnExecute(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters) const
{
	...
	Params::GCN_Twinblast_C_OnExecute Parms{};
