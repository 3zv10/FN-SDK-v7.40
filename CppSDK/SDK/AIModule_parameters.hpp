...
static_assert(alignof(AIController_OnPossess) == 0x000008, "Wrong alignment on AIController_OnPossess");
static_assert(sizeof(AIController_OnPossess) == 0x000008, "Wrong size on AIController_OnPossess");
...
static_assert(alignof(AIController_OnUnpossess) == 0x000008, "Wrong alignment on AIController_OnUnpossess");
static_assert(sizeof(AIController_OnUnpossess) == 0x000008, "Wrong size on AIController_OnUnpossess");
...
static_assert(sizeof(AIBlueprintHelperLibrary_SpawnAIFromClass) == 0x000040, "Wrong size on AIBlueprintHelperLibrary_SpawnAIFromClass");
...
static_assert(offsetof(AIBlueprintHelperLibrary_SpawnAIFromClass, ReturnValue) == 0x000038, "Member 'AIBlueprintHelperLibrary_SpawnAIFromClass::ReturnValue' has a wrong offset!");
