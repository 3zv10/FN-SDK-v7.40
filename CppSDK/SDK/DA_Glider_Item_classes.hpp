...
static_assert(sizeof(ADA_Glider_Item_C) == 0x000A78, "Wrong size on ADA_Glider_Item_C");
static_assert(offsetof(ADA_Glider_Item_C, UberGraphFrame) == 0x000A10, "Member 'ADA_Glider_Item_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ADA_Glider_Item_C, ErrorReason) == 0x000A18, "Member 'ADA_Glider_Item_C::ErrorReason' has a wrong offset!");
static_assert(offsetof(ADA_Glider_Item_C, ErrorReasonGamepad) == 0x000A38, "Member 'ADA_Glider_Item_C::ErrorReasonGamepad' has a wrong offset!");
static_assert(offsetof(ADA_Glider_Item_C, ErrorCannotUse) == 0x000A58, "Member 'ADA_Glider_Item_C::ErrorCannotUse' has a wrong offset!");
