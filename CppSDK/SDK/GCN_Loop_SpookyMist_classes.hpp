...
static_assert(sizeof(AGCN_Loop_SpookyMist_C) == 0x0009C0, "Wrong size on AGCN_Loop_SpookyMist_C");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, UberGraphFrame) == 0x000880, "Member 'AGCN_Loop_SpookyMist_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, PostProcess) == 0x000888, "Member 'AGCN_Loop_SpookyMist_C::PostProcess' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, FadeInOut_Visbility_642089304BE20EFA276DDA9C98DD3C71) == 0x000890, "Member 'AGCN_Loop_SpookyMist_C::FadeInOut_Visbility_642089304BE20EFA276DDA9C98DD3C71' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, FadeInOut__Direction_642089304BE20EFA276DDA9C98DD3C71) == 0x000894, "Member 'AGCN_Loop_SpookyMist_C::FadeInOut__Direction_642089304BE20EFA276DDA9C98DD3C71' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, FadeInOut) == 0x000898, "Member 'AGCN_Loop_SpookyMist_C::FadeInOut' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, TargetPlayer) == 0x0008A0, "Member 'AGCN_Loop_SpookyMist_C::TargetPlayer' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, ExpirationSoundPeriod) == 0x0008A8, "Member 'AGCN_Loop_SpookyMist_C::ExpirationSoundPeriod' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, VelocityInterp) == 0x0008AC, "Member 'AGCN_Loop_SpookyMist_C::VelocityInterp' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, AttachedFX) == 0x0008B0, "Member 'AGCN_Loop_SpookyMist_C::AttachedFX' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, PlayerSkeletalMeshes) == 0x0008C0, "Member 'AGCN_Loop_SpookyMist_C::PlayerSkeletalMeshes' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, FriendlyPlayer) == 0x0008D0, "Member 'AGCN_Loop_SpookyMist_C::FriendlyPlayer' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, ExpireTellDelayTimer) == 0x0008D8, "Member 'AGCN_Loop_SpookyMist_C::ExpireTellDelayTimer' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, ExpirationSoundTimer) == 0x0008E0, "Member 'AGCN_Loop_SpookyMist_C::ExpirationSoundTimer' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, VisbilityLevel) == 0x0008E8, "Member 'AGCN_Loop_SpookyMist_C::VisbilityLevel' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, WalkVisMultiplier) == 0x0008EC, "Member 'AGCN_Loop_SpookyMist_C::WalkVisMultiplier' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, SprintVisMultiplier) == 0x0008F0, "Member 'AGCN_Loop_SpookyMist_C::SprintVisMultiplier' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, MinFriendlyOpacity) == 0x0008F4, "Member 'AGCN_Loop_SpookyMist_C::MinFriendlyOpacity' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, InteractVisibility) == 0x0008F8, "Member 'AGCN_Loop_SpookyMist_C::InteractVisibility' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, DataDuration) == 0x000900, "Member 'AGCN_Loop_SpookyMist_C::DataDuration' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, DataTellDuration) == 0x000920, "Member 'AGCN_Loop_SpookyMist_C::DataTellDuration' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, DataWalkVisMult) == 0x000940, "Member 'AGCN_Loop_SpookyMist_C::DataWalkVisMult' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, DataSprintVisMult) == 0x000960, "Member 'AGCN_Loop_SpookyMist_C::DataSprintVisMult' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, DataFriendlyVisMult) == 0x000980, "Member 'AGCN_Loop_SpookyMist_C::DataFriendlyVisMult' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SpookyMist_C, DataShadowPlaneOpacity) == 0x0009A0, "Member 'AGCN_Loop_SpookyMist_C::DataShadowPlaneOpacity' has a wrong offset!");
