...
static_assert(alignof(FMovieSceneEvent) == 0x000004, "Wrong alignment on FMovieSceneEvent");
static_assert(sizeof(FMovieSceneEvent) == 0x000008, "Wrong size on FMovieSceneEvent");
static_assert(offsetof(FMovieSceneEvent, FunctionName) == 0x000000, "Member 'FMovieSceneEvent::FunctionName' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneSkeletalAnimationParams) == 0x0000C8, "Wrong size on FMovieSceneSkeletalAnimationParams");
...
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, bSkipAnimNotifiers) == 0x0000C0, "Member 'FMovieSceneSkeletalAnimationParams::bSkipAnimNotifiers' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneSkeletalAnimationSectionTemplateParameters) == 0x0000D0, "Wrong size on FMovieSceneSkeletalAnimationSectionTemplateParameters");
static_assert(offsetof(FMovieSceneSkeletalAnimationSectionTemplateParameters, SectionStartTime) == 0x0000C8, "Member 'FMovieSceneSkeletalAnimationSectionTemplateParameters::SectionStartTime' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationSectionTemplateParameters, SectionEndTime) == 0x0000CC, "Member 'FMovieSceneSkeletalAnimationSectionTemplateParameters::SectionEndTime' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneSkeletalAnimationSectionTemplate) == 0x0000F0, "Wrong size on FMovieSceneSkeletalAnimationSectionTemplate");
...
static_assert(sizeof(FMovieSceneActorReferenceKey) == 0x000018, "Wrong size on FMovieSceneActorReferenceKey");
...
static_assert(sizeof(FMovieSceneActorReferenceData) == 0x0000A0, "Wrong size on FMovieSceneActorReferenceData");
...
static_assert(offsetof(FMovieSceneActorReferenceData, KeyValues) == 0x000030, "Member 'FMovieSceneActorReferenceData::KeyValues' has a wrong offset!");
...
public:
	...
	TDelegate<void(const TArray<struct FSubtitleCue>& Subtitles, float CueDuration)> OnQueueSubtitles; // 0x0168(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FMovieSceneAudioSectionTemplateData) == 0x000198, "Wrong size on FMovieSceneAudioSectionTemplateData");
...
static_assert(offsetof(FMovieSceneAudioSectionTemplateData, SectionStartTimeSeconds) == 0x000010, "Member 'FMovieSceneAudioSectionTemplateData::SectionStartTimeSeconds' has a wrong offset!");
static_assert(offsetof(FMovieSceneAudioSectionTemplateData, AudioPitchMultiplierCurve) == 0x000018, "Member 'FMovieSceneAudioSectionTemplateData::AudioPitchMultiplierCurve' has a wrong offset!");
static_assert(offsetof(FMovieSceneAudioSectionTemplateData, AudioVolumeCurve) == 0x0000B8, "Member 'FMovieSceneAudioSectionTemplateData::AudioVolumeCurve' has a wrong offset!");
static_assert(offsetof(FMovieSceneAudioSectionTemplateData, RowIndex) == 0x000158, "Member 'FMovieSceneAudioSectionTemplateData::RowIndex' has a wrong offset!");
static_assert(offsetof(FMovieSceneAudioSectionTemplateData, bOverrideAttenuation) == 0x00015C, "Member 'FMovieSceneAudioSectionTemplateData::bOverrideAttenuation' has a wrong offset!");
static_assert(offsetof(FMovieSceneAudioSectionTemplateData, AttenuationSettings) == 0x000160, "Member 'FMovieSceneAudioSectionTemplateData::AttenuationSettings' has a wrong offset!");
static_assert(offsetof(FMovieSceneAudioSectionTemplateData, OnQueueSubtitles) == 0x000168, "Member 'FMovieSceneAudioSectionTemplateData::OnQueueSubtitles' has a wrong offset!");
static_assert(offsetof(FMovieSceneAudioSectionTemplateData, OnAudioFinished) == 0x000178, "Member 'FMovieSceneAudioSectionTemplateData::OnAudioFinished' has a wrong offset!");
static_assert(offsetof(FMovieSceneAudioSectionTemplateData, OnAudioPlaybackPercent) == 0x000188, "Member 'FMovieSceneAudioSectionTemplateData::OnAudioPlaybackPercent' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneAudioSectionTemplate) == 0x0001B8, "Wrong size on FMovieSceneAudioSectionTemplate");
...
static_assert(sizeof(FMovieSceneEventRepeaterTemplate) == 0x000040, "Wrong size on FMovieSceneEventRepeaterTemplate");
...
static_assert(offsetof(FMovieSceneEventTriggerTemplate, EventFunctions) == 0x000048, "Member 'FMovieSceneEventTriggerTemplate::EventFunctions' has a wrong offset!");
