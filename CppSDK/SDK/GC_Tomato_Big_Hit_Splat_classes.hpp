...
static_assert(alignof(UGC_Tomato_Big_Hit_Splat_C) == 0x000008, "Wrong alignment on UGC_Tomato_Big_Hit_Splat_C");
static_assert(sizeof(UGC_Tomato_Big_Hit_Splat_C) == 0x0001A0, "Wrong size on UGC_Tomato_Big_Hit_Splat_C");
