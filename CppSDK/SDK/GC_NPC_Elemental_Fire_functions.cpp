...
#include "GC_NPC_Elemental_Fire_classes.hpp"
#include "GC_NPC_Elemental_Fire_parameters.hpp"
...
void AGC_NPC_Elemental_Fire_C::ExecuteUbergraph_GC_NPC_Elemental_Fire(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_NPC_Elemental_Fire_C", "ExecuteUbergraph_GC_NPC_Elemental_Fire");

	Params::GC_NPC_Elemental_Fire_C_ExecuteUbergraph_GC_NPC_Elemental_Fire Parms{};
...
void AGC_NPC_Elemental_Fire_C::Rerun()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GC_NPC_Elemental_Fire_C", "Rerun");
...
void AGC_NPC_Elemental_Fire_C::K2_HandleGameplayCue(class AActor* MyTarget, EGameplayCueEvent EventType, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_NPC_Elemental_Fire_C", "K2_HandleGameplayCue");

	Params::GC_NPC_Elemental_Fire_C_K2_HandleGameplayCue Parms{};
...
void AGC_NPC_Elemental_Fire_C::UserConstructionScript()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GC_NPC_Elemental_Fire_C", "UserConstructionScript");
...
bool AGC_NPC_Elemental_Fire_C::OnRemove(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_NPC_Elemental_Fire_C", "OnRemove");

	Params::GC_NPC_Elemental_Fire_C_OnRemove Parms{};
...
void AGC_NPC_Elemental_Fire_C::Death_FX_Setup(bool Remove, class AEnemyPawn_Parent_C* Pawn)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GC_NPC_Elemental_Fire_C", "Death FX Setup");

	Params::GC_NPC_Elemental_Fire_C_Death_FX_Setup Parms{};
