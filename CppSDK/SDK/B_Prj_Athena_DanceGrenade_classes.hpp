...
static_assert(sizeof(AB_Prj_Athena_DanceGrenade_C) == 0x0008B0, "Wrong size on AB_Prj_Athena_DanceGrenade_C");
static_assert(offsetof(AB_Prj_Athena_DanceGrenade_C, UberGraphFrame_B_Prj_Athena_DanceGrenade_C) == 0x000828, "Member 'AB_Prj_Athena_DanceGrenade_C::UberGraphFrame_B_Prj_Athena_DanceGrenade_C' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_DanceGrenade_C, StunAbility) == 0x000830, "Member 'AB_Prj_Athena_DanceGrenade_C::StunAbility' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_DanceGrenade_C, ControllerWhoThrew) == 0x000850, "Member 'AB_Prj_Athena_DanceGrenade_C::ControllerWhoThrew' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_DanceGrenade_C, QuestItem) == 0x000858, "Member 'AB_Prj_Athena_DanceGrenade_C::QuestItem' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_DanceGrenade_C, ObjBackendName) == 0x000860, "Member 'AB_Prj_Athena_DanceGrenade_C::ObjBackendName' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_DanceGrenade_C, ObjStat) == 0x000868, "Member 'AB_Prj_Athena_DanceGrenade_C::ObjStat' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_DanceGrenade_C, QuestSuccessSound) == 0x000878, "Member 'AB_Prj_Athena_DanceGrenade_C::QuestSuccessSound' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_DanceGrenade_C, QuestSuccessEmitter) == 0x000880, "Member 'AB_Prj_Athena_DanceGrenade_C::QuestSuccessEmitter' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_DanceGrenade_C, Target) == 0x000888, "Member 'AB_Prj_Athena_DanceGrenade_C::Target' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_DanceGrenade_C, QuestItem_2) == 0x000890, "Member 'AB_Prj_Athena_DanceGrenade_C::QuestItem_2' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_DanceGrenade_C, ObjBackendName_2) == 0x000898, "Member 'AB_Prj_Athena_DanceGrenade_C::ObjBackendName_2' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_DanceGrenade_C, ObjStat_2) == 0x0008A0, "Member 'AB_Prj_Athena_DanceGrenade_C::ObjStat_2' has a wrong offset!");
