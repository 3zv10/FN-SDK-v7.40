...
static_assert(sizeof(AGCN_RiftSpawner_DMG_Stage_00_Loop_C) == 0x000888, "Wrong size on AGCN_RiftSpawner_DMG_Stage_00_Loop_C");
static_assert(offsetof(AGCN_RiftSpawner_DMG_Stage_00_Loop_C, UberGraphFrame) == 0x000880, "Member 'AGCN_RiftSpawner_DMG_Stage_00_Loop_C::UberGraphFrame' has a wrong offset!");
