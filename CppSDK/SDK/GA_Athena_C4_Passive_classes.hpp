...
static_assert(sizeof(UGA_Athena_C4_Passive_C) == 0x000950, "Wrong size on UGA_Athena_C4_Passive_C");
static_assert(offsetof(UGA_Athena_C4_Passive_C, UberGraphFrame) == 0x000938, "Member 'UGA_Athena_C4_Passive_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_Athena_C4_Passive_C, TrackGroupTag) == 0x000940, "Member 'UGA_Athena_C4_Passive_C::TrackGroupTag' has a wrong offset!");
static_assert(offsetof(UGA_Athena_C4_Passive_C, C4ItemDef) == 0x000948, "Member 'UGA_Athena_C4_Passive_C::C4ItemDef' has a wrong offset!");
