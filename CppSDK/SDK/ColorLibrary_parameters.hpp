...
static_assert(offsetof(ColorLibrary_C_Get_Base___Buff_Colors, Temp_struct_Variable2) == 0x0001E4, "Member 'ColorLibrary_C_Get_Base___Buff_Colors::Temp_struct_Variable2' has a wrong offset!");
