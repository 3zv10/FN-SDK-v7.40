...
static_assert(sizeof(AAIGoalManager_C) == 0x000450, "Wrong size on AAIGoalManager_C");
static_assert(offsetof(AAIGoalManager_C, DefaultSceneRoot) == 0x000448, "Member 'AAIGoalManager_C::DefaultSceneRoot' has a wrong offset!");
