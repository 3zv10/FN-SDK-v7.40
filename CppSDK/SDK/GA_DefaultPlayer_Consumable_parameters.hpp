...
public:
	...
	TDelegate<void(const struct FGameplayAbilityTargetDataHandle& TargetData, const struct FGameplayTag& ApplicationTag)> K2Node_CreateDelegate_OutputDelegate2; // 0x0178(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(offsetof(GA_DefaultPlayer_Consumable_C_ExecuteUbergraph_GA_DefaultPlayer_Consumable, K2Node_CustomEvent_TargetData2) == 0x0000D0, "Member 'GA_DefaultPlayer_Consumable_C_ExecuteUbergraph_GA_DefaultPlayer_Consumable::K2Node_CustomEvent_TargetData2' has a wrong offset!");
static_assert(offsetof(GA_DefaultPlayer_Consumable_C_ExecuteUbergraph_GA_DefaultPlayer_Consumable, K2Node_CustomEvent_ApplicationTag2) == 0x0000F0, "Member 'GA_DefaultPlayer_Consumable_C_ExecuteUbergraph_GA_DefaultPlayer_Consumable::K2Node_CustomEvent_ApplicationTag2' has a wrong offset!");
...
static_assert(offsetof(GA_DefaultPlayer_Consumable_C_ExecuteUbergraph_GA_DefaultPlayer_Consumable, K2Node_CreateDelegate_OutputDelegate2) == 0x000178, "Member 'GA_DefaultPlayer_Consumable_C_ExecuteUbergraph_GA_DefaultPlayer_Consumable::K2Node_CreateDelegate_OutputDelegate2' has a wrong offset!");
