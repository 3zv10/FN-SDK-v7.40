...
static_assert(sizeof(GCN_Zipline_SpeedLines_C_OnBurst) == 0x000438, "Wrong size on GCN_Zipline_SpeedLines_C_OnBurst");
...
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_Greater_IntInt_ReturnValue) == 0x000194, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_K2_SetWorldRotation_SweepHitResult) == 0x000198, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_K2_SetWorldRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_GetForwardVector_ReturnValue) == 0x000220, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_GetForwardVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_K2_GetComponentLocation_ReturnValue) == 0x00022C, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_K2_GetComponentLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_Multiply_VectorFloat_ReturnValue) == 0x000238, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_Multiply_VectorFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, K2Node_MakeArray_Array) == 0x000248, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_Add_VectorVector_ReturnValue) == 0x000258, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_Add_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_Subtract_VectorVector_ReturnValue) == 0x000264, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_Subtract_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_Add_VectorVector_ReturnValue1) == 0x000270, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_Add_VectorVector_ReturnValue1' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_LineTraceSingleForObjects_OutHit) == 0x00027C, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_LineTraceSingleForObjects_OutHit' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_LineTraceSingleForObjects_ReturnValue) == 0x000304, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_LineTraceSingleForObjects_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_bBlockingHit) == 0x000305, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_bBlockingHit' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_bInitialOverlap) == 0x000306, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_bInitialOverlap' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_Time) == 0x000308, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_Time' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_Distance) == 0x00030C, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_Distance' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_Location) == 0x000310, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_Location' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_ImpactPoint) == 0x00031C, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_ImpactPoint' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_Normal) == 0x000328, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_Normal' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_ImpactNormal) == 0x000334, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_ImpactNormal' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_PhysMat) == 0x000340, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_PhysMat' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_HitActor) == 0x000348, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_HitActor' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_HitComponent) == 0x000350, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_HitComponent' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_HitBoneName) == 0x000358, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_HitBoneName' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_HitItem) == 0x000360, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_HitItem' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_FaceIndex) == 0x000364, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_FaceIndex' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_TraceStart) == 0x000368, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_TraceStart' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_TraceEnd) == 0x000374, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_TraceEnd' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_Multiply_VectorFloat_ReturnValue1) == 0x000380, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_Multiply_VectorFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_Conv_VectorToRotator_ReturnValue) == 0x00038C, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_Conv_VectorToRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_Conv_VectorToRotator_ReturnValue1) == 0x000398, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_Conv_VectorToRotator_ReturnValue1' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult) == 0x0003A4, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_SpawnDecalAtLocation_ReturnValue) == 0x000430, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_SpawnDecalAtLocation_ReturnValue' has a wrong offset!");
