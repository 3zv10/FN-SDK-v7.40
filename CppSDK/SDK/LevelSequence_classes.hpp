...
static_assert(offsetof(ULevelSequence, DirectorClass) == 0x000350, "Member 'ULevelSequence::DirectorClass' has a wrong offset!");
static_assert(offsetof(ULevelSequence, ObjectReferences) == 0x000358, "Member 'ULevelSequence::ObjectReferences' has a wrong offset!");
static_assert(offsetof(ULevelSequence, BindingReferences) == 0x0003A8, "Member 'ULevelSequence::BindingReferences' has a wrong offset!");
static_assert(offsetof(ULevelSequence, PossessedObjects) == 0x000448, "Member 'ULevelSequence::PossessedObjects' has a wrong offset!");
...
static_assert(sizeof(ALevelSequenceActor) == 0x0003A8, "Wrong size on ALevelSequenceActor");
static_assert(offsetof(ALevelSequenceActor, PlaybackSettings) == 0x000340, "Member 'ALevelSequenceActor::PlaybackSettings' has a wrong offset!");
...
static_assert(offsetof(ALevelSequenceActor, DefaultInstanceData) == 0x000398, "Member 'ALevelSequenceActor::DefaultInstanceData' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BurnInInstance) == 0x0003A0, "Member 'ALevelSequenceActor::BurnInInstance' has a wrong offset!");
...
static_assert(sizeof(ULevelSequenceBurnIn) == 0x0002C0, "Wrong size on ULevelSequenceBurnIn");
...
static_assert(offsetof(ULevelSequenceBurnIn, LevelSequenceActor) == 0x0002B8, "Member 'ULevelSequenceBurnIn::LevelSequenceActor' has a wrong offset!");
...
static_assert(sizeof(ULegacyLevelSequenceDirectorBlueprint) == 0x0000E0, "Wrong size on ULegacyLevelSequenceDirectorBlueprint");
...
static_assert(sizeof(ULevelSequencePlayer) == 0x000860, "Wrong size on ULevelSequencePlayer");
static_assert(offsetof(ULevelSequencePlayer, OnCameraCut) == 0x0007C0, "Member 'ULevelSequencePlayer::OnCameraCut' has a wrong offset!");
