...
static_assert(offsetof(Minigame_PlayerCreated_C_OnClientExitVolume, Volume_0) == 0x000008, "Member 'Minigame_PlayerCreated_C_OnClientExitVolume::Volume_0' has a wrong offset!");
...
static_assert(offsetof(Minigame_PlayerCreated_C_OnClientEnterVolume, Volume_0) == 0x000008, "Member 'Minigame_PlayerCreated_C_OnClientEnterVolume::Volume_0' has a wrong offset!");
