...
// Parameters:
// const struct FStatGroupData&            StatGroupData                                          (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// int32                                   Index_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UPieChartStatWidget_C::AddStat(const struct FStatGroupData& StatGroupData, int32 Index_0)
{
	static class UFunction* Func = nullptr;
