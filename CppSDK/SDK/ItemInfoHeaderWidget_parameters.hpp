...
static_assert(offsetof(ItemInfoHeaderWidget_C_ExecuteUbergraph_ItemInfoHeaderWidget, Temp_byte_Variable1) == 0x000005, "Member 'ItemInfoHeaderWidget_C_ExecuteUbergraph_ItemInfoHeaderWidget::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(ItemInfoHeaderWidget_C_ExecuteUbergraph_ItemInfoHeaderWidget, Temp_byte_Variable2) == 0x000007, "Member 'ItemInfoHeaderWidget_C_ExecuteUbergraph_ItemInfoHeaderWidget::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_ExecuteUbergraph_ItemInfoHeaderWidget, Temp_byte_Variable3) == 0x000008, "Member 'ItemInfoHeaderWidget_C_ExecuteUbergraph_ItemInfoHeaderWidget::Temp_byte_Variable3' has a wrong offset!");
...
static_assert(offsetof(ItemInfoHeaderWidget_C_ExecuteUbergraph_ItemInfoHeaderWidget, Temp_bool_Variable1) == 0x000018, "Member 'ItemInfoHeaderWidget_C_ExecuteUbergraph_ItemInfoHeaderWidget::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(ItemInfoHeaderWidget_C_ExecuteUbergraph_ItemInfoHeaderWidget, K2Node_Select1_Default) == 0x00001B, "Member 'ItemInfoHeaderWidget_C_ExecuteUbergraph_ItemInfoHeaderWidget::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(sizeof(ItemInfoHeaderWidget_C_Update) == 0x000100, "Wrong size on ItemInfoHeaderWidget_C_Update");
...
static_assert(offsetof(ItemInfoHeaderWidget_C_Update, CallFunc_GetShortDescription_ReturnValue) == 0x000028, "Member 'ItemInfoHeaderWidget_C_Update::CallFunc_GetShortDescription_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_Update, CallFunc_GetRarity_ReturnValue) == 0x000040, "Member 'ItemInfoHeaderWidget_C_Update::CallFunc_GetRarity_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_Update, CallFunc_TextIsEmpty_ReturnValue) == 0x000041, "Member 'ItemInfoHeaderWidget_C_Update::CallFunc_TextIsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_Update, CallFunc_BPGetRarityData_ReturnValue) == 0x000048, "Member 'ItemInfoHeaderWidget_C_Update::CallFunc_BPGetRarityData_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_Update, CallFunc_TextToUpper_ReturnValue) == 0x0000C8, "Member 'ItemInfoHeaderWidget_C_Update::CallFunc_TextToUpper_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_Update, CallFunc_TextToUpper_ReturnValue1) == 0x0000E0, "Member 'ItemInfoHeaderWidget_C_Update::CallFunc_TextToUpper_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_Update, Temp_byte_Variable1) == 0x0000F8, "Member 'ItemInfoHeaderWidget_C_Update::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_Update, Temp_bool_Variable) == 0x0000F9, "Member 'ItemInfoHeaderWidget_C_Update::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_Update, K2Node_Select_Default) == 0x0000FA, "Member 'ItemInfoHeaderWidget_C_Update::K2Node_Select_Default' has a wrong offset!");
...
static_assert(offsetof(ItemInfoHeaderWidget_C_UpdateNameText, CallFunc_TextToUpper_ReturnValue1) == 0x000058, "Member 'ItemInfoHeaderWidget_C_UpdateNameText::CallFunc_TextToUpper_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_UpdateNameText, CallFunc_TextToUpper_ReturnValue2) == 0x000070, "Member 'ItemInfoHeaderWidget_C_UpdateNameText::CallFunc_TextToUpper_ReturnValue2' has a wrong offset!");
...
static_assert(offsetof(ItemInfoHeaderWidget_C_UpdateNameText, K2Node_MakeStruct_FormatArgumentData1) == 0x0000C8, "Member 'ItemInfoHeaderWidget_C_UpdateNameText::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_UpdateNameText, K2Node_MakeStruct_FormatArgumentData2) == 0x000108, "Member 'ItemInfoHeaderWidget_C_UpdateNameText::K2Node_MakeStruct_FormatArgumentData2' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_UpdateNameText, K2Node_MakeStruct_FormatArgumentData3) == 0x000148, "Member 'ItemInfoHeaderWidget_C_UpdateNameText::K2Node_MakeStruct_FormatArgumentData3' has a wrong offset!");
...
static_assert(offsetof(ItemInfoHeaderWidget_C_UpdateNameText, K2Node_MakeArray_Array1) == 0x000198, "Member 'ItemInfoHeaderWidget_C_UpdateNameText::K2Node_MakeArray_Array1' has a wrong offset!");
...
static_assert(offsetof(ItemInfoHeaderWidget_C_UpdateNameText, CallFunc_Format_ReturnValue1) == 0x0001C0, "Member 'ItemInfoHeaderWidget_C_UpdateNameText::CallFunc_Format_ReturnValue1' has a wrong offset!");
...
static_assert(alignof(ItemInfoHeaderWidget_C_SetScrollWidget) == 0x000008, "Wrong alignment on ItemInfoHeaderWidget_C_SetScrollWidget");
static_assert(sizeof(ItemInfoHeaderWidget_C_SetScrollWidget) == 0x000008, "Wrong size on ItemInfoHeaderWidget_C_SetScrollWidget");
static_assert(offsetof(ItemInfoHeaderWidget_C_SetScrollWidget, CallFunc_GetUINavigationManager_ReturnValue) == 0x000000, "Member 'ItemInfoHeaderWidget_C_SetScrollWidget::CallFunc_GetUINavigationManager_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemInfoHeaderWidget_C_UpdateDetailVisibility, Temp_byte_Variable1) == 0x000001, "Member 'ItemInfoHeaderWidget_C_UpdateDetailVisibility::Temp_byte_Variable1' has a wrong offset!");
...
public:
	...
	ESlateVisibility                              K2Node_Select1_Default;                            // 0x00F9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription) == 0x000008, "Wrong alignment on ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription");
static_assert(sizeof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription) == 0x000100, "Wrong size on ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, Hearder) == 0x000000, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::Hearder' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, Desciption) == 0x000018, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::Desciption' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, ItemType) == 0x000030, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::ItemType' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, bUseAlternateHeaderBG) == 0x000048, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::bUseAlternateHeaderBG' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, Temp_byte_Variable) == 0x000049, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, CallFunc_TextToUpper_ReturnValue) == 0x000050, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::CallFunc_TextToUpper_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, Temp_bool_Variable) == 0x000068, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, Temp_byte_Variable1) == 0x000069, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, K2Node_Select_Default) == 0x000070, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, CallFunc_BPGetRarityData_ReturnValue) == 0x000078, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::CallFunc_BPGetRarityData_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, Temp_bool_Variable1) == 0x0000F8, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, K2Node_Select1_Default) == 0x0000F9, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(sizeof(ItemInfoHeaderWidget_C_UpdateColorRarity) == 0x0000C8, "Wrong size on ItemInfoHeaderWidget_C_UpdateColorRarity");
static_assert(offsetof(ItemInfoHeaderWidget_C_UpdateColorRarity, NewParam) == 0x000000, "Member 'ItemInfoHeaderWidget_C_UpdateColorRarity::NewParam' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_UpdateColorRarity, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000080, "Member 'ItemInfoHeaderWidget_C_UpdateColorRarity::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_UpdateColorRarity, K2Node_MakeStruct_SlateColor) == 0x000088, "Member 'ItemInfoHeaderWidget_C_UpdateColorRarity::K2Node_MakeStruct_SlateColor' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_UpdateColorRarity, CallFunc_GetDynamicFontMaterial_ReturnValue) == 0x0000B0, "Member 'ItemInfoHeaderWidget_C_UpdateColorRarity::CallFunc_GetDynamicFontMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_UpdateColorRarity, CallFunc_GetDynamicMaterial_ReturnValue1) == 0x0000B8, "Member 'ItemInfoHeaderWidget_C_UpdateColorRarity::CallFunc_GetDynamicMaterial_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_UpdateColorRarity, CallFunc_GetDynamicMaterial_ReturnValue2) == 0x0000C0, "Member 'ItemInfoHeaderWidget_C_UpdateColorRarity::CallFunc_GetDynamicMaterial_ReturnValue2' has a wrong offset!");
...
static_assert(offsetof(ItemInfoHeaderWidget_C_GetAlternateNameForItem, Temp_text_Variable1) == 0x000058, "Member 'ItemInfoHeaderWidget_C_GetAlternateNameForItem::Temp_text_Variable1' has a wrong offset!");
...
static_assert(offsetof(ItemInfoHeaderWidget_C_GetAlternateNameForItem, CallFunc_GetItemType_ReturnValue1) == 0x000071, "Member 'ItemInfoHeaderWidget_C_GetAlternateNameForItem::CallFunc_GetItemType_ReturnValue1' has a wrong offset!");
