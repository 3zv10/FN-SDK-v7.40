...
static_assert(offsetof(EventStoreHostPanels_C_ExecuteUbergraph_EventStoreHostPanels, K2Node_DynamicCast_AsFort_Item_Details_Host_Panel1) == 0x000030, "Member 'EventStoreHostPanels_C_ExecuteUbergraph_EventStoreHostPanels::K2Node_DynamicCast_AsFort_Item_Details_Host_Panel1' has a wrong offset!");
static_assert(offsetof(EventStoreHostPanels_C_ExecuteUbergraph_EventStoreHostPanels, K2Node_DynamicCast_bSuccess1) == 0x000038, "Member 'EventStoreHostPanels_C_ExecuteUbergraph_EventStoreHostPanels::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
