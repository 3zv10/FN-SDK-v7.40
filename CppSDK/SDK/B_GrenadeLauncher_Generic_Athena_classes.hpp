...
static_assert(sizeof(AB_GrenadeLauncher_Generic_Athena_C) == 0x000DF8, "Wrong size on AB_GrenadeLauncher_Generic_Athena_C");
static_assert(offsetof(AB_GrenadeLauncher_Generic_Athena_C, Reload_MagazineReload) == 0x000DE8, "Member 'AB_GrenadeLauncher_Generic_Athena_C::Reload_MagazineReload' has a wrong offset!");
static_assert(offsetof(AB_GrenadeLauncher_Generic_Athena_C, Reload_Ammo) == 0x000DF0, "Member 'AB_GrenadeLauncher_Generic_Athena_C::Reload_Ammo' has a wrong offset!");
