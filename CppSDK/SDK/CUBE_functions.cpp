...
void ACUBE_C::Three__DuplicateSpecified()
{
	static class UFunction* Func = nullptr;
...
void ACUBE_C::Two__DeleteLastIndex()
{
	static class UFunction* Func = nullptr;
...
void ACUBE_C::One___DupLastIndex()
{
	static class UFunction* Func = nullptr;
...
// const struct FTimespan&                 TimeUntilEnd_0                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void ACUBE_C::OnEventActive_750DF2F749472DA252073089796089C8(const class FString& EventName, const struct FTimespan& TimeUntilEnd_0, const struct FTimespan& TimeSinceBegin, float TimespanRatio)
{
	static class UFunction* Func = nullptr;
	...
	Parms.TimeUntilEnd_0 = std::move(TimeUntilEnd_0);
...
void ACUBE_C::OnEventUpdated_750DF2F749472DA252073089796089C8(const class FString& EventName, const struct FTimespan& TimeUntilEnd_0, const struct FTimespan& TimeSinceBegin, float TimespanRatio)
{
	static class UFunction* Func = nullptr;
...
void ACUBE_C::OnEventEnded_750DF2F749472DA252073089796089C8(const class FString& EventName, const struct FTimespan& TimeUntilEnd_0, const struct FTimespan& TimeSinceBegin, float TimespanRatio)
{
	static class UFunction* Func = nullptr;
...
void ACUBE_C::OnEventActive_2648B1B24D74D365B5C956ACA1EAECB0(const class FString& EventName, const struct FTimespan& TimeUntilEnd_0, const struct FTimespan& TimeSinceBegin, float TimespanRatio)
{
	static class UFunction* Func = nullptr;
...
void ACUBE_C::OnEventUpdated_2648B1B24D74D365B5C956ACA1EAECB0(const class FString& EventName, const struct FTimespan& TimeUntilEnd_0, const struct FTimespan& TimeSinceBegin, float TimespanRatio)
{
	static class UFunction* Func = nullptr;
...
void ACUBE_C::OnEventEnded_2648B1B24D74D365B5C956ACA1EAECB0(const class FString& EventName, const struct FTimespan& TimeUntilEnd_0, const struct FTimespan& TimeSinceBegin, float TimespanRatio)
{
	static class UFunction* Func = nullptr;
...
void ACUBE_C::OnEventActive_16C2560C48CD325DC3C47CA23BEBB2C9(const class FString& EventName, const struct FTimespan& TimeUntilEnd_0, const struct FTimespan& TimeSinceBegin, float TimespanRatio)
{
	static class UFunction* Func = nullptr;
...
void ACUBE_C::OnEventUpdated_16C2560C48CD325DC3C47CA23BEBB2C9(const class FString& EventName, const struct FTimespan& TimeUntilEnd_0, const struct FTimespan& TimeSinceBegin, float TimespanRatio)
{
	static class UFunction* Func = nullptr;
...
void ACUBE_C::OnEventEnded_16C2560C48CD325DC3C47CA23BEBB2C9(const class FString& EventName, const struct FTimespan& TimeUntilEnd_0, const struct FTimespan& TimeSinceBegin, float TimespanRatio)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FTimespan&                 TimespanTillEnd                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// int32                                   RuneDestination_0                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ACUBE_C::CalculateNextMove(const struct FTimespan& TimespanTillEnd, int32 RuneDestination_0, int32* NextIndex, float* SecondsTillMove)
{
	static class UFunction* Func = nullptr;
	...
	Parms.RuneDestination_0 = RuneDestination_0;
...
void ACUBE_C::StepsThisRuneIndex(int32 RuneDestination_0)
{
	static class UFunction* Func = nullptr;
