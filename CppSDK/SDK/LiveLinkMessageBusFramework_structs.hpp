...
static_assert(sizeof(FLiveLinkPingMessage) == 0x000010, "Wrong size on FLiveLinkPingMessage");
...
static_assert(alignof(FLiveLinkConnectMessage) == 0x000001, "Wrong alignment on FLiveLinkConnectMessage");
static_assert(sizeof(FLiveLinkConnectMessage) == 0x000001, "Wrong size on FLiveLinkConnectMessage");
...
static_assert(sizeof(FLiveLinkPongMessage) == 0x000030, "Wrong size on FLiveLinkPongMessage");
