...
static_assert(sizeof(BluGloRequestHandler_C_ExecuteUbergraph_BluGloRequestHandler) == 0x000040, "Wrong size on BluGloRequestHandler_C_ExecuteUbergraph_BluGloRequestHandler");
...
static_assert(offsetof(BluGloRequestHandler_C_ExecuteUbergraph_BluGloRequestHandler, K2Node_CreateDelegate_OutputDelegate) == 0x000014, "Member 'BluGloRequestHandler_C_ExecuteUbergraph_BluGloRequestHandler::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BluGloRequestHandler_C_ExecuteUbergraph_BluGloRequestHandler, K2Node_CustomEvent_NumBluGloToSpawn) == 0x000024, "Member 'BluGloRequestHandler_C_ExecuteUbergraph_BluGloRequestHandler::K2Node_CustomEvent_NumBluGloToSpawn' has a wrong offset!");
static_assert(offsetof(BluGloRequestHandler_C_ExecuteUbergraph_BluGloRequestHandler, K2Node_CustomEvent_ActorToSpawnFrom) == 0x000028, "Member 'BluGloRequestHandler_C_ExecuteUbergraph_BluGloRequestHandler::K2Node_CustomEvent_ActorToSpawnFrom' has a wrong offset!");
static_assert(offsetof(BluGloRequestHandler_C_ExecuteUbergraph_BluGloRequestHandler, K2Node_CustomEvent_LocationToSpawnFromIfActorInvalid) == 0x000030, "Member 'BluGloRequestHandler_C_ExecuteUbergraph_BluGloRequestHandler::K2Node_CustomEvent_LocationToSpawnFromIfActorInvalid' has a wrong offset!");
