...
static_assert(sizeof(FrontEndRewards_Expedition_C_SetBrushFromExpedition) == 0x000380, "Wrong size on FrontEndRewards_Expedition_C_SetBrushFromExpedition");
...
static_assert(offsetof(FrontEndRewards_Expedition_C_SetBrushFromExpedition, CallFunc_GetUIDataForTag_ReturnValue) == 0x000378, "Member 'FrontEndRewards_Expedition_C_SetBrushFromExpedition::CallFunc_GetUIDataForTag_ReturnValue' has a wrong offset!");
