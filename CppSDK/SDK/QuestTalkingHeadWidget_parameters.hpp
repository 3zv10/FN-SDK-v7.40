...
static_assert(offsetof(QuestTalkingHeadWidget_C_ExecuteUbergraph_QuestTalkingHeadWidget, K2Node_CreateDelegate_OutputDelegate) == 0x000004, "Member 'QuestTalkingHeadWidget_C_ExecuteUbergraph_QuestTalkingHeadWidget::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(offsetof(QuestTalkingHeadWidget_C_SetTalkingHeadName, Temp_byte_Variable1) == 0x00001B, "Member 'QuestTalkingHeadWidget_C_SetTalkingHeadName::Temp_byte_Variable1' has a wrong offset!");
