...
struct GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate final
{
public:
...
static_assert(alignof(GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate) == 0x000010, "Wrong alignment on GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate");
static_assert(sizeof(GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate) == 0x000240, "Wrong size on GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate");
static_assert(offsetof(GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate, WhileActiveParticleSysComponent) == 0x000000, "Member 'GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate::WhileActiveParticleSysComponent' has a wrong offset!");
static_assert(offsetof(GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate, Parameters) == 0x000008, "Member 'GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate::Parameters' has a wrong offset!");
static_assert(offsetof(GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate, CallFunc_MakeLiteralFloat_ReturnValue) == 0x0000C0, "Member 'GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate::CallFunc_MakeLiteralFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate, CallFunc_MakeLiteralFloat_ReturnValue1) == 0x0000C4, "Member 'GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate::CallFunc_MakeLiteralFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x0000C8, "Member 'GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate, CallFunc_Multiply_FloatFloat_ReturnValue1) == 0x0000CC, "Member 'GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate::CallFunc_Multiply_FloatFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate, CallFunc_MakeVector_ReturnValue) == 0x0000D0, "Member 'GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate::CallFunc_MakeVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate, CallFunc_GetOwner_ReturnValue) == 0x0000E0, "Member 'GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate, CallFunc_GetActorBounds_Origin) == 0x0000E8, "Member 'GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate::CallFunc_GetActorBounds_Origin' has a wrong offset!");
static_assert(offsetof(GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate, CallFunc_GetActorBounds_BoxExtent) == 0x0000F4, "Member 'GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate::CallFunc_GetActorBounds_BoxExtent' has a wrong offset!");
...
static_assert(offsetof(GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate, CallFunc_FClamp_ReturnValue) == 0x0001A0, "Member 'GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate::CallFunc_FClamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate, K2Node_MakeStruct_ParticleSysParam1) == 0x0001B0, "Member 'GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate::K2Node_MakeStruct_ParticleSysParam1' has a wrong offset!");
static_assert(offsetof(GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate, K2Node_MakeArray_Array) == 0x000230, "Member 'GCNL_GM_Snare_C_OnWhileActiveParticleSystemActivate::K2Node_MakeArray_Array' has a wrong offset!");
