...
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec, Target_Selection_List_Index) == 0x000080, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec::Target_Selection_List_Index' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec, At_Level) == 0x000084, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec::At_Level' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec, __WorldContext) == 0x000088, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec::__WorldContext' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec, Range) == 0x000090, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec::Range' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec, CallFunc_Array_Get_Item) == 0x000098, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec::CallFunc_Array_Get_Item' has a wrong offset!");
...
static_assert(offsetof(AbilityFunctions_C_GetAngleBetweenTwoVectors, CallFunc_Normal_ReturnValue1) == 0x000030, "Member 'AbilityFunctions_C_GetAngleBetweenTwoVectors::CallFunc_Normal_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AbilityFunctions_C_GetTotalGameplayEffectCount, CallFunc_Add_IntInt_ReturnValue1) == 0x00004C, "Member 'AbilityFunctions_C_GetTotalGameplayEffectCount::CallFunc_Add_IntInt_ReturnValue1' has a wrong offset!");
...
static_assert(sizeof(AbilityFunctions_C_GetRangeFromGameplayEffectContainer) == 0x0001B0, "Wrong size on AbilityFunctions_C_GetRangeFromGameplayEffectContainer");
...
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainer, CallFunc_GetValueAtLevel_ReturnValue) == 0x0001A8, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainer::CallFunc_GetValueAtLevel_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AbilityFunctions_C_EvaluatePerkTierBalanceValue, Temp_bool_Variable1) == 0x000071, "Member 'AbilityFunctions_C_EvaluatePerkTierBalanceValue::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_EvaluatePerkTierBalanceValue, Temp_bool_Variable2) == 0x000072, "Member 'AbilityFunctions_C_EvaluatePerkTierBalanceValue::Temp_bool_Variable2' has a wrong offset!");
...
static_assert(offsetof(AbilityFunctions_C_EvaluatePerkTierBalanceValue, CallFunc_GetValueAtLevel_ReturnValue1) == 0x000078, "Member 'AbilityFunctions_C_EvaluatePerkTierBalanceValue::CallFunc_GetValueAtLevel_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AbilityFunctions_C_EvaluatePerkTierBalanceValue, K2Node_Select1_Default) == 0x0000A8, "Member 'AbilityFunctions_C_EvaluatePerkTierBalanceValue::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_EvaluatePerkTierBalanceValue, K2Node_Select2_Default) == 0x0000C8, "Member 'AbilityFunctions_C_EvaluatePerkTierBalanceValue::K2Node_Select2_Default' has a wrong offset!");
...
static_assert(offsetof(AbilityFunctions_C_GetPawnFromPlayerStateZone, CallFunc_IsValid_ReturnValue1) == 0x000038, "Member 'AbilityFunctions_C_GetPawnFromPlayerStateZone::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AbilityFunctions_C_GetDistanceBetweenActors, CallFunc_K2_GetActorLocation_ReturnValue1) == 0x000028, "Member 'AbilityFunctions_C_GetDistanceBetweenActors::CallFunc_K2_GetActorLocation_ReturnValue1' has a wrong offset!");
