...
public:
	...
	TDelegate<void(const class UFortQuestItem* Quest)> K2Node_CreateDelegate_OutputDelegate1;        // 0x0040(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(offsetof(MainTabsScreen_C_ExecuteUbergraph_MainTabsScreen, CallFunc_GetContext_ReturnValue1) == 0x000038, "Member 'MainTabsScreen_C_ExecuteUbergraph_MainTabsScreen::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(sizeof(MainTabsScreen_C_HandleTabCreated) == 0x000098, "Wrong size on MainTabsScreen_C_HandleTabCreated");
...
static_assert(offsetof(MainTabsScreen_C_HandleTabCreated, K2Node_DynamicCast_AsMain_Tab_Icon_Button1) == 0x000050, "Member 'MainTabsScreen_C_HandleTabCreated::K2Node_DynamicCast_AsMain_Tab_Icon_Button1' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_HandleTabCreated, K2Node_DynamicCast_bSuccess1) == 0x000058, "Member 'MainTabsScreen_C_HandleTabCreated::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_HandleTabCreated, K2Node_DynamicCast_AsMain_Tab_Icon_Button2) == 0x000060, "Member 'MainTabsScreen_C_HandleTabCreated::K2Node_DynamicCast_AsMain_Tab_Icon_Button2' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_HandleTabCreated, K2Node_DynamicCast_bSuccess2) == 0x000068, "Member 'MainTabsScreen_C_HandleTabCreated::K2Node_DynamicCast_bSuccess2' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_HandleTabCreated, K2Node_DynamicCast_AsQuests_Count_Icon_Tab_Button) == 0x000070, "Member 'MainTabsScreen_C_HandleTabCreated::K2Node_DynamicCast_AsQuests_Count_Icon_Tab_Button' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_HandleTabCreated, K2Node_DynamicCast_bSuccess3) == 0x000078, "Member 'MainTabsScreen_C_HandleTabCreated::K2Node_DynamicCast_bSuccess3' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_HandleTabCreated, CallFunc_TextToUpper_ReturnValue) == 0x000080, "Member 'MainTabsScreen_C_HandleTabCreated::CallFunc_TextToUpper_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(MainTabsScreen_C_Update_Squad_Tab_Button_Bang, CallFunc_EqualEqual_NameName_ReturnValue1) == 0x00002B, "Member 'MainTabsScreen_C_Update_Squad_Tab_Button_Bang::CallFunc_EqualEqual_NameName_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MainTabsScreen_C_Update_Squad_Tab_Button_Bang, CallFunc_AreAnyHomebaseNodeItemsUnseenForSquadType_ReturnValue1) == 0x000040, "Member 'MainTabsScreen_C_Update_Squad_Tab_Button_Bang::CallFunc_AreAnyHomebaseNodeItemsUnseenForSquadType_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MainTabsScreen_C_Update_Hero_Tab_Button_Bang, CallFunc_EqualEqual_NameName_ReturnValue1) == 0x00001A, "Member 'MainTabsScreen_C_Update_Hero_Tab_Button_Bang::CallFunc_EqualEqual_NameName_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MainTabsScreen_C_Update_Quest_Tab_Button_Bang, CallFunc_EqualEqual_NameName_ReturnValue1) == 0x000048, "Member 'MainTabsScreen_C_Update_Quest_Tab_Button_Bang::CallFunc_EqualEqual_NameName_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MainTabsScreen_C_Update_Quest_Tab_Button_Bang, K2Node_DynamicCast_bSuccess1) == 0x000078, "Member 'MainTabsScreen_C_Update_Quest_Tab_Button_Bang::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
...
static_assert(offsetof(MainTabsScreen_C_Are_Any_Transform_Keys_Unseen, CallFunc_Not_PreBool_ReturnValue1) == 0x000052, "Member 'MainTabsScreen_C_Are_Any_Transform_Keys_Unseen::CallFunc_Not_PreBool_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MainTabsScreen_C_Update_Store_Tab_Button_Bang, CallFunc_EqualEqual_NameName_ReturnValue1) == 0x000014, "Member 'MainTabsScreen_C_Update_Store_Tab_Button_Bang::CallFunc_EqualEqual_NameName_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MainTabsScreen_C_Update_Store_Tab_Button_Bang, CallFunc_Not_PreBool_ReturnValue1) == 0x000065, "Member 'MainTabsScreen_C_Update_Store_Tab_Button_Bang::CallFunc_Not_PreBool_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_Update_Store_Tab_Button_Bang, CallFunc_BooleanAND_ReturnValue1) == 0x000066, "Member 'MainTabsScreen_C_Update_Store_Tab_Button_Bang::CallFunc_BooleanAND_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MainTabsScreen_C_HandleCardPackStore, CallFunc_EqualEqual_NameName_ReturnValue1) == 0x000009, "Member 'MainTabsScreen_C_HandleCardPackStore::CallFunc_EqualEqual_NameName_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MainTabsScreen_C_Is_Transform_Feature_Unlocked, CallFunc_HasGameplayTagContainer_ReturnValue1) == 0x000011, "Member 'MainTabsScreen_C_Is_Transform_Feature_Unlocked::CallFunc_HasGameplayTagContainer_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MainTabsScreen_C_Get_Valid_Offers, CallFunc_CheckHighestPriorityOffer_outPriorityOffer1) == 0x000178, "Member 'MainTabsScreen_C_Get_Valid_Offers::CallFunc_CheckHighestPriorityOffer_outPriorityOffer1' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_Get_Valid_Offers, CallFunc_CheckHighestPriorityOffer_FoundOffer1) == 0x000208, "Member 'MainTabsScreen_C_Get_Valid_Offers::CallFunc_CheckHighestPriorityOffer_FoundOffer1' has a wrong offset!");
...
static_assert(offsetof(MainTabsScreen_C_Get_Valid_Offers, CallFunc_GetMetaBoolOnOffer_ReturnValue1) == 0x00020A, "Member 'MainTabsScreen_C_Get_Valid_Offers::CallFunc_GetMetaBoolOnOffer_ReturnValue1' has a wrong offset!");
...
static_assert(sizeof(MainTabsScreen_C_CheckDisplayCriteria) == 0x000100, "Wrong size on MainTabsScreen_C_CheckDisplayCriteria");
...
static_assert(offsetof(MainTabsScreen_C_CheckDisplayCriteria, CallFunc_GetContext_ReturnValue1) == 0x0000B0, "Member 'MainTabsScreen_C_CheckDisplayCriteria::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MainTabsScreen_C_CheckDisplayCriteria, CallFunc_GetAccountItemWithDefinition_ReturnValue) == 0x0000F0, "Member 'MainTabsScreen_C_CheckDisplayCriteria::CallFunc_GetAccountItemWithDefinition_ReturnValue' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_CheckDisplayCriteria, CallFunc_IsValid_ReturnValue) == 0x0000F8, "Member 'MainTabsScreen_C_CheckDisplayCriteria::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_CheckDisplayCriteria, CallFunc_GetNumInStack_ReturnValue) == 0x0000FC, "Member 'MainTabsScreen_C_CheckDisplayCriteria::CallFunc_GetNumInStack_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable, CallFunc_Array_Length_ReturnValue) == 0x000030, "Member 'MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable, CallFunc_Array_Get_Item) == 0x000038, "Member 'MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable, CallFunc_Less_IntInt_ReturnValue) == 0x0000C8, "Member 'MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable, CallFunc_BooleanAND_ReturnValue) == 0x0000C9, "Member 'MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable, CallFunc_GetTotalItemQuantityByDefinition_ReturnValue) == 0x0000CC, "Member 'MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable::CallFunc_GetTotalItemQuantityByDefinition_ReturnValue' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x0000D0, "Member 'MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable, CallFunc_EqualEqual_ObjectObject_ReturnValue) == 0x0000D1, "Member 'MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable::CallFunc_EqualEqual_ObjectObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable, CallFunc_Not_PreBool_ReturnValue1) == 0x0000D2, "Member 'MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable::CallFunc_Not_PreBool_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable, CallFunc_Greater_IntInt_ReturnValue) == 0x0000D3, "Member 'MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable, CallFunc_BooleanAND_ReturnValue1) == 0x0000D4, "Member 'MainTabsScreen_C_Determine_If_Any_non_MTX_offers_are_purchasable::CallFunc_BooleanAND_ReturnValue1' has a wrong offset!");
