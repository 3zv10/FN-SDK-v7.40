...
static_assert(sizeof(UTeamMicStack_C) == 0x000298, "Wrong size on UTeamMicStack_C");
static_assert(offsetof(UTeamMicStack_C, UberGraphFrame) == 0x000268, "Member 'UTeamMicStack_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UTeamMicStack_C, _Vertical_Box__Team_Members) == 0x000270, "Member 'UTeamMicStack_C::_Vertical_Box__Team_Members' has a wrong offset!");
static_assert(offsetof(UTeamMicStack_C, BorderFrame) == 0x000278, "Member 'UTeamMicStack_C::BorderFrame' has a wrong offset!");
static_assert(offsetof(UTeamMicStack_C, TeamMembers) == 0x000280, "Member 'UTeamMicStack_C::TeamMembers' has a wrong offset!");
static_assert(offsetof(UTeamMicStack_C, NewVar_0) == 0x000290, "Member 'UTeamMicStack_C::NewVar_0' has a wrong offset!");
