...
static_assert(offsetof(UPurchaseHistoryEntry_C, CommonTextBlock_XITEMS) == 0x000B58, "Member 'UPurchaseHistoryEntry_C::CommonTextBlock_XITEMS' has a wrong offset!");
...
static_assert(offsetof(UPurchaseHistoryEntry_C, Overlay_XItems) == 0x000B88, "Member 'UPurchaseHistoryEntry_C::Overlay_XItems' has a wrong offset!");
