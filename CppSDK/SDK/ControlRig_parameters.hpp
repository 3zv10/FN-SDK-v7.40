...
static_assert(offsetof(ControlRig_SetGlobalTransform, JointName) == 0x000000, "Member 'ControlRig_SetGlobalTransform::JointName' has a wrong offset!");
...
static_assert(offsetof(ControlRig_GetGlobalTransform, JointName) == 0x000000, "Member 'ControlRig_GetGlobalTransform::JointName' has a wrong offset!");
