...
static_assert(sizeof(UGA_DefaultPlayer_Consumable_C) == 0x000948, "Wrong size on UGA_DefaultPlayer_Consumable_C");
static_assert(offsetof(UGA_DefaultPlayer_Consumable_C, UberGraphFrame) == 0x000938, "Member 'UGA_DefaultPlayer_Consumable_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_DefaultPlayer_Consumable_C, EatMontage) == 0x000940, "Member 'UGA_DefaultPlayer_Consumable_C::EatMontage' has a wrong offset!");
