...
// Parameters:
// const struct FScalableFloat&            Lookup_Base                                            (BlueprintVisible, BlueprintReadOnly, Parm)
// const struct FScalableFloat&            Lookup_Commander                                       (BlueprintVisible, BlueprintReadOnly, Parm)
// const struct FGameplayTag&              Commander_Tag                                          (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, HasGetValueTypeHash)
...
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FGameplayTagContainer&     InstegatorTags                                         (BlueprintVisible, BlueprintReadOnly, Parm)
...
void UGAT_GenericTriggeredAbility_Perk_C::CalcStreakBreakerThreshold(float PROC_Chance__0_1_, int32* Streak_Breaker_Threshold)
{
	static class UFunction* Func = nullptr;
