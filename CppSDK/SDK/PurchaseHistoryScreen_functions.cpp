...
// Parameters:
// const TArray<class UCommonTextBlock*>&  ItemsToReturn_0                                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)

void UPurchaseHistoryScreen_C::UpdateItemList(const TArray<class UCommonTextBlock*>& ItemsToReturn_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.ItemsToReturn_0 = std::move(ItemsToReturn_0);
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// const struct FMtxPurchaseHistory&       PurchaseHistory                                        (BlueprintVisible, BlueprintReadOnly, Parm)
