...
static_assert(sizeof(UGA_Constructor_HammerHitsHeal_C) == 0x000A90, "Wrong size on UGA_Constructor_HammerHitsHeal_C");
static_assert(offsetof(UGA_Constructor_HammerHitsHeal_C, UberGraphFrame_GA_Constructor_HammerHitsHeal_C) == 0x000A68, "Member 'UGA_Constructor_HammerHitsHeal_C::UberGraphFrame_GA_Constructor_HammerHitsHeal_C' has a wrong offset!");
static_assert(offsetof(UGA_Constructor_HammerHitsHeal_C, TC_RequiredTags) == 0x000A70, "Member 'UGA_Constructor_HammerHitsHeal_C::TC_RequiredTags' has a wrong offset!");
