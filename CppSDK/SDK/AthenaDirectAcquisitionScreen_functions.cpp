...
// Parameters:
// const bool                              bDisplayToast                                          (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UAthenaDirectAcquisitionScreen_C::OnDisplayToast(const bool bDisplayToast)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaDirectAcquisitionScreen_C", "OnDisplayToast");

	Params::AthenaDirectAcquisitionScreen_C_OnDisplayToast Parms{};
