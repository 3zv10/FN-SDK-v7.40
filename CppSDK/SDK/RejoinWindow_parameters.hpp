...
public:
	...
	struct FMcpBanInfo                            CallFunc_GetBanInfo_ReturnValue;                   // 0x0010(0x0040)(ConstParm)
	bool                                          CallFunc_IsUserCurrentlyBanned_ReturnValue;        // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(RejoinWindow_C_ExecuteUbergraph_RejoinWindow) == 0x000008, "Wrong alignment on RejoinWindow_C_ExecuteUbergraph_RejoinWindow");
static_assert(sizeof(RejoinWindow_C_ExecuteUbergraph_RejoinWindow) == 0x000058, "Wrong size on RejoinWindow_C_ExecuteUbergraph_RejoinWindow");
...
static_assert(offsetof(RejoinWindow_C_ExecuteUbergraph_RejoinWindow, CallFunc_GetContext_ReturnValue) == 0x000008, "Member 'RejoinWindow_C_ExecuteUbergraph_RejoinWindow::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(RejoinWindow_C_ExecuteUbergraph_RejoinWindow, CallFunc_GetBanInfo_ReturnValue) == 0x000010, "Member 'RejoinWindow_C_ExecuteUbergraph_RejoinWindow::CallFunc_GetBanInfo_ReturnValue' has a wrong offset!");
static_assert(offsetof(RejoinWindow_C_ExecuteUbergraph_RejoinWindow, CallFunc_IsUserCurrentlyBanned_ReturnValue) == 0x000050, "Member 'RejoinWindow_C_ExecuteUbergraph_RejoinWindow::CallFunc_IsUserCurrentlyBanned_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(RejoinWindow_C_ShowRetryScreen) == 0x000050, "Wrong size on RejoinWindow_C_ShowRetryScreen");
...
static_assert(offsetof(RejoinWindow_C_ShowRetryScreen, K2Node_MakeStruct_DataTableRowHandle) == 0x000020, "Member 'RejoinWindow_C_ShowRetryScreen::K2Node_MakeStruct_DataTableRowHandle' has a wrong offset!");
static_assert(offsetof(RejoinWindow_C_ShowRetryScreen, CallFunc_Array_Add_ReturnValue) == 0x000030, "Member 'RejoinWindow_C_ShowRetryScreen::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(RejoinWindow_C_ShowRetryScreen, K2Node_MakeStruct_DataTableRowHandle1) == 0x000038, "Member 'RejoinWindow_C_ShowRetryScreen::K2Node_MakeStruct_DataTableRowHandle1' has a wrong offset!");
static_assert(offsetof(RejoinWindow_C_ShowRetryScreen, CallFunc_Array_Add_ReturnValue1) == 0x000048, "Member 'RejoinWindow_C_ShowRetryScreen::CallFunc_Array_Add_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(RejoinWindow_C_ShowInitalScreen, K2Node_MakeStruct_DataTableRowHandle1) == 0x000018, "Member 'RejoinWindow_C_ShowInitalScreen::K2Node_MakeStruct_DataTableRowHandle1' has a wrong offset!");
...
static_assert(offsetof(RejoinWindow_C_InitializeRejoinWindow, K2Node_CreateDelegate_OutputDelegate) == 0x00000C, "Member 'RejoinWindow_C_InitializeRejoinWindow::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
