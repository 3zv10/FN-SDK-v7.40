...
static_assert(offsetof(AShoppingCartVehicleSK_C, Hit_ZImpulseMultiplier) == 0x000E90, "Member 'AShoppingCartVehicleSK_C::Hit_ZImpulseMultiplier' has a wrong offset!");
static_assert(offsetof(AShoppingCartVehicleSK_C, Hit_LateralImpulseMultiplier) == 0x000EB0, "Member 'AShoppingCartVehicleSK_C::Hit_LateralImpulseMultiplier' has a wrong offset!");
static_assert(offsetof(AShoppingCartVehicleSK_C, Hit_MaxImpulseVelocity) == 0x000ED0, "Member 'AShoppingCartVehicleSK_C::Hit_MaxImpulseVelocity' has a wrong offset!");
