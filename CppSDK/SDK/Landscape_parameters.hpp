...
static_assert(alignof(LandscapeBlueprintCustomBrush_Initialize) == 0x000004, "Wrong alignment on LandscapeBlueprintCustomBrush_Initialize");
static_assert(sizeof(LandscapeBlueprintCustomBrush_Initialize) == 0x000010, "Wrong size on LandscapeBlueprintCustomBrush_Initialize");
static_assert(offsetof(LandscapeBlueprintCustomBrush_Initialize, InLandscapeSize) == 0x000000, "Member 'LandscapeBlueprintCustomBrush_Initialize::InLandscapeSize' has a wrong offset!");
static_assert(offsetof(LandscapeBlueprintCustomBrush_Initialize, InLandscapeRenderTargetSize) == 0x000008, "Member 'LandscapeBlueprintCustomBrush_Initialize::InLandscapeRenderTargetSize' has a wrong offset!");
