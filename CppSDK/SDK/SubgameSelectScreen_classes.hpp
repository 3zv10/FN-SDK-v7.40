...
public:
	...
	class UWidgetAnimation*                       Pan_P1P2;                                          // 0x0340(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	class UWidgetAnimation*                       Pan_P1;                                            // 0x0348(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	class UWidgetAnimation*                       Pan_P2;                                            // 0x0350(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	...
	class UMaterialInstanceDynamic*               MID_Keyart;                                        // 0x0470(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(USubgameSelectScreen_C, Pan_P1P2) == 0x000340, "Member 'USubgameSelectScreen_C::Pan_P1P2' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, Pan_P1) == 0x000348, "Member 'USubgameSelectScreen_C::Pan_P1' has a wrong offset!");
static_assert(offsetof(USubgameSelectScreen_C, Pan_P2) == 0x000350, "Member 'USubgameSelectScreen_C::Pan_P2' has a wrong offset!");
...
static_assert(offsetof(USubgameSelectScreen_C, MID_Keyart) == 0x000470, "Member 'USubgameSelectScreen_C::MID_Keyart' has a wrong offset!");
