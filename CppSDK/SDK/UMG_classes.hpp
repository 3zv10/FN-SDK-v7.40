...
static_assert(alignof(INativeUserListEntry) == 0x000001, "Wrong alignment on INativeUserListEntry");
static_assert(sizeof(INativeUserListEntry) == 0x000001, "Wrong size on INativeUserListEntry");
