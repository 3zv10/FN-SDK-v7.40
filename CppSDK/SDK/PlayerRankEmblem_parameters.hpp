...
static_assert(sizeof(PlayerRankEmblem_C_SetBannerInfo) == 0x000160, "Wrong size on PlayerRankEmblem_C_SetBannerInfo");
...
static_assert(offsetof(PlayerRankEmblem_C_SetBannerInfo, CallFunc_Conv_StringToName_ReturnValue1) == 0x000030, "Member 'PlayerRankEmblem_C_SetBannerInfo::CallFunc_Conv_StringToName_ReturnValue1' has a wrong offset!");
