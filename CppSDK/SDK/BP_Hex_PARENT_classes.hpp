...
public:
	...
	class UMaterialInstanceDynamic*               MID_Selected;                                      // 0x0678(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class UStaticMesh*>                    Hex_Deco_Meshes;                                   // 0x0680(0x0010)(Edit, BlueprintVisible, ZeroConstructor)
	class UMaterialInstanceDynamic*               MID_Mouseover;                                     // 0x0690(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ABP_Hex_PARENT_C, MID_Selected) == 0x000678, "Member 'ABP_Hex_PARENT_C::MID_Selected' has a wrong offset!");
...
static_assert(offsetof(ABP_Hex_PARENT_C, MID_Mouseover) == 0x000690, "Member 'ABP_Hex_PARENT_C::MID_Mouseover' has a wrong offset!");
