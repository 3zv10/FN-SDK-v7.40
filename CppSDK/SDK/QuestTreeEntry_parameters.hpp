...
public:
	...
	TDelegate<void(const class UFortQuestItem* Quest)> K2Node_CreateDelegate_OutputDelegate;         // 0x00C8(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(sizeof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry) == 0x000110, "Wrong size on QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry");
...
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_GetContext_ReturnValue1) == 0x000010, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_IsValid_ReturnValue1) == 0x000021, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_GetQuestManager_ReturnValue1) == 0x000028, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_GetQuestManager_ReturnValue1' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_GetContext_ReturnValue2) == 0x000030, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_IsValid_ReturnValue2) == 0x000038, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_IsValid_ReturnValue2' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_IsValid_ReturnValue3) == 0x000039, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_IsValid_ReturnValue3' has a wrong offset!");
...
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_IsValid_ReturnValue4) == 0x000048, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_IsValid_ReturnValue4' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, K2Node_Event_Category1) == 0x000050, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::K2Node_Event_Category1' has a wrong offset!");
...
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_GetSmallPreviewImage_ReturnValue) == 0x000060, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_GetSmallPreviewImage_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_IsAssetNull_ReturnValue) == 0x000088, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_IsAssetNull_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_Get_Quest_Item_Def_AsFort_Quest_Item_Definition) == 0x000090, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_Get_Quest_Item_Def_AsFort_Quest_Item_Definition' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, Temp_byte_Variable) == 0x000098, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_GetQuestType_ReturnValue) == 0x000099, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_GetQuestType_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x00009A, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_EqualEqual_ByteByte_ReturnValue1) == 0x00009B, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_EqualEqual_ByteByte_ReturnValue1' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_EqualEqual_ByteByte_ReturnValue2) == 0x00009C, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_EqualEqual_ByteByte_ReturnValue2' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_BooleanOR_ReturnValue) == 0x00009D, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, Temp_byte_Variable1) == 0x00009E, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_BooleanOR_ReturnValue1) == 0x00009F, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_BooleanOR_ReturnValue1' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, K2Node_Select_Default) == 0x0000A0, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, Temp_bool_Variable1) == 0x0000B0, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, Temp_int_Variable) == 0x0000B4, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, K2Node_Select1_Default) == 0x0000B8, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, K2Node_CustomEvent_Quest) == 0x0000C0, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::K2Node_CustomEvent_Quest' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, K2Node_CreateDelegate_OutputDelegate) == 0x0000C8, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, Temp_int_Variable1) == 0x0000D8, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::Temp_int_Variable1' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, K2Node_CreateDelegate_OutputDelegate1) == 0x0000DC, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, Temp_int_Variable2) == 0x0000EC, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::Temp_int_Variable2' has a wrong offset!");
...
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, Temp_byte_Variable2) == 0x000100, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, K2Node_Event_bIsExpanded) == 0x000101, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::K2Node_Event_bIsExpanded' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, CallFunc_Conv_BoolToInt_ReturnValue) == 0x000104, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::CallFunc_Conv_BoolToInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, Temp_int_Variable3) == 0x000108, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::Temp_int_Variable3' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry, K2Node_Select2_Default) == 0x00010C, "Member 'QuestTreeEntry_C_ExecuteUbergraph_QuestTreeEntry::K2Node_Select2_Default' has a wrong offset!");
...
static_assert(alignof(QuestTreeEntry_C_BP_OnItemExpansionChanged) == 0x000001, "Wrong alignment on QuestTreeEntry_C_BP_OnItemExpansionChanged");
static_assert(sizeof(QuestTreeEntry_C_BP_OnItemExpansionChanged) == 0x000001, "Wrong size on QuestTreeEntry_C_BP_OnItemExpansionChanged");
static_assert(offsetof(QuestTreeEntry_C_BP_OnItemExpansionChanged, bIsExpanded) == 0x000000, "Member 'QuestTreeEntry_C_BP_OnItemExpansionChanged::bIsExpanded' has a wrong offset!");
...
static_assert(offsetof(QuestTreeEntry_C_Update_Quest_Item_Bang_State, CallFunc_Not_PreBool_ReturnValue1) == 0x000004, "Member 'QuestTreeEntry_C_Update_Quest_Item_Bang_State::CallFunc_Not_PreBool_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(QuestTreeEntry_C_Update_Quest_Item_Seen, CallFunc_IsValid_ReturnValue1) == 0x000011, "Member 'QuestTreeEntry_C_Update_Quest_Item_Seen::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(QuestTreeEntry_C_Update_Quest_Category_Bang_State, CallFunc_HasUnseenQuests_ReturnValue) == 0x000000, "Member 'QuestTreeEntry_C_Update_Quest_Category_Bang_State::CallFunc_HasUnseenQuests_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(QuestTreeEntry_C_Quest_Category_Have_Unseen_Quests, CallFunc_Not_PreBool_ReturnValue1) == 0x000022, "Member 'QuestTreeEntry_C_Quest_Category_Have_Unseen_Quests::CallFunc_Not_PreBool_ReturnValue1' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_Quest_Category_Have_Unseen_Quests, CallFunc_Not_PreBool_ReturnValue2) == 0x000023, "Member 'QuestTreeEntry_C_Quest_Category_Have_Unseen_Quests::CallFunc_Not_PreBool_ReturnValue2' has a wrong offset!");
...
static_assert(offsetof(QuestTreeEntry_C_Quest_Category_Have_Unseen_Quests, CallFunc_BooleanAND_ReturnValue1) == 0x00002A, "Member 'QuestTreeEntry_C_Quest_Category_Have_Unseen_Quests::CallFunc_BooleanAND_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(QuestTreeEntry_C_Set_Quest_Display_Name, K2Node_MakeStruct_FormatArgumentData1) == 0x000078, "Member 'QuestTreeEntry_C_Set_Quest_Display_Name::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
...
static_assert(offsetof(QuestTreeEntry_C_Is_Streaming_Quest, CallFunc_EqualEqual_ByteByte_ReturnValue1) == 0x000012, "Member 'QuestTreeEntry_C_Is_Streaming_Quest::CallFunc_EqualEqual_ByteByte_ReturnValue1' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_Is_Streaming_Quest, CallFunc_EqualEqual_ByteByte_ReturnValue2) == 0x000013, "Member 'QuestTreeEntry_C_Is_Streaming_Quest::CallFunc_EqualEqual_ByteByte_ReturnValue2' has a wrong offset!");
...
static_assert(offsetof(QuestTreeEntry_C_Is_Streaming_Quest, CallFunc_BooleanOR_ReturnValue1) == 0x000015, "Member 'QuestTreeEntry_C_Is_Streaming_Quest::CallFunc_BooleanOR_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name, Temp_text_Variable1) == 0x000038, "Member 'QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name::Temp_text_Variable1' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name, Temp_text_Variable2) == 0x000050, "Member 'QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name::Temp_text_Variable2' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name, Temp_text_Variable3) == 0x000068, "Member 'QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name::Temp_text_Variable3' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name, Temp_text_Variable4) == 0x000080, "Member 'QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name::Temp_text_Variable4' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name, Temp_text_Variable5) == 0x000098, "Member 'QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name::Temp_text_Variable5' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name, Temp_text_Variable6) == 0x0000B0, "Member 'QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name::Temp_text_Variable6' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name, Temp_text_Variable7) == 0x0000C8, "Member 'QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name::Temp_text_Variable7' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name, Temp_text_Variable8) == 0x0000E0, "Member 'QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name::Temp_text_Variable8' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name, Temp_text_Variable9) == 0x0000F8, "Member 'QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name::Temp_text_Variable9' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name, Temp_text_Variable10) == 0x000110, "Member 'QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name::Temp_text_Variable10' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name, Temp_text_Variable11) == 0x000128, "Member 'QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name::Temp_text_Variable11' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name, Temp_text_Variable12) == 0x000140, "Member 'QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name::Temp_text_Variable12' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name, Temp_text_Variable13) == 0x000158, "Member 'QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name::Temp_text_Variable13' has a wrong offset!");
static_assert(offsetof(QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name, Temp_text_Variable14) == 0x000170, "Member 'QuestTreeEntry_C_Get_Streaming_Attached_Quest_Name::Temp_text_Variable14' has a wrong offset!");
