...
static_assert(alignof(LobbyTimer_C_Show_Lobby_Timer) == 0x000008, "Wrong alignment on LobbyTimer_C_Show_Lobby_Timer");
static_assert(sizeof(LobbyTimer_C_Show_Lobby_Timer) == 0x000010, "Wrong size on LobbyTimer_C_Show_Lobby_Timer");
...
static_assert(offsetof(LobbyTimer_C_Show_Lobby_Timer, CallFunc_PlayAnimation_ReturnValue) == 0x000008, "Member 'LobbyTimer_C_Show_Lobby_Timer::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(LobbyTimer_C_Bind_Delegates, K2Node_CreateDelegate_OutputDelegate1) == 0x000018, "Member 'LobbyTimer_C_Bind_Delegates::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(LobbyTimer_C_Bind_Delegates, CallFunc_GetContext_ReturnValue1) == 0x000028, "Member 'LobbyTimer_C_Bind_Delegates::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(LobbyTimer_C_Bind_Delegates, K2Node_CreateDelegate_OutputDelegate2) == 0x000030, "Member 'LobbyTimer_C_Bind_Delegates::K2Node_CreateDelegate_OutputDelegate2' has a wrong offset!");
static_assert(offsetof(LobbyTimer_C_Bind_Delegates, CallFunc_GetContext_ReturnValue2) == 0x000040, "Member 'LobbyTimer_C_Bind_Delegates::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
