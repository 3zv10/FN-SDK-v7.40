...
static_assert(sizeof(APlayerSpawnPlacementActor_C) == 0x0006B0, "Wrong size on APlayerSpawnPlacementActor_C");
static_assert(offsetof(APlayerSpawnPlacementActor_C, Arrow) == 0x0006A8, "Member 'APlayerSpawnPlacementActor_C::Arrow' has a wrong offset!");
