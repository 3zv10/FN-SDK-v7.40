...
static_assert(offsetof(TabBrightnessOptions_C_ExecuteUbergraph_TabBrightnessOptions, K2Node_CreateDelegate_OutputDelegate) == 0x000024, "Member 'TabBrightnessOptions_C_ExecuteUbergraph_TabBrightnessOptions::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(offsetof(TabBrightnessOptions_C_ExecuteUbergraph_TabBrightnessOptions, K2Node_CustomEvent_Value) == 0x00005C, "Member 'TabBrightnessOptions_C_ExecuteUbergraph_TabBrightnessOptions::K2Node_CustomEvent_Value' has a wrong offset!");
...
static_assert(alignof(TabBrightnessOptions_C_Setting_Value_Changed) == 0x000004, "Wrong alignment on TabBrightnessOptions_C_Setting_Value_Changed");
static_assert(sizeof(TabBrightnessOptions_C_Setting_Value_Changed) == 0x000004, "Wrong size on TabBrightnessOptions_C_Setting_Value_Changed");
static_assert(offsetof(TabBrightnessOptions_C_Setting_Value_Changed, Value) == 0x000000, "Member 'TabBrightnessOptions_C_Setting_Value_Changed::Value' has a wrong offset!");
