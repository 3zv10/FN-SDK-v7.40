...
static_assert(sizeof(UAthenaLobbyPlayerPanelActions_C) == 0x0004F8, "Wrong size on UAthenaLobbyPlayerPanelActions_C");
...
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, ButtonMute) == 0x000260, "Member 'UAthenaLobbyPlayerPanelActions_C::ButtonMute' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, ViewProfileButton) == 0x000268, "Member 'UAthenaLobbyPlayerPanelActions_C::ViewProfileButton' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, HoveredActionButton) == 0x000270, "Member 'UAthenaLobbyPlayerPanelActions_C::HoveredActionButton' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, OnGadgetsClicked) == 0x000278, "Member 'UAthenaLobbyPlayerPanelActions_C::OnGadgetsClicked' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, TeamMemberInfo) == 0x000288, "Member 'UAthenaLobbyPlayerPanelActions_C::TeamMemberInfo' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, OnEmoteClicked) == 0x000488, "Member 'UAthenaLobbyPlayerPanelActions_C::OnEmoteClicked' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, AddFriendText) == 0x000498, "Member 'UAthenaLobbyPlayerPanelActions_C::AddFriendText' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, AcceptInviteText) == 0x0004B0, "Member 'UAthenaLobbyPlayerPanelActions_C::AcceptInviteText' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, SentInviteText) == 0x0004C8, "Member 'UAthenaLobbyPlayerPanelActions_C::SentInviteText' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, AcceptedInviteText) == 0x0004E0, "Member 'UAthenaLobbyPlayerPanelActions_C::AcceptedInviteText' has a wrong offset!");
