...
static_assert(offsetof(BP_ProjectileTrajectory_C_SetTrajectorySpline, Temp_int_Array_Index_Variable1) == 0x0000EC, "Member 'BP_ProjectileTrajectory_C_SetTrajectorySpline::Temp_int_Array_Index_Variable1' has a wrong offset!");
static_assert(offsetof(BP_ProjectileTrajectory_C_SetTrajectorySpline, Temp_int_Loop_Counter_Variable1) == 0x0000F0, "Member 'BP_ProjectileTrajectory_C_SetTrajectorySpline::Temp_int_Loop_Counter_Variable1' has a wrong offset!");
...
static_assert(offsetof(BP_ProjectileTrajectory_C_SetTrajectorySpline, CallFunc_Less_IntInt_ReturnValue1) == 0x000100, "Member 'BP_ProjectileTrajectory_C_SetTrajectorySpline::CallFunc_Less_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(BP_ProjectileTrajectory_C_SetTrajectorySpline, CallFunc_Add_IntInt_ReturnValue2) == 0x000104, "Member 'BP_ProjectileTrajectory_C_SetTrajectorySpline::CallFunc_Add_IntInt_ReturnValue2' has a wrong offset!");
static_assert(offsetof(BP_ProjectileTrajectory_C_SetTrajectorySpline, CallFunc_Add_IntInt_ReturnValue3) == 0x000108, "Member 'BP_ProjectileTrajectory_C_SetTrajectorySpline::CallFunc_Add_IntInt_ReturnValue3' has a wrong offset!");
...
static_assert(offsetof(BP_ProjectileTrajectory_C_SetTrajectorySpline, CallFunc_Array_Get_Item1) == 0x000110, "Member 'BP_ProjectileTrajectory_C_SetTrajectorySpline::CallFunc_Array_Get_Item1' has a wrong offset!");
static_assert(offsetof(BP_ProjectileTrajectory_C_SetTrajectorySpline, CallFunc_Array_Get_Item2) == 0x00011C, "Member 'BP_ProjectileTrajectory_C_SetTrajectorySpline::CallFunc_Array_Get_Item2' has a wrong offset!");
...
static_assert(offsetof(BP_ProjectileTrajectory_C_SetTrajectorySpline, CallFunc_Add_IntInt_ReturnValue4) == 0x000150, "Member 'BP_ProjectileTrajectory_C_SetTrajectorySpline::CallFunc_Add_IntInt_ReturnValue4' has a wrong offset!");
...
static_assert(offsetof(BP_ProjectileTrajectory_C_SetTrajectorySpline, CallFunc_Array_Get_Item3) == 0x000158, "Member 'BP_ProjectileTrajectory_C_SetTrajectorySpline::CallFunc_Array_Get_Item3' has a wrong offset!");
static_assert(offsetof(BP_ProjectileTrajectory_C_SetTrajectorySpline, CallFunc_Normal_ReturnValue1) == 0x000164, "Member 'BP_ProjectileTrajectory_C_SetTrajectorySpline::CallFunc_Normal_ReturnValue1' has a wrong offset!");
static_assert(offsetof(BP_ProjectileTrajectory_C_SetTrajectorySpline, CallFunc_Multiply_VectorFloat_ReturnValue1) == 0x000170, "Member 'BP_ProjectileTrajectory_C_SetTrajectorySpline::CallFunc_Multiply_VectorFloat_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(BP_ProjectileTrajectory_C_SetTrajectorySpline, CallFunc_GetLocationAtSplinePoint_ReturnValue1) == 0x000188, "Member 'BP_ProjectileTrajectory_C_SetTrajectorySpline::CallFunc_GetLocationAtSplinePoint_ReturnValue1' has a wrong offset!");
...
static_assert(sizeof(BP_ProjectileTrajectory_C_SetShouldUpdateFromOwner) == 0x000020, "Wrong size on BP_ProjectileTrajectory_C_SetShouldUpdateFromOwner");
static_assert(offsetof(BP_ProjectileTrajectory_C_SetShouldUpdateFromOwner, ShouldUpdate) == 0x000000, "Member 'BP_ProjectileTrajectory_C_SetShouldUpdateFromOwner::ShouldUpdate' has a wrong offset!");
...
static_assert(offsetof(BP_ProjectileTrajectory_C_SetShouldUpdateFromOwner, Interval) == 0x000010, "Member 'BP_ProjectileTrajectory_C_SetShouldUpdateFromOwner::Interval' has a wrong offset!");
static_assert(offsetof(BP_ProjectileTrajectory_C_SetShouldUpdateFromOwner, CallFunc_K2_SetTimer_ReturnValue) == 0x000018, "Member 'BP_ProjectileTrajectory_C_SetShouldUpdateFromOwner::CallFunc_K2_SetTimer_ReturnValue' has a wrong offset!");
