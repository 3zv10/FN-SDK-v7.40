...
static_assert(alignof(UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C) == 0x000008, "Wrong alignment on UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C");
static_assert(sizeof(UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C) == 0x0001A8, "Wrong size on UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C");
static_assert(offsetof(UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C, ConcurrencySettings) == 0x0001A0, "Member 'UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C::ConcurrencySettings' has a wrong offset!");
