...
static_assert(offsetof(PieChartRowWidget_C_Setup, Num_0) == 0x000000, "Member 'PieChartRowWidget_C_Setup::Num_0' has a wrong offset!");
static_assert(offsetof(PieChartRowWidget_C_Setup, Param_Name_0) == 0x000008, "Member 'PieChartRowWidget_C_Setup::Param_Name_0' has a wrong offset!");
static_assert(offsetof(PieChartRowWidget_C_Setup, Value_0) == 0x000020, "Member 'PieChartRowWidget_C_Setup::Value_0' has a wrong offset!");
