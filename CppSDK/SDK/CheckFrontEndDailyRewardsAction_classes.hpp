...
static_assert(sizeof(ACheckFrontEndDailyRewardsAction_C) == 0x0003A8, "Wrong size on ACheckFrontEndDailyRewardsAction_C");
static_assert(offsetof(ACheckFrontEndDailyRewardsAction_C, UberGraphFrame) == 0x000390, "Member 'ACheckFrontEndDailyRewardsAction_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ACheckFrontEndDailyRewardsAction_C, DefaultSceneRoot) == 0x000398, "Member 'ACheckFrontEndDailyRewardsAction_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(ACheckFrontEndDailyRewardsAction_C, bLastStateWasLoginScreen) == 0x0003A0, "Member 'ACheckFrontEndDailyRewardsAction_C::bLastStateWasLoginScreen' has a wrong offset!");
