...
static_assert(sizeof(ADA_BoostJumpPack_C) == 0x000A78, "Wrong size on ADA_BoostJumpPack_C");
static_assert(offsetof(ADA_BoostJumpPack_C, UberGraphFrame) == 0x000A10, "Member 'ADA_BoostJumpPack_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ADA_BoostJumpPack_C, ErrorReason) == 0x000A18, "Member 'ADA_BoostJumpPack_C::ErrorReason' has a wrong offset!");
static_assert(offsetof(ADA_BoostJumpPack_C, ErrorReasonGamepad) == 0x000A38, "Member 'ADA_BoostJumpPack_C::ErrorReasonGamepad' has a wrong offset!");
static_assert(offsetof(ADA_BoostJumpPack_C, ErrorCannotUse) == 0x000A58, "Member 'ADA_BoostJumpPack_C::ErrorCannotUse' has a wrong offset!");
