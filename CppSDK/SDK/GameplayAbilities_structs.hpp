...
static_assert(sizeof(FGameplayAttribute) == 0x000020, "Wrong size on FGameplayAttribute");
...
static_assert(sizeof(FGameplayEffectAttributeCaptureDefinition) == 0x000028, "Wrong size on FGameplayEffectAttributeCaptureDefinition");
...
static_assert(sizeof(FGameplayEffectModifiedAttribute) == 0x000028, "Wrong size on FGameplayEffectModifiedAttribute");
...
static_assert(sizeof(FScalableFloat) == 0x000020, "Wrong size on FScalableFloat");
...
static_assert(sizeof(FGameplayAbilitySpecDef) == 0x000090, "Wrong size on FGameplayAbilitySpecDef");
...
static_assert(offsetof(FGameplayAbilitySpecDef, InputID) == 0x000028, "Member 'FGameplayAbilitySpecDef::InputID' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpecDef, RemovalPolicy) == 0x00002C, "Member 'FGameplayAbilitySpecDef::RemovalPolicy' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpecDef, SourceObject) == 0x000030, "Member 'FGameplayAbilitySpecDef::SourceObject' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpecDef, AssignedHandle) == 0x000088, "Member 'FGameplayAbilitySpecDef::AssignedHandle' has a wrong offset!");
...
static_assert(sizeof(FActiveGameplayEffect) == 0x000370, "Wrong size on FActiveGameplayEffect");
...
static_assert(sizeof(FReplicatedPredictionKeyMap) == 0x0000C0, "Wrong size on FReplicatedPredictionKeyMap");
...
static_assert(sizeof(FGameplayEffectCue) == 0x000048, "Wrong size on FGameplayEffectCue");
...
static_assert(sizeof(FGameplayCueParameters) == 0x0000B8, "Wrong size on FGameplayCueParameters");
...
static_assert(sizeof(FActiveGameplayCueContainer) == 0x0000D0, "Wrong size on FActiveGameplayCueContainer");
...
static_assert(offsetof(FActiveGameplayCueContainer, Owner) == 0x0000C8, "Member 'FActiveGameplayCueContainer::Owner' has a wrong offset!");
...
static_assert(sizeof(FActiveGameplayEffectQuery) == 0x000070, "Wrong size on FActiveGameplayEffectQuery");
...
static_assert(sizeof(FGameplayAbilityTargetDataHandle) == 0x000020, "Wrong size on FGameplayAbilityTargetDataHandle");
...
static_assert(sizeof(FGameplayEventData) == 0x0000A8, "Wrong size on FGameplayEventData");
...
static_assert(sizeof(FGameplayEffectQuery) == 0x000138, "Wrong size on FGameplayEffectQuery");
...
static_assert(offsetof(FGameplayEffectQuery, EffectSource) == 0x000118, "Member 'FGameplayEffectQuery::EffectSource' has a wrong offset!");
static_assert(offsetof(FGameplayEffectQuery, EffectDefinition) == 0x000120, "Member 'FGameplayEffectQuery::EffectDefinition' has a wrong offset!");
...
static_assert(sizeof(FGameplayAbilityActorInfo) == 0x000040, "Wrong size on FGameplayAbilityActorInfo");
...
static_assert(sizeof(FGameplayEffectCustomExecutionParameters) == 0x0000A8, "Wrong size on FGameplayEffectCustomExecutionParameters");
...
public:
	...
	uint8                                         Pad_F0[0x310];                                     // 0x00F0(0x0310)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FActiveGameplayEffectsContainer) == 0x000428, "Wrong size on FActiveGameplayEffectsContainer");
static_assert(offsetof(FActiveGameplayEffectsContainer, GameplayEffects_Internal) == 0x0000E0, "Member 'FActiveGameplayEffectsContainer::GameplayEffects_Internal' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffectsContainer, ApplicationImmunityQueryEffects) == 0x000400, "Member 'FActiveGameplayEffectsContainer::ApplicationImmunityQueryEffects' has a wrong offset!");
...
static_assert(sizeof(FGameplayAbilitySpecContainer) == 0x0000C8, "Wrong size on FGameplayAbilitySpecContainer");
...
static_assert(offsetof(FGameplayAbilitySpecContainer, Owner) == 0x0000C0, "Member 'FGameplayAbilitySpecContainer::Owner' has a wrong offset!");
...
static_assert(sizeof(FMinimalGameplayCueReplicationProxy) == 0x0001C0, "Wrong size on FMinimalGameplayCueReplicationProxy");
static_assert(offsetof(FMinimalGameplayCueReplicationProxy, Owner) == 0x0001B0, "Member 'FMinimalGameplayCueReplicationProxy::Owner' has a wrong offset!");
...
static_assert(sizeof(FCustomCalculationBasedFloat) == 0x000078, "Wrong size on FCustomCalculationBasedFloat");
...
static_assert(offsetof(FCustomCalculationBasedFloat, PreMultiplyAdditiveValue) == 0x000028, "Member 'FCustomCalculationBasedFloat::PreMultiplyAdditiveValue' has a wrong offset!");
static_assert(offsetof(FCustomCalculationBasedFloat, PostMultiplyAdditiveValue) == 0x000048, "Member 'FCustomCalculationBasedFloat::PostMultiplyAdditiveValue' has a wrong offset!");
static_assert(offsetof(FCustomCalculationBasedFloat, FinalLookupCurve) == 0x000068, "Member 'FCustomCalculationBasedFloat::FinalLookupCurve' has a wrong offset!");
...
static_assert(sizeof(FGameplayTargetDataFilter) == 0x000028, "Wrong size on FGameplayTargetDataFilter");
...
static_assert(sizeof(FGameplayAbilityTargetData_SingleTargetHit) == 0x000090, "Wrong size on FGameplayAbilityTargetData_SingleTargetHit");
...
static_assert(sizeof(FAttributeBasedFloat) == 0x0000E0, "Wrong size on FAttributeBasedFloat");
...
static_assert(offsetof(FAttributeBasedFloat, PreMultiplyAdditiveValue) == 0x000020, "Member 'FAttributeBasedFloat::PreMultiplyAdditiveValue' has a wrong offset!");
static_assert(offsetof(FAttributeBasedFloat, PostMultiplyAdditiveValue) == 0x000040, "Member 'FAttributeBasedFloat::PostMultiplyAdditiveValue' has a wrong offset!");
static_assert(offsetof(FAttributeBasedFloat, BackingAttribute) == 0x000060, "Member 'FAttributeBasedFloat::BackingAttribute' has a wrong offset!");
static_assert(offsetof(FAttributeBasedFloat, AttributeCurve) == 0x000088, "Member 'FAttributeBasedFloat::AttributeCurve' has a wrong offset!");
static_assert(offsetof(FAttributeBasedFloat, AttributeCalculationType) == 0x000098, "Member 'FAttributeBasedFloat::AttributeCalculationType' has a wrong offset!");
static_assert(offsetof(FAttributeBasedFloat, FinalChannel) == 0x000099, "Member 'FAttributeBasedFloat::FinalChannel' has a wrong offset!");
static_assert(offsetof(FAttributeBasedFloat, SourceTagFilter) == 0x0000A0, "Member 'FAttributeBasedFloat::SourceTagFilter' has a wrong offset!");
static_assert(offsetof(FAttributeBasedFloat, TargetTagFilter) == 0x0000C0, "Member 'FAttributeBasedFloat::TargetTagFilter' has a wrong offset!");
...
static_assert(sizeof(FGameplayEffectModifierMagnitude) == 0x000190, "Wrong size on FGameplayEffectModifierMagnitude");
...
static_assert(offsetof(FGameplayEffectModifierMagnitude, AttributeBasedMagnitude) == 0x000028, "Member 'FGameplayEffectModifierMagnitude::AttributeBasedMagnitude' has a wrong offset!");
static_assert(offsetof(FGameplayEffectModifierMagnitude, CustomMagnitude) == 0x000108, "Member 'FGameplayEffectModifierMagnitude::CustomMagnitude' has a wrong offset!");
static_assert(offsetof(FGameplayEffectModifierMagnitude, SetByCallerMagnitude) == 0x000180, "Member 'FGameplayEffectModifierMagnitude::SetByCallerMagnitude' has a wrong offset!");
...
static_assert(sizeof(FGameplayModifierInfo) == 0x000260, "Wrong size on FGameplayModifierInfo");
...
static_assert(offsetof(FGameplayModifierInfo, EvaluationChannelSettings) == 0x0001D8, "Member 'FGameplayModifierInfo::EvaluationChannelSettings' has a wrong offset!");
static_assert(offsetof(FGameplayModifierInfo, SourceTags) == 0x0001E0, "Member 'FGameplayModifierInfo::SourceTags' has a wrong offset!");
static_assert(offsetof(FGameplayModifierInfo, TargetTags) == 0x000220, "Member 'FGameplayModifierInfo::TargetTags' has a wrong offset!");
...
static_assert(sizeof(FGameplayEffectExecutionScopedModifierInfo) == 0x000248, "Wrong size on FGameplayEffectExecutionScopedModifierInfo");
...
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, EvaluationChannelSettings) == 0x0001C0, "Member 'FGameplayEffectExecutionScopedModifierInfo::EvaluationChannelSettings' has a wrong offset!");
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, SourceTags) == 0x0001C8, "Member 'FGameplayEffectExecutionScopedModifierInfo::SourceTags' has a wrong offset!");
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, TargetTags) == 0x000208, "Member 'FGameplayEffectExecutionScopedModifierInfo::TargetTags' has a wrong offset!");
...
static_assert(sizeof(FGameplayModifierEvaluatedData) == 0x000038, "Wrong size on FGameplayModifierEvaluatedData");
