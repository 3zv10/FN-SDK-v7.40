...
static_assert(sizeof(USocialManager) == 0x000190, "Wrong size on USocialManager");
static_assert(offsetof(USocialManager, SocialToolkits) == 0x000040, "Member 'USocialManager::SocialToolkits' has a wrong offset!");
...
static_assert(alignof(USocialParty) == 0x000008, "Wrong alignment on USocialParty");
static_assert(sizeof(USocialParty) == 0x000260, "Wrong size on USocialParty");
...
static_assert(offsetof(USocialParty, OwningLocalUserId) == 0x000070, "Member 'USocialParty::OwningLocalUserId' has a wrong offset!");
static_assert(offsetof(USocialParty, CurrentLeaderId) == 0x000098, "Member 'USocialParty::CurrentLeaderId' has a wrong offset!");
static_assert(offsetof(USocialParty, PartyMembersById) == 0x0000C0, "Member 'USocialParty::PartyMembersById' has a wrong offset!");
...
static_assert(sizeof(UPartyMember) == 0x0000D8, "Wrong size on UPartyMember");
...
static_assert(sizeof(USocialChatManager) == 0x0001D0, "Wrong size on USocialChatManager");
...
static_assert(sizeof(USocialSettings) == 0x000040, "Wrong size on USocialSettings");
...
static_assert(sizeof(USocialUser) == 0x000138, "Wrong size on USocialUser");
