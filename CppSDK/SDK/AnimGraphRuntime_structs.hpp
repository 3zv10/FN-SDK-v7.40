...
static_assert(sizeof(FPoseDriverTarget) == 0x0000B8, "Wrong size on FPoseDriverTarget");
...
static_assert(sizeof(FAnimNode_PoseHandler) == 0x000068, "Wrong size on FAnimNode_PoseHandler");
static_assert(offsetof(FAnimNode_PoseHandler, PoseAsset) == 0x000030, "Member 'FAnimNode_PoseHandler::PoseAsset' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_PoseDriver) == 0x000100, "Wrong size on FAnimNode_PoseDriver");
static_assert(offsetof(FAnimNode_PoseDriver, SourcePose) == 0x000068, "Member 'FAnimNode_PoseDriver::SourcePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, SourceBones) == 0x000078, "Member 'FAnimNode_PoseDriver::SourceBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, OnlyDriveBones) == 0x000088, "Member 'FAnimNode_PoseDriver::OnlyDriveBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, PoseTargets) == 0x000098, "Member 'FAnimNode_PoseDriver::PoseTargets' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, EvalSpaceBone) == 0x0000D8, "Member 'FAnimNode_PoseDriver::EvalSpaceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, RBFParams) == 0x0000E8, "Member 'FAnimNode_PoseDriver::RBFParams' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, DriveSource) == 0x0000F8, "Member 'FAnimNode_PoseDriver::DriveSource' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, DriveOutput) == 0x0000F9, "Member 'FAnimNode_PoseDriver::DriveOutput' has a wrong offset!");
...
{
public:
	uint8                                         Pad_690[0x1C0];                                    // 0x0690(0x01C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimSequencerInstanceProxy) == 0x000010, "Wrong alignment on FAnimSequencerInstanceProxy");
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000850, "Wrong size on FAnimSequencerInstanceProxy");
...
public:
	...
	uint8                                         Pad_246[0xCA];                                     // 0x0246(0x00CA)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_AnimDynamics) == 0x000010, "Wrong alignment on FAnimNode_AnimDynamics");
static_assert(sizeof(FAnimNode_AnimDynamics) == 0x000310, "Wrong size on FAnimNode_AnimDynamics");
...
public:
	...
	uint8                                         Pad_50[0x88];                                      // 0x0050(0x0088)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FAnimNode_BlendSpacePlayer) == 0x0000E0, "Wrong size on FAnimNode_BlendSpacePlayer");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, X) == 0x000030, "Member 'FAnimNode_BlendSpacePlayer::X' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, Y) == 0x000034, "Member 'FAnimNode_BlendSpacePlayer::Y' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, Z) == 0x000038, "Member 'FAnimNode_BlendSpacePlayer::Z' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, PlayRate) == 0x00003C, "Member 'FAnimNode_BlendSpacePlayer::PlayRate' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, bLoop) == 0x000040, "Member 'FAnimNode_BlendSpacePlayer::bLoop' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, bResetPlayTimeWhenBlendSpaceChanges) == 0x000041, "Member 'FAnimNode_BlendSpacePlayer::bResetPlayTimeWhenBlendSpaceChanges' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, StartPosition) == 0x000044, "Member 'FAnimNode_BlendSpacePlayer::StartPosition' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, BlendSpace) == 0x000048, "Member 'FAnimNode_BlendSpacePlayer::BlendSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, PreviousBlendSpace) == 0x0000D8, "Member 'FAnimNode_BlendSpacePlayer::PreviousBlendSpace' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_AimOffsetLookAt) == 0x0001B0, "Wrong size on FAnimNode_AimOffsetLookAt");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, BasePose) == 0x000140, "Member 'FAnimNode_AimOffsetLookAt::BasePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, LODThreshold) == 0x000150, "Member 'FAnimNode_AimOffsetLookAt::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SourceSocketName) == 0x000154, "Member 'FAnimNode_AimOffsetLookAt::SourceSocketName' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, PivotSocketName) == 0x00015C, "Member 'FAnimNode_AimOffsetLookAt::PivotSocketName' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, LookAtLocation) == 0x000164, "Member 'FAnimNode_AimOffsetLookAt::LookAtLocation' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_BlendSpaceEvaluator) == 0x0000E8, "Wrong size on FAnimNode_BlendSpaceEvaluator");
static_assert(offsetof(FAnimNode_BlendSpaceEvaluator, NormalizedTime) == 0x0000E0, "Member 'FAnimNode_BlendSpaceEvaluator::NormalizedTime' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_20[0x44];                                      // 0x0020(0x0044)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(FAnimNode_RandomPlayer, bShuffleMode) == 0x000064, "Member 'FAnimNode_RandomPlayer::bShuffleMode' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_SequenceEvaluator) == 0x000048, "Wrong size on FAnimNode_SequenceEvaluator");
static_assert(offsetof(FAnimNode_SequenceEvaluator, Sequence) == 0x000030, "Member 'FAnimNode_SequenceEvaluator::Sequence' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator, ExplicitTime) == 0x000038, "Member 'FAnimNode_SequenceEvaluator::ExplicitTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator, bShouldLoop) == 0x00003C, "Member 'FAnimNode_SequenceEvaluator::bShouldLoop' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator, bTeleportToExplicitTime) == 0x00003D, "Member 'FAnimNode_SequenceEvaluator::bTeleportToExplicitTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator, ReinitializationBehavior) == 0x00003E, "Member 'FAnimNode_SequenceEvaluator::ReinitializationBehavior' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator, StartPosition) == 0x000040, "Member 'FAnimNode_SequenceEvaluator::StartPosition' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_LayeredBoneBlend) == 0x0000B8, "Wrong size on FAnimNode_LayeredBoneBlend");
...
static_assert(offsetof(FAnimNode_LayeredBoneBlend, bBlendRootMotionBasedOnRootBone) == 0x000052, "Member 'FAnimNode_LayeredBoneBlend::bBlendRootMotionBasedOnRootBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, LODThreshold) == 0x000054, "Member 'FAnimNode_LayeredBoneBlend::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, PerBoneBlendWeights) == 0x000058, "Member 'FAnimNode_LayeredBoneBlend::PerBoneBlendWeights' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, SkeletonGuid) == 0x000068, "Member 'FAnimNode_LayeredBoneBlend::SkeletonGuid' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, VirtualBoneGuid) == 0x000078, "Member 'FAnimNode_LayeredBoneBlend::VirtualBoneGuid' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_BlendListBase, BlendType) == 0x000030, "Member 'FAnimNode_BlendListBase::BlendType' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendListBase, bResetChildOnActivation) == 0x000031, "Member 'FAnimNode_BlendListBase::bResetChildOnActivation' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_PoseBlendNode) == 0x000088, "Wrong size on FAnimNode_PoseBlendNode");
static_assert(offsetof(FAnimNode_PoseBlendNode, SourcePose) == 0x000068, "Member 'FAnimNode_PoseBlendNode::SourcePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseBlendNode, BlendOption) == 0x000078, "Member 'FAnimNode_PoseBlendNode::BlendOption' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseBlendNode, CustomCurve) == 0x000080, "Member 'FAnimNode_PoseBlendNode::CustomCurve' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1A[0x11E];                                     // 0x001A(0x011E)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_CopyPoseFromMesh) == 0x000008, "Wrong alignment on FAnimNode_CopyPoseFromMesh");
static_assert(sizeof(FAnimNode_CopyPoseFromMesh) == 0x000138, "Wrong size on FAnimNode_CopyPoseFromMesh");
...
static_assert(offsetof(FAnimNode_CopyPoseFromMesh, bUseAttachedParent) == 0x000018, "Member 'FAnimNode_CopyPoseFromMesh::bUseAttachedParent' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyPoseFromMesh, bCopyCurves) == 0x000019, "Member 'FAnimNode_CopyPoseFromMesh::bCopyCurves' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1B5[0x39B];                                    // 0x01B5(0x039B)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_RigidBody) == 0x000010, "Wrong alignment on FAnimNode_RigidBody");
static_assert(sizeof(FAnimNode_RigidBody) == 0x000550, "Wrong size on FAnimNode_RigidBody");
...
static_assert(offsetof(FAnimNode_RigidBody, OverrideWorldGravity) == 0x000160, "Member 'FAnimNode_RigidBody::OverrideWorldGravity' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, ExternalForce) == 0x00016C, "Member 'FAnimNode_RigidBody::ExternalForce' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, ComponentLinearAccScale) == 0x000178, "Member 'FAnimNode_RigidBody::ComponentLinearAccScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, ComponentLinearVelScale) == 0x000184, "Member 'FAnimNode_RigidBody::ComponentLinearVelScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, ComponentAppliedLinearAccClamp) == 0x000190, "Member 'FAnimNode_RigidBody::ComponentAppliedLinearAccClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, CachedBoundsScale) == 0x00019C, "Member 'FAnimNode_RigidBody::CachedBoundsScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, BaseBoneRef) == 0x0001A0, "Member 'FAnimNode_RigidBody::BaseBoneRef' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, OverlapChannel) == 0x0001B0, "Member 'FAnimNode_RigidBody::OverlapChannel' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, SimulationSpace) == 0x0001B1, "Member 'FAnimNode_RigidBody::SimulationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, bForceDisableCollisionBetweenConstraintBodies) == 0x0001B2, "Member 'FAnimNode_RigidBody::bForceDisableCollisionBetweenConstraintBodies' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_PoseByName) == 0x000078, "Wrong size on FAnimNode_PoseByName");
static_assert(offsetof(FAnimNode_PoseByName, PoseName) == 0x000068, "Member 'FAnimNode_PoseByName::PoseName' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseByName, PoseWeight) == 0x000070, "Member 'FAnimNode_PoseByName::PoseWeight' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_Root) == 0x000020, "Wrong size on FAnimNode_Root");
...
static_assert(sizeof(FAnimNode_RotationOffsetBlendSpace) == 0x000188, "Wrong size on FAnimNode_RotationOffsetBlendSpace");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, BasePose) == 0x0000E0, "Member 'FAnimNode_RotationOffsetBlendSpace::BasePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, LODThreshold) == 0x0000F0, "Member 'FAnimNode_RotationOffsetBlendSpace::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, Alpha) == 0x0000F4, "Member 'FAnimNode_RotationOffsetBlendSpace::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBias) == 0x0000F8, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaBoolBlend) == 0x000100, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaCurveName) == 0x000148, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBiasClamp) == 0x000150, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaInputType) == 0x000184, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, bAlphaBoolEnabled) == 0x000185, "Member 'FAnimNode_RotationOffsetBlendSpace::bAlphaBoolEnabled' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_SplineIK) == 0x000250, "Wrong size on FAnimNode_SplineIK");
...
static_assert(sizeof(FAnimNode_Trail) == 0x000270, "Wrong size on FAnimNode_Trail");
...
static_assert(offsetof(FAnimNode_Trail, UnwindingSize) == 0x00011C, "Member 'FAnimNode_Trail::UnwindingSize' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, RelaxationSpeedScale) == 0x000120, "Member 'FAnimNode_Trail::RelaxationSpeedScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, TrailRelaxationSpeed) == 0x000128, "Member 'FAnimNode_Trail::TrailRelaxationSpeed' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, RelaxationSpeedScaleInputProcessor) == 0x0001B0, "Member 'FAnimNode_Trail::RelaxationSpeedScaleInputProcessor' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, RotationLimits) == 0x0001E0, "Member 'FAnimNode_Trail::RotationLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, RotationOffsets) == 0x0001F0, "Member 'FAnimNode_Trail::RotationOffsets' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, PlanarLimits) == 0x000200, "Member 'FAnimNode_Trail::PlanarLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, StretchLimit) == 0x000210, "Member 'FAnimNode_Trail::StretchLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, FakeVelocity) == 0x000214, "Member 'FAnimNode_Trail::FakeVelocity' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, BaseJoint) == 0x000220, "Member 'FAnimNode_Trail::BaseJoint' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, LastBoneRotationAnimAlphaBlend) == 0x000230, "Member 'FAnimNode_Trail::LastBoneRotationAnimAlphaBlend' has a wrong offset!");
...
static_assert(sizeof(FRBFTarget) == 0x000098, "Wrong size on FRBFTarget");
