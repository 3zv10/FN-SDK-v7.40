...
static_assert(sizeof(UStruct) == 0x000098, "Wrong size on UStruct");
...
static_assert(offsetof(UStruct, Size) == 0x000050, "Member 'UStruct::Size' has a wrong offset!");
static_assert(offsetof(UStruct, MinAlignemnt) == 0x000054, "Member 'UStruct::MinAlignemnt' has a wrong offset!");
...
static_assert(sizeof(UFunction) == 0x0000C8, "Wrong size on UFunction");
static_assert(offsetof(UFunction, FunctionFlags) == 0x000098, "Member 'UFunction::FunctionFlags' has a wrong offset!");
static_assert(offsetof(UFunction, ExecFunction) == 0x0000C0, "Member 'UFunction::ExecFunction' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_108[0x100];                                    // 0x0108(0x0100)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UClass) == 0x000208, "Wrong size on UClass");
...
static_assert(sizeof(UScriptStruct) == 0x0000A8, "Wrong size on UScriptStruct");
...
static_assert(sizeof(UDelegateFunction) == 0x0000C8, "Wrong size on UDelegateFunction");
...
static_assert(sizeof(UDynamicClass) == 0x000270, "Wrong size on UDynamicClass");
...
{
public:
	uint8                                         Pad_208[0x1B8];                                    // 0x0208(0x01B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULinkerPlaceholderFunction) == 0x000280, "Wrong size on ULinkerPlaceholderFunction");
