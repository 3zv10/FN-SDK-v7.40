...
static_assert(offsetof(GCNL_Athena_SnowSurface_C_ExecuteUbergraph_GCNL_Athena_SnowSurface, K2Node_Event_MyTarget1) == 0x0000F8, "Member 'GCNL_Athena_SnowSurface_C_ExecuteUbergraph_GCNL_Athena_SnowSurface::K2Node_Event_MyTarget1' has a wrong offset!");
static_assert(offsetof(GCNL_Athena_SnowSurface_C_ExecuteUbergraph_GCNL_Athena_SnowSurface, K2Node_Event_Parameters1) == 0x000100, "Member 'GCNL_Athena_SnowSurface_C_ExecuteUbergraph_GCNL_Athena_SnowSurface::K2Node_Event_Parameters1' has a wrong offset!");
static_assert(offsetof(GCNL_Athena_SnowSurface_C_ExecuteUbergraph_GCNL_Athena_SnowSurface, K2Node_Event_ParticleComponents1) == 0x0001B8, "Member 'GCNL_Athena_SnowSurface_C_ExecuteUbergraph_GCNL_Athena_SnowSurface::K2Node_Event_ParticleComponents1' has a wrong offset!");
static_assert(offsetof(GCNL_Athena_SnowSurface_C_ExecuteUbergraph_GCNL_Athena_SnowSurface, K2Node_Event_AudioComponents1) == 0x0001C8, "Member 'GCNL_Athena_SnowSurface_C_ExecuteUbergraph_GCNL_Athena_SnowSurface::K2Node_Event_AudioComponents1' has a wrong offset!");
...
static_assert(offsetof(GCNL_Athena_SnowSurface_C_ExecuteUbergraph_GCNL_Athena_SnowSurface, K2Node_DynamicCast_AsPlayer_Pawn_Athena_Generic1) == 0x0001E8, "Member 'GCNL_Athena_SnowSurface_C_ExecuteUbergraph_GCNL_Athena_SnowSurface::K2Node_DynamicCast_AsPlayer_Pawn_Athena_Generic1' has a wrong offset!");
static_assert(offsetof(GCNL_Athena_SnowSurface_C_ExecuteUbergraph_GCNL_Athena_SnowSurface, K2Node_DynamicCast_bSuccess1) == 0x0001F0, "Member 'GCNL_Athena_SnowSurface_C_ExecuteUbergraph_GCNL_Athena_SnowSurface::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
