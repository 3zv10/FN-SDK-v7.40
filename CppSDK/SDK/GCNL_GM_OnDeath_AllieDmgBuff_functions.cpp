...
#include "GCNL_GM_OnDeath_AllieDmgBuff_classes.hpp"
#include "GCNL_GM_OnDeath_AllieDmgBuff_parameters.hpp"
...
void AGCNL_GM_OnDeath_AllieDmgBuff_C::ExecuteUbergraph_GCNL_GM_OnDeath_AllieDmgBuff(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_GM_OnDeath_AllieDmgBuff_C", "ExecuteUbergraph_GCNL_GM_OnDeath_AllieDmgBuff");

	Params::GCNL_GM_OnDeath_AllieDmgBuff_C_ExecuteUbergraph_GCNL_GM_OnDeath_AllieDmgBuff Parms{};
...
void AGCNL_GM_OnDeath_AllieDmgBuff_C::OnRemoval(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_GM_OnDeath_AllieDmgBuff_C", "OnRemoval");

	Params::GCNL_GM_OnDeath_AllieDmgBuff_C_OnRemoval Parms{};
...
void AGCNL_GM_OnDeath_AllieDmgBuff_C::UserConstructionScript()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_GM_OnDeath_AllieDmgBuff_C", "UserConstructionScript");
...
bool AGCNL_GM_OnDeath_AllieDmgBuff_C::OnActive(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_GM_OnDeath_AllieDmgBuff_C", "OnActive");

	Params::GCNL_GM_OnDeath_AllieDmgBuff_C_OnActive Parms{};
