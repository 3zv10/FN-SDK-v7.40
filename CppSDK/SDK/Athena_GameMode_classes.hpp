...
static_assert(sizeof(AAthena_GameMode_C) == 0x001190, "Wrong size on AAthena_GameMode_C");
static_assert(offsetof(AAthena_GameMode_C, DefaultSceneRoot) == 0x001188, "Member 'AAthena_GameMode_C::DefaultSceneRoot' has a wrong offset!");
