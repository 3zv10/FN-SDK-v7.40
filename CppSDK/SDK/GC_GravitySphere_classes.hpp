...
static_assert(sizeof(AGC_GravitySphere_C) == 0x000440, "Wrong size on AGC_GravitySphere_C");
static_assert(offsetof(AGC_GravitySphere_C, UberGraphFrame) == 0x000428, "Member 'AGC_GravitySphere_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGC_GravitySphere_C, P_Outlander_GravitySphere_Feet_01) == 0x000430, "Member 'AGC_GravitySphere_C::P_Outlander_GravitySphere_Feet_01' has a wrong offset!");
static_assert(offsetof(AGC_GravitySphere_C, My_Target) == 0x000438, "Member 'AGC_GravitySphere_C::My_Target' has a wrong offset!");
