...
namespace Offsets
{
	constexpr int32 GObjects          = 0x05B918B8;
	constexpr int32 AppendString      = 0x0199C130;
	constexpr int32 GNames            = 0x05B8D390;
	constexpr int32 GWorld            = 0x05C80950;
	constexpr int32 ProcessEvent      = 0x01B4B0D0;
