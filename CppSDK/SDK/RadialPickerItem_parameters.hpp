...
static_assert(sizeof(RadialPickerItem_C_SetSelected) == 0x0000A0, "Wrong size on RadialPickerItem_C_SetSelected");
...
static_assert(offsetof(RadialPickerItem_C_SetSelected, Temp_bool_Variable1) == 0x000004, "Member 'RadialPickerItem_C_SetSelected::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(RadialPickerItem_C_SetSelected, K2Node_Select_Default) == 0x000005, "Member 'RadialPickerItem_C_SetSelected::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(RadialPickerItem_C_SetSelected, Temp_float_Variable) == 0x000008, "Member 'RadialPickerItem_C_SetSelected::Temp_float_Variable' has a wrong offset!");
...
static_assert(offsetof(RadialPickerItem_C_SetSelected, K2Node_Select1_Default) == 0x000028, "Member 'RadialPickerItem_C_SetSelected::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(RadialPickerItem_C_SetSelected, CallFunc_PlayAnimation_ReturnValue1) == 0x000030, "Member 'RadialPickerItem_C_SetSelected::CallFunc_PlayAnimation_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(RadialPickerItem_C_SetSelected, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x00003C, "Member 'RadialPickerItem_C_SetSelected::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RadialPickerItem_C_SetSelected, CallFunc_GetIsEnabled_ReturnValue) == 0x000048, "Member 'RadialPickerItem_C_SetSelected::CallFunc_GetIsEnabled_ReturnValue' has a wrong offset!");
static_assert(offsetof(RadialPickerItem_C_SetSelected, K2Node_MakeStruct_SlateColor) == 0x000050, "Member 'RadialPickerItem_C_SetSelected::K2Node_MakeStruct_SlateColor' has a wrong offset!");
static_assert(offsetof(RadialPickerItem_C_SetSelected, K2Node_MakeStruct_SlateColor1) == 0x000078, "Member 'RadialPickerItem_C_SetSelected::K2Node_MakeStruct_SlateColor1' has a wrong offset!");
