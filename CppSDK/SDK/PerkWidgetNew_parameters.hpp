...
static_assert(offsetof(PerkWidgetNew_C_InitializeBasicPerk, Temp_bool_Variable1) == 0x000001, "Member 'PerkWidgetNew_C_InitializeBasicPerk::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(PerkWidgetNew_C_InitializeBasicPerk, Temp_bool_Variable2) == 0x000008, "Member 'PerkWidgetNew_C_InitializeBasicPerk::Temp_bool_Variable2' has a wrong offset!");
static_assert(offsetof(PerkWidgetNew_C_InitializeBasicPerk, Temp_float_Variable1) == 0x00000C, "Member 'PerkWidgetNew_C_InitializeBasicPerk::Temp_float_Variable1' has a wrong offset!");
static_assert(offsetof(PerkWidgetNew_C_InitializeBasicPerk, Temp_bool_Variable3) == 0x000010, "Member 'PerkWidgetNew_C_InitializeBasicPerk::Temp_bool_Variable3' has a wrong offset!");
...
static_assert(offsetof(PerkWidgetNew_C_InitializeBasicPerk, K2Node_Select1_Default) == 0x000240, "Member 'PerkWidgetNew_C_InitializeBasicPerk::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(offsetof(PerkWidgetNew_C_InitializeBasicPerk, K2Node_Select2_Default) == 0x0002D0, "Member 'PerkWidgetNew_C_InitializeBasicPerk::K2Node_Select2_Default' has a wrong offset!");
static_assert(offsetof(PerkWidgetNew_C_InitializeBasicPerk, K2Node_Select3_Default) == 0x0002D4, "Member 'PerkWidgetNew_C_InitializeBasicPerk::K2Node_Select3_Default' has a wrong offset!");
...
static_assert(offsetof(PerkWidgetNew_C_InitializeAbilityPerk, Temp_bool_Variable1) == 0x000008, "Member 'PerkWidgetNew_C_InitializeAbilityPerk::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(PerkWidgetNew_C_InitializeAbilityPerk, Temp_float_Variable1) == 0x00000C, "Member 'PerkWidgetNew_C_InitializeAbilityPerk::Temp_float_Variable1' has a wrong offset!");
static_assert(offsetof(PerkWidgetNew_C_InitializeAbilityPerk, Temp_bool_Variable2) == 0x000010, "Member 'PerkWidgetNew_C_InitializeAbilityPerk::Temp_bool_Variable2' has a wrong offset!");
static_assert(offsetof(PerkWidgetNew_C_InitializeAbilityPerk, Temp_bool_Variable3) == 0x000011, "Member 'PerkWidgetNew_C_InitializeAbilityPerk::Temp_bool_Variable3' has a wrong offset!");
...
static_assert(offsetof(PerkWidgetNew_C_InitializeAbilityPerk, K2Node_Select1_Default) == 0x000240, "Member 'PerkWidgetNew_C_InitializeAbilityPerk::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(offsetof(PerkWidgetNew_C_InitializeAbilityPerk, K2Node_Select2_Default) == 0x0002D0, "Member 'PerkWidgetNew_C_InitializeAbilityPerk::K2Node_Select2_Default' has a wrong offset!");
static_assert(offsetof(PerkWidgetNew_C_InitializeAbilityPerk, K2Node_Select3_Default) == 0x0002D4, "Member 'PerkWidgetNew_C_InitializeAbilityPerk::K2Node_Select3_Default' has a wrong offset!");
...
static_assert(offsetof(PerkWidgetNew_C_InitializeText, Temp_bool_Variable1) == 0x000013, "Member 'PerkWidgetNew_C_InitializeText::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(PerkWidgetNew_C_InitializeText, Temp_byte_Variable2) == 0x000014, "Member 'PerkWidgetNew_C_InitializeText::Temp_byte_Variable2' has a wrong offset!");
...
static_assert(offsetof(PerkWidgetNew_C_InitializeText, Temp_byte_Variable4) == 0x000021, "Member 'PerkWidgetNew_C_InitializeText::Temp_byte_Variable4' has a wrong offset!");
...
static_assert(offsetof(PerkWidgetNew_C_InitializeText, Temp_byte_Variable5) == 0x000023, "Member 'PerkWidgetNew_C_InitializeText::Temp_byte_Variable5' has a wrong offset!");
static_assert(offsetof(PerkWidgetNew_C_InitializeText, Temp_bool_Variable2) == 0x000024, "Member 'PerkWidgetNew_C_InitializeText::Temp_bool_Variable2' has a wrong offset!");
static_assert(offsetof(PerkWidgetNew_C_InitializeText, K2Node_Select1_Default) == 0x000025, "Member 'PerkWidgetNew_C_InitializeText::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(offsetof(PerkWidgetNew_C_InitializeText, K2Node_DynamicCast_bSuccess1) == 0x000030, "Member 'PerkWidgetNew_C_InitializeText::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
...
static_assert(offsetof(PerkWidgetNew_C_SetupBadge, Temp_byte_Variable1) == 0x000002, "Member 'PerkWidgetNew_C_SetupBadge::Temp_byte_Variable1' has a wrong offset!");
...
public:
	...
	bool                                          bUseLargeFormatName_0;                             // 0x0004(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(PerkWidgetNew_C_InitializeSettings, bUseLegacyFixedSizeIcons_0) == 0x000002, "Member 'PerkWidgetNew_C_InitializeSettings::bUseLegacyFixedSizeIcons_0' has a wrong offset!");
static_assert(offsetof(PerkWidgetNew_C_InitializeSettings, IconSize_0) == 0x000003, "Member 'PerkWidgetNew_C_InitializeSettings::IconSize_0' has a wrong offset!");
static_assert(offsetof(PerkWidgetNew_C_InitializeSettings, bUseLargeFormatName_0) == 0x000004, "Member 'PerkWidgetNew_C_InitializeSettings::bUseLargeFormatName_0' has a wrong offset!");
...
static_assert(offsetof(PerkWidgetNew_C_SetDescriptionWraptTextAt, CallFunc_GreaterEqual_FloatFloat_ReturnValue1) == 0x00000D, "Member 'PerkWidgetNew_C_SetDescriptionWraptTextAt::CallFunc_GreaterEqual_FloatFloat_ReturnValue1' has a wrong offset!");
