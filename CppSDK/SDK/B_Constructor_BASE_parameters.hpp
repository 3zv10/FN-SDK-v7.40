...
static_assert(alignof(B_Constructor_BASE_C_BndEvt__P_FeeltheBase_Chargup_K2Node_ComponentBoundEvent_0_ParticleBurstSignature__DelegateSignature) == 0x000004, "Wrong alignment on B_Constructor_BASE_C_BndEvt__P_FeeltheBase_Chargup_K2Node_ComponentBoundEvent_0_ParticleBurstSignature__DelegateSignature");
...
static_assert(offsetof(B_Constructor_BASE_C_SetupHostileEffects, K2Node_MakeStruct_BASEGameplayEffect2) == 0x000078, "Member 'B_Constructor_BASE_C_SetupHostileEffects::K2Node_MakeStruct_BASEGameplayEffect2' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetupHostileEffects, CallFunc_Array_Add_ReturnValue2) == 0x000088, "Member 'B_Constructor_BASE_C_SetupHostileEffects::CallFunc_Array_Add_ReturnValue2' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetupHostileEffects, CallFunc_HasAllMatchingGameplayTags_TagContainerInterface2_CastInput) == 0x000090, "Member 'B_Constructor_BASE_C_SetupHostileEffects::CallFunc_HasAllMatchingGameplayTags_TagContainerInterface2_CastInput' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetupHostileEffects, CallFunc_HasAllMatchingGameplayTags_ReturnValue2) == 0x0000A0, "Member 'B_Constructor_BASE_C_SetupHostileEffects::CallFunc_HasAllMatchingGameplayTags_ReturnValue2' has a wrong offset!");
...
static_assert(sizeof(B_Constructor_BASE_C_SetDamageMultiplier) == 0x0000D0, "Wrong size on B_Constructor_BASE_C_SetDamageMultiplier");
...
static_assert(offsetof(B_Constructor_BASE_C_SetDamageMultiplier, CallFunc_DoesTagAssetInterfaceHaveTag_TagContainerInterface_CastInput) == 0x000040, "Member 'B_Constructor_BASE_C_SetDamageMultiplier::CallFunc_DoesTagAssetInterfaceHaveTag_TagContainerInterface_CastInput' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetDamageMultiplier, CallFunc_DoesTagAssetInterfaceHaveTag_ReturnValue) == 0x000050, "Member 'B_Constructor_BASE_C_SetDamageMultiplier::CallFunc_DoesTagAssetInterfaceHaveTag_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetDamageMultiplier, CallFunc_MakeOutgoingSpec_ReturnValue) == 0x000058, "Member 'B_Constructor_BASE_C_SetDamageMultiplier::CallFunc_MakeOutgoingSpec_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetDamageMultiplier, CallFunc_MakeOutgoingSpec_ReturnValue1) == 0x000068, "Member 'B_Constructor_BASE_C_SetDamageMultiplier::CallFunc_MakeOutgoingSpec_ReturnValue1' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetDamageMultiplier, CallFunc_AssignSetByCallerMagnitude_ReturnValue) == 0x000078, "Member 'B_Constructor_BASE_C_SetDamageMultiplier::CallFunc_AssignSetByCallerMagnitude_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetDamageMultiplier, CallFunc_HasAllMatchingGameplayTags_TagContainerInterface_CastInput) == 0x000088, "Member 'B_Constructor_BASE_C_SetDamageMultiplier::CallFunc_HasAllMatchingGameplayTags_TagContainerInterface_CastInput' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetDamageMultiplier, CallFunc_HasAllMatchingGameplayTags_ReturnValue) == 0x000098, "Member 'B_Constructor_BASE_C_SetDamageMultiplier::CallFunc_HasAllMatchingGameplayTags_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetDamageMultiplier, CallFunc_GetFloatAttributeFromAbilitySystemComponent_bSuccessfullyFoundAttribute) == 0x000099, "Member 'B_Constructor_BASE_C_SetDamageMultiplier::CallFunc_GetFloatAttributeFromAbilitySystemComponent_bSuccessfullyFoundAttribute' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetDamageMultiplier, CallFunc_GetFloatAttributeFromAbilitySystemComponent_ReturnValue) == 0x00009C, "Member 'B_Constructor_BASE_C_SetDamageMultiplier::CallFunc_GetFloatAttributeFromAbilitySystemComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetDamageMultiplier, CallFunc_EvaluateAttributeValueWithTagsAndBase_bSuccess) == 0x0000A0, "Member 'B_Constructor_BASE_C_SetDamageMultiplier::CallFunc_EvaluateAttributeValueWithTagsAndBase_bSuccess' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetDamageMultiplier, CallFunc_EvaluateAttributeValueWithTagsAndBase_ReturnValue) == 0x0000A4, "Member 'B_Constructor_BASE_C_SetDamageMultiplier::CallFunc_EvaluateAttributeValueWithTagsAndBase_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetDamageMultiplier, CallFunc_MakeOutgoingSpec_ReturnValue2) == 0x0000A8, "Member 'B_Constructor_BASE_C_SetDamageMultiplier::CallFunc_MakeOutgoingSpec_ReturnValue2' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetDamageMultiplier, CallFunc_AssignSetByCallerMagnitude_ReturnValue1) == 0x0000B8, "Member 'B_Constructor_BASE_C_SetDamageMultiplier::CallFunc_AssignSetByCallerMagnitude_ReturnValue1' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetDamageMultiplier, CallFunc_BooleanAND_ReturnValue) == 0x0000C8, "Member 'B_Constructor_BASE_C_SetDamageMultiplier::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Constructor_BASE_C_SetDamageMultiplier, CallFunc_IsValid_ReturnValue) == 0x0000C9, "Member 'B_Constructor_BASE_C_SetDamageMultiplier::CallFunc_IsValid_ReturnValue' has a wrong offset!");
