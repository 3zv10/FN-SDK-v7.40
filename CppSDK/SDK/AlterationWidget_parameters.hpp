...
static_assert(sizeof(AlterationWidget_C_GetHighlightColor) == 0x000058, "Wrong size on AlterationWidget_C_GetHighlightColor");
...
static_assert(offsetof(AlterationWidget_C_GetHighlightColor, CallFunc_Get_Buff_Color_Color) == 0x000034, "Member 'AlterationWidget_C_GetHighlightColor::CallFunc_Get_Buff_Color_Color' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_GetHighlightColor, K2Node_Select_Default) == 0x000044, "Member 'AlterationWidget_C_GetHighlightColor::K2Node_Select_Default' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_ShouldFadeAlteration, CallFunc_Not_PreBool_ReturnValue1) == 0x000013, "Member 'AlterationWidget_C_ShouldFadeAlteration::CallFunc_Not_PreBool_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_InitDescriptiveText, Temp_byte_Variable1) == 0x00000A, "Member 'AlterationWidget_C_InitDescriptiveText::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitDescriptiveText, Temp_bool_Variable1) == 0x00000B, "Member 'AlterationWidget_C_InitDescriptiveText::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitDescriptiveText, Temp_byte_Variable2) == 0x00000C, "Member 'AlterationWidget_C_InitDescriptiveText::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitDescriptiveText, Temp_byte_Variable3) == 0x00000D, "Member 'AlterationWidget_C_InitDescriptiveText::Temp_byte_Variable3' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitDescriptiveText, Temp_bool_Variable2) == 0x00000E, "Member 'AlterationWidget_C_InitDescriptiveText::Temp_bool_Variable2' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitDescriptiveText, Temp_byte_Variable4) == 0x00000F, "Member 'AlterationWidget_C_InitDescriptiveText::Temp_byte_Variable4' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitDescriptiveText, Temp_byte_Variable5) == 0x000010, "Member 'AlterationWidget_C_InitDescriptiveText::Temp_byte_Variable5' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitDescriptiveText, Temp_bool_Variable3) == 0x000011, "Member 'AlterationWidget_C_InitDescriptiveText::Temp_bool_Variable3' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_InitDescriptiveText, CallFunc_GetAlterationInfo_ReturnValue1) == 0x000068, "Member 'AlterationWidget_C_InitDescriptiveText::CallFunc_GetAlterationInfo_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_InitDescriptiveText, K2Node_Select1_Default) == 0x000091, "Member 'AlterationWidget_C_InitDescriptiveText::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitDescriptiveText, Temp_class_Variable1) == 0x000098, "Member 'AlterationWidget_C_InitDescriptiveText::Temp_class_Variable1' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitDescriptiveText, K2Node_Select2_Default) == 0x0000A0, "Member 'AlterationWidget_C_InitDescriptiveText::K2Node_Select2_Default' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitDescriptiveText, Temp_bool_Variable4) == 0x0000A8, "Member 'AlterationWidget_C_InitDescriptiveText::Temp_bool_Variable4' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitDescriptiveText, K2Node_Select3_Default) == 0x0000B0, "Member 'AlterationWidget_C_InitDescriptiveText::K2Node_Select3_Default' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitDescriptiveText, K2Node_Select4_Default) == 0x0000B8, "Member 'AlterationWidget_C_InitDescriptiveText::K2Node_Select4_Default' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_UpdatePips, Temp_bool_Variable1) == 0x0000B8, "Member 'AlterationWidget_C_UpdatePips::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_UpdatePips, CallFunc_GetAlterationInfo_ReturnValue1) == 0x0000C0, "Member 'AlterationWidget_C_UpdatePips::CallFunc_GetAlterationInfo_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_UpdatePips, CallFunc_GetAlterationDefintion_ReturnValue1) == 0x0000D8, "Member 'AlterationWidget_C_UpdatePips::CallFunc_GetAlterationDefintion_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_UpdatePips, CallFunc_EqualEqual_ByteByte_ReturnValue1) == 0x0000E2, "Member 'AlterationWidget_C_UpdatePips::CallFunc_EqualEqual_ByteByte_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_UpdatePips, CallFunc_IsFreeAlterationChoice_ReturnValue1) == 0x0000E5, "Member 'AlterationWidget_C_UpdatePips::CallFunc_IsFreeAlterationChoice_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_UpdatePips, K2Node_Select1_Default) == 0x0000FC, "Member 'AlterationWidget_C_UpdatePips::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_InitLockedLayout, Temp_byte_Variable1) == 0x000002, "Member 'AlterationWidget_C_InitLockedLayout::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitLockedLayout, Temp_bool_Variable1) == 0x000003, "Member 'AlterationWidget_C_InitLockedLayout::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitLockedLayout, Temp_bool_Variable2) == 0x000004, "Member 'AlterationWidget_C_InitLockedLayout::Temp_bool_Variable2' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitLockedLayout, Temp_byte_Variable2) == 0x000005, "Member 'AlterationWidget_C_InitLockedLayout::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitLockedLayout, Temp_byte_Variable3) == 0x000006, "Member 'AlterationWidget_C_InitLockedLayout::Temp_byte_Variable3' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_InitLockedLayout, CallFunc_ShouldFadeAlteration_ReturnValue1) == 0x000009, "Member 'AlterationWidget_C_InitLockedLayout::CallFunc_ShouldFadeAlteration_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_InitLockedLayout, K2Node_Select1_Default) == 0x000018, "Member 'AlterationWidget_C_InitLockedLayout::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_InitLockedLayout, CallFunc_ShouldFadeAlteration_ReturnValue2) == 0x000098, "Member 'AlterationWidget_C_InitLockedLayout::CallFunc_ShouldFadeAlteration_ReturnValue2' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitLockedLayout, K2Node_Select2_Default) == 0x000099, "Member 'AlterationWidget_C_InitLockedLayout::K2Node_Select2_Default' has a wrong offset!");
