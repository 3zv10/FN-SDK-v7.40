...
static_assert(offsetof(AGolfCartVehicleSK_C, Hit_ZImpulseMultiplier) == 0x000FC8, "Member 'AGolfCartVehicleSK_C::Hit_ZImpulseMultiplier' has a wrong offset!");
static_assert(offsetof(AGolfCartVehicleSK_C, Hit_LateralImpulseMultiplier) == 0x000FE8, "Member 'AGolfCartVehicleSK_C::Hit_LateralImpulseMultiplier' has a wrong offset!");
static_assert(offsetof(AGolfCartVehicleSK_C, Hit_MaxImpulseVelocity) == 0x001008, "Member 'AGolfCartVehicleSK_C::Hit_MaxImpulseVelocity' has a wrong offset!");
