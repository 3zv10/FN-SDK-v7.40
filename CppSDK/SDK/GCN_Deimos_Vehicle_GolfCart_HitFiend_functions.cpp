...
#include "GCN_Deimos_Vehicle_GolfCart_HitFiend_classes.hpp"
#include "GCN_Deimos_Vehicle_GolfCart_HitFiend_parameters.hpp"
...
void UGCN_Deimos_Vehicle_GolfCart_HitFiend_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Deimos_Vehicle_GolfCart_HitFiend_C", "OnBurst");

	Params::GCN_Deimos_Vehicle_GolfCart_HitFiend_C_OnBurst Parms{};
