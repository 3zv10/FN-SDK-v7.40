...
static_assert(sizeof(FTickAnimationSharingFunction) == 0x000058, "Wrong size on FTickAnimationSharingFunction");
...
static_assert(sizeof(FAnimationSetup) == 0x000038, "Wrong size on FAnimationSetup");
static_assert(offsetof(FAnimationSetup, AnimBlueprint) == 0x000000, "Member 'FAnimationSetup::AnimBlueprint' has a wrong offset!");
static_assert(offsetof(FAnimationSetup, AnimSequence) == 0x000008, "Member 'FAnimationSetup::AnimSequence' has a wrong offset!");
static_assert(offsetof(FAnimationSetup, NumRandomizedInstances) == 0x000030, "Member 'FAnimationSetup::NumRandomizedInstances' has a wrong offset!");
static_assert(offsetof(FAnimationSetup, Enabled) == 0x000034, "Member 'FAnimationSetup::Enabled' has a wrong offset!");
...
static_assert(sizeof(FPerSkeletonAnimationSharingSetup) == 0x000078, "Wrong size on FPerSkeletonAnimationSharingSetup");
...
static_assert(offsetof(FPerSkeletonAnimationSharingSetup, StateProcessorClass) == 0x000038, "Member 'FPerSkeletonAnimationSharingSetup::StateProcessorClass' has a wrong offset!");
static_assert(offsetof(FPerSkeletonAnimationSharingSetup, SkeletalMesh) == 0x000040, "Member 'FPerSkeletonAnimationSharingSetup::SkeletalMesh' has a wrong offset!");
static_assert(offsetof(FPerSkeletonAnimationSharingSetup, BlendAnimBlueprint) == 0x000068, "Member 'FPerSkeletonAnimationSharingSetup::BlendAnimBlueprint' has a wrong offset!");
static_assert(offsetof(FPerSkeletonAnimationSharingSetup, AdditiveAnimBlueprint) == 0x000070, "Member 'FPerSkeletonAnimationSharingSetup::AdditiveAnimBlueprint' has a wrong offset!");
