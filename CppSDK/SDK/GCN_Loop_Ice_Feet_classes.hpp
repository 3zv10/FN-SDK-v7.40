...
static_assert(alignof(AGCN_Loop_Ice_Feet_C) == 0x000008, "Wrong alignment on AGCN_Loop_Ice_Feet_C");
static_assert(sizeof(AGCN_Loop_Ice_Feet_C) == 0x000928, "Wrong size on AGCN_Loop_Ice_Feet_C");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, UberGraphFrame) == 0x000880, "Member 'AGCN_Loop_Ice_Feet_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, Duration) == 0x000888, "Member 'AGCN_Loop_Ice_Feet_C::Duration' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, ExpirationTellDuration) == 0x00088C, "Member 'AGCN_Loop_Ice_Feet_C::ExpirationTellDuration' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, TargetPlayer) == 0x000890, "Member 'AGCN_Loop_Ice_Feet_C::TargetPlayer' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, ExpireTellDelayTimer) == 0x000898, "Member 'AGCN_Loop_Ice_Feet_C::ExpireTellDelayTimer' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, ExpirationSoundTimer) == 0x0008A0, "Member 'AGCN_Loop_Ice_Feet_C::ExpirationSoundTimer' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, ExpirationSoundPeriod) == 0x0008A8, "Member 'AGCN_Loop_Ice_Feet_C::ExpirationSoundPeriod' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, SpawnedEmitters) == 0x0008B0, "Member 'AGCN_Loop_Ice_Feet_C::SpawnedEmitters' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, Crack) == 0x0008C0, "Member 'AGCN_Loop_Ice_Feet_C::Crack' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, DataTellDuration) == 0x0008C8, "Member 'AGCN_Loop_Ice_Feet_C::DataTellDuration' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, SC_Footstep_Local) == 0x0008E8, "Member 'AGCN_Loop_Ice_Feet_C::SC_Footstep_Local' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, SC_Footstep_Remote) == 0x0008F0, "Member 'AGCN_Loop_Ice_Feet_C::SC_Footstep_Remote' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, SC_Collision) == 0x0008F8, "Member 'AGCN_Loop_Ice_Feet_C::SC_Collision' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, CollisionAudioComp) == 0x000900, "Member 'AGCN_Loop_Ice_Feet_C::CollisionAudioComp' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, SpawnedAudioComps) == 0x000908, "Member 'AGCN_Loop_Ice_Feet_C::SpawnedAudioComps' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, SC_OnJumpOrBeginFalling) == 0x000918, "Member 'AGCN_Loop_Ice_Feet_C::SC_OnJumpOrBeginFalling' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_C, SC_OnLand) == 0x000920, "Member 'AGCN_Loop_Ice_Feet_C::SC_OnLand' has a wrong offset!");
