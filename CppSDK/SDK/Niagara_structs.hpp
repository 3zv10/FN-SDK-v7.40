...
static_assert(sizeof(FNiagaraVariableMetaData) == 0x000098, "Wrong size on FNiagaraVariableMetaData");
...
static_assert(offsetof(FNiagaraVariableMetaData, CategoryName) == 0x000068, "Member 'FNiagaraVariableMetaData::CategoryName' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, EditorSortPriority) == 0x000080, "Member 'FNiagaraVariableMetaData::EditorSortPriority' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, CallSortPriority) == 0x000084, "Member 'FNiagaraVariableMetaData::CallSortPriority' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, ReferencerNodes) == 0x000088, "Member 'FNiagaraVariableMetaData::ReferencerNodes' has a wrong offset!");
...
static_assert(sizeof(FNiagaraVMExecutableData) == 0x000168, "Wrong size on FNiagaraVMExecutableData");
...
static_assert(sizeof(FNiagaraVMExecutableDataId) == 0x000068, "Wrong size on FNiagaraVMExecutableDataId");
...
static_assert(offsetof(FNiagaraVMExecutableDataId, ReferencedDependencyIds) == 0x000048, "Member 'FNiagaraVMExecutableDataId::ReferencedDependencyIds' has a wrong offset!");
