...
static_assert(offsetof(GCN_Athena_DanceStun_C_ExecuteUbergraph_GCN_Athena_DanceStun, K2Node_Event_DeltaSeconds) == 0x00001C, "Member 'GCN_Athena_DanceStun_C_ExecuteUbergraph_GCN_Athena_DanceStun::K2Node_Event_DeltaSeconds' has a wrong offset!");
...
static_assert(offsetof(GCN_Athena_DanceStun_C_ExecuteUbergraph_GCN_Athena_DanceStun, CallFunc_Greater_FloatFloat_ReturnValue) == 0x0000BA, "Member 'GCN_Athena_DanceStun_C_ExecuteUbergraph_GCN_Athena_DanceStun::CallFunc_Greater_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_Athena_DanceStun_C_ExecuteUbergraph_GCN_Athena_DanceStun, CallFunc_Greater_FloatFloat_ReturnValue1) == 0x0000BB, "Member 'GCN_Athena_DanceStun_C_ExecuteUbergraph_GCN_Athena_DanceStun::CallFunc_Greater_FloatFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(GCN_Athena_DanceStun_C_ExecuteUbergraph_GCN_Athena_DanceStun, CallFunc_Subtract_FloatFloat_ReturnValue) == 0x0000BC, "Member 'GCN_Athena_DanceStun_C_ExecuteUbergraph_GCN_Athena_DanceStun::CallFunc_Subtract_FloatFloat_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(GCN_Athena_DanceStun_C_OnActive) == 0x0000E0, "Wrong size on GCN_Athena_DanceStun_C_OnActive");
...
static_assert(offsetof(GCN_Athena_DanceStun_C_OnActive, CallFunc_Conv_FloatToVector_ReturnValue) == 0x0000C4, "Member 'GCN_Athena_DanceStun_C_OnActive::CallFunc_Conv_FloatToVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_Athena_DanceStun_C_OnActive, K2Node_DynamicCast_AsFort_Player_Pawn_Athena) == 0x0000D0, "Member 'GCN_Athena_DanceStun_C_OnActive::K2Node_DynamicCast_AsFort_Player_Pawn_Athena' has a wrong offset!");
static_assert(offsetof(GCN_Athena_DanceStun_C_OnActive, K2Node_DynamicCast_bSuccess) == 0x0000D8, "Member 'GCN_Athena_DanceStun_C_OnActive::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(GCN_Athena_DanceStun_C_OnActive, CallFunc_GetValueAtLevel_ReturnValue) == 0x0000DC, "Member 'GCN_Athena_DanceStun_C_OnActive::CallFunc_GetValueAtLevel_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GCN_Athena_DanceStun_C_OnRemove, CallFunc_Conv_FloatToVector_ReturnValue) == 0x0000C4, "Member 'GCN_Athena_DanceStun_C_OnRemove::CallFunc_Conv_FloatToVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_Athena_DanceStun_C_OnRemove, CallFunc_IsValid_ReturnValue) == 0x0000D0, "Member 'GCN_Athena_DanceStun_C_OnRemove::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GCN_Athena_DanceStun_C_OnRemove, K2Node_DynamicCast_bSuccess) == 0x0000E0, "Member 'GCN_Athena_DanceStun_C_OnRemove::K2Node_DynamicCast_bSuccess' has a wrong offset!");
