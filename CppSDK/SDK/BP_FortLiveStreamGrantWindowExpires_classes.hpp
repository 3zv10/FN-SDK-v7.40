...
static_assert(sizeof(UBP_FortLiveStreamGrantWindowExpires_C) == 0x000340, "Wrong size on UBP_FortLiveStreamGrantWindowExpires_C");
...
static_assert(offsetof(UBP_FortLiveStreamGrantWindowExpires_C, SimulatedTimespan) == 0x0002F0, "Member 'UBP_FortLiveStreamGrantWindowExpires_C::SimulatedTimespan' has a wrong offset!");
static_assert(offsetof(UBP_FortLiveStreamGrantWindowExpires_C, StreamTimerExpired) == 0x0002F8, "Member 'UBP_FortLiveStreamGrantWindowExpires_C::StreamTimerExpired' has a wrong offset!");
static_assert(offsetof(UBP_FortLiveStreamGrantWindowExpires_C, StreamTimerStarted) == 0x000308, "Member 'UBP_FortLiveStreamGrantWindowExpires_C::StreamTimerStarted' has a wrong offset!");
static_assert(offsetof(UBP_FortLiveStreamGrantWindowExpires_C, SimulatedExpirationTimerHandle) == 0x000318, "Member 'UBP_FortLiveStreamGrantWindowExpires_C::SimulatedExpirationTimerHandle' has a wrong offset!");
static_assert(offsetof(UBP_FortLiveStreamGrantWindowExpires_C, CurrentName) == 0x000320, "Member 'UBP_FortLiveStreamGrantWindowExpires_C::CurrentName' has a wrong offset!");
static_assert(offsetof(UBP_FortLiveStreamGrantWindowExpires_C, TotalNames) == 0x000324, "Member 'UBP_FortLiveStreamGrantWindowExpires_C::TotalNames' has a wrong offset!");
static_assert(offsetof(UBP_FortLiveStreamGrantWindowExpires_C, Viewers) == 0x000328, "Member 'UBP_FortLiveStreamGrantWindowExpires_C::Viewers' has a wrong offset!");
static_assert(offsetof(UBP_FortLiveStreamGrantWindowExpires_C, SecondsToDisplayName) == 0x000338, "Member 'UBP_FortLiveStreamGrantWindowExpires_C::SecondsToDisplayName' has a wrong offset!");
