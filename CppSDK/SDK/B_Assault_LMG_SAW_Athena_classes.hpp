...
static_assert(sizeof(AB_Assault_LMG_SAW_Athena_C) == 0x000E08, "Wrong size on AB_Assault_LMG_SAW_Athena_C");
static_assert(offsetof(AB_Assault_LMG_SAW_Athena_C, UberGraphFrame_B_Assault_LMG_SAW_Athena_C) == 0x000DE8, "Member 'AB_Assault_LMG_SAW_Athena_C::UberGraphFrame_B_Assault_LMG_SAW_Athena_C' has a wrong offset!");
static_assert(offsetof(AB_Assault_LMG_SAW_Athena_C, LaserScaleUntargeted) == 0x000DF0, "Member 'AB_Assault_LMG_SAW_Athena_C::LaserScaleUntargeted' has a wrong offset!");
static_assert(offsetof(AB_Assault_LMG_SAW_Athena_C, LaserScaleTargeted) == 0x000DFC, "Member 'AB_Assault_LMG_SAW_Athena_C::LaserScaleTargeted' has a wrong offset!");
