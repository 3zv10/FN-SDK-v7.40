...
static_assert(sizeof(UGAT_ActiveAbility_C) == 0x000968, "Wrong size on UGAT_ActiveAbility_C");
static_assert(offsetof(UGAT_ActiveAbility_C, UberGraphFrame) == 0x000938, "Member 'UGAT_ActiveAbility_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGAT_ActiveAbility_C, TC_AbilitiesGenericActiveAbilityActivate) == 0x000940, "Member 'UGAT_ActiveAbility_C::TC_AbilitiesGenericActiveAbilityActivate' has a wrong offset!");
static_assert(offsetof(UGAT_ActiveAbility_C, N_SavedCollisionChannel) == 0x000948, "Member 'UGAT_ActiveAbility_C::N_SavedCollisionChannel' has a wrong offset!");
static_assert(offsetof(UGAT_ActiveAbility_C, GE_KnockBackImmunity) == 0x000950, "Member 'UGAT_ActiveAbility_C::GE_KnockBackImmunity' has a wrong offset!");
static_assert(offsetof(UGAT_ActiveAbility_C, GEH_KnockBackImmunity) == 0x000958, "Member 'UGAT_ActiveAbility_C::GEH_KnockBackImmunity' has a wrong offset!");
static_assert(offsetof(UGAT_ActiveAbility_C, bPlayerHolsterState) == 0x000960, "Member 'UGAT_ActiveAbility_C::bPlayerHolsterState' has a wrong offset!");
