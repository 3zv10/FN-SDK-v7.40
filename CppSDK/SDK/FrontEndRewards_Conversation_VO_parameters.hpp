...
static_assert(offsetof(FrontEndRewards_Conversation_VO_C_PopulateFromConversation, K2Node_CreateDelegate_OutputDelegate) == 0x00000C, "Member 'FrontEndRewards_Conversation_VO_C_PopulateFromConversation::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(sizeof(FrontEndRewards_Conversation_VO_C_HandleNewSentence) == 0x0000E8, "Wrong size on FrontEndRewards_Conversation_VO_C_HandleNewSentence");
...
static_assert(offsetof(FrontEndRewards_Conversation_VO_C_HandleNewSentence, CallFunc_GetDataFromSentence_Text) == 0x0000C8, "Member 'FrontEndRewards_Conversation_VO_C_HandleNewSentence::CallFunc_GetDataFromSentence_Text' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Conversation_VO_C_HandleNewSentence, CallFunc_GetDataFromSentence_TalkingHeadTexture) == 0x0000E0, "Member 'FrontEndRewards_Conversation_VO_C_HandleNewSentence::CallFunc_GetDataFromSentence_TalkingHeadTexture' has a wrong offset!");
...
static_assert(offsetof(FrontEndRewards_Conversation_VO_C_HandleConversationFinished, CallFunc_IsValid_ReturnValue1) == 0x000020, "Member 'FrontEndRewards_Conversation_VO_C_HandleConversationFinished::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
...
static_assert(sizeof(FrontEndRewards_Conversation_VO_C_PlayConversation) == 0x000030, "Wrong size on FrontEndRewards_Conversation_VO_C_PlayConversation");
...
static_assert(offsetof(FrontEndRewards_Conversation_VO_C_PlayConversation, K2Node_CreateDelegate_OutputDelegate) == 0x000014, "Member 'FrontEndRewards_Conversation_VO_C_PlayConversation::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Conversation_VO_C_PlayConversation, CallFunc_IsValidConversation_ReturnValue) == 0x000024, "Member 'FrontEndRewards_Conversation_VO_C_PlayConversation::CallFunc_IsValidConversation_ReturnValue' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Conversation_VO_C_PlayConversation, CallFunc_CreateConversationActor_NewAnnoucement) == 0x000028, "Member 'FrontEndRewards_Conversation_VO_C_PlayConversation::CallFunc_CreateConversationActor_NewAnnoucement' has a wrong offset!");
