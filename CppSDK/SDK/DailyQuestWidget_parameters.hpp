...
static_assert(alignof(DailyQuestWidget_C_Collect_Anim) == 0x000008, "Wrong alignment on DailyQuestWidget_C_Collect_Anim");
static_assert(sizeof(DailyQuestWidget_C_Collect_Anim) == 0x000008, "Wrong size on DailyQuestWidget_C_Collect_Anim");
static_assert(offsetof(DailyQuestWidget_C_Collect_Anim, CallFunc_PlayAnimation_ReturnValue) == 0x000000, "Member 'DailyQuestWidget_C_Collect_Anim::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
...
static_assert(alignof(DailyQuestWidget_C_Entrance_Anim) == 0x000008, "Wrong alignment on DailyQuestWidget_C_Entrance_Anim");
static_assert(sizeof(DailyQuestWidget_C_Entrance_Anim) == 0x000008, "Wrong size on DailyQuestWidget_C_Entrance_Anim");
static_assert(offsetof(DailyQuestWidget_C_Entrance_Anim, CallFunc_PlayAnimation_ReturnValue) == 0x000000, "Member 'DailyQuestWidget_C_Entrance_Anim::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
