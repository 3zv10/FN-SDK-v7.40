...
static_assert(sizeof(AAnnounce_OnboardingSatelliteCine_C) == 0x0003C8, "Wrong size on AAnnounce_OnboardingSatelliteCine_C");
static_assert(offsetof(AAnnounce_OnboardingSatelliteCine_C, UberGraphFrame) == 0x0003A0, "Member 'AAnnounce_OnboardingSatelliteCine_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AAnnounce_OnboardingSatelliteCine_C, DefaultSceneRoot) == 0x0003A8, "Member 'AAnnounce_OnboardingSatelliteCine_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(AAnnounce_OnboardingSatelliteCine_C, SatelliteMediaSource) == 0x0003B0, "Member 'AAnnounce_OnboardingSatelliteCine_C::SatelliteMediaSource' has a wrong offset!");
static_assert(offsetof(AAnnounce_OnboardingSatelliteCine_C, AllowSkipping) == 0x0003B8, "Member 'AAnnounce_OnboardingSatelliteCine_C::AllowSkipping' has a wrong offset!");
static_assert(offsetof(AAnnounce_OnboardingSatelliteCine_C, StartingState) == 0x0003B9, "Member 'AAnnounce_OnboardingSatelliteCine_C::StartingState' has a wrong offset!");
static_assert(offsetof(AAnnounce_OnboardingSatelliteCine_C, SatelliteSubtitlesPlayer) == 0x0003C0, "Member 'AAnnounce_OnboardingSatelliteCine_C::SatelliteSubtitlesPlayer' has a wrong offset!");
