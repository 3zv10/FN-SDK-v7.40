...
void AParentBuildingContainerBlueprint_C::GetTimeOfDayBlueprintDefaultVariables(struct FTimeOfDayBlueprintDefaultVariables* OutVariables)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("ParentBuildingContainerBlueprint_C", "GetTimeOfDayBlueprintDefaultVariables");

	Params::ParentBuildingContainerBlueprint_C_GetTimeOfDayBlueprintDefaultVariables Parms{};
