...
static_assert(alignof(FLandscapeProceduralLayerBrush) == 0x000008, "Wrong alignment on FLandscapeProceduralLayerBrush");
static_assert(sizeof(FLandscapeProceduralLayerBrush) == 0x000008, "Wrong size on FLandscapeProceduralLayerBrush");
static_assert(offsetof(FLandscapeProceduralLayerBrush, BPCustomBrush) == 0x000000, "Member 'FLandscapeProceduralLayerBrush::BPCustomBrush' has a wrong offset!");
...
static_assert(alignof(FProceduralLayer) == 0x000008, "Wrong alignment on FProceduralLayer");
static_assert(sizeof(FProceduralLayer) == 0x000040, "Wrong size on FProceduralLayer");
static_assert(offsetof(FProceduralLayer, Name) == 0x000000, "Member 'FProceduralLayer::Name' has a wrong offset!");
static_assert(offsetof(FProceduralLayer, Visible) == 0x000008, "Member 'FProceduralLayer::Visible' has a wrong offset!");
static_assert(offsetof(FProceduralLayer, Weight) == 0x00000C, "Member 'FProceduralLayer::Weight' has a wrong offset!");
static_assert(offsetof(FProceduralLayer, Brushes) == 0x000010, "Member 'FProceduralLayer::Brushes' has a wrong offset!");
static_assert(offsetof(FProceduralLayer, HeightmapBrushOrderIndices) == 0x000020, "Member 'FProceduralLayer::HeightmapBrushOrderIndices' has a wrong offset!");
static_assert(offsetof(FProceduralLayer, WeightmapBrushOrderIndices) == 0x000030, "Member 'FProceduralLayer::WeightmapBrushOrderIndices' has a wrong offset!");
...
static_assert(offsetof(FGrassVariety, bCastDynamicShadow) == 0x000041, "Member 'FGrassVariety::bCastDynamicShadow' has a wrong offset!");
static_assert(offsetof(FGrassVariety, bKeepInstanceBufferCPUCopy) == 0x000042, "Member 'FGrassVariety::bKeepInstanceBufferCPUCopy' has a wrong offset!");
...
static_assert(alignof(FProceduralLayerData) == 0x000008, "Wrong alignment on FProceduralLayerData");
static_assert(sizeof(FProceduralLayerData) == 0x000050, "Wrong size on FProceduralLayerData");
static_assert(offsetof(FProceduralLayerData, Heightmaps) == 0x000000, "Member 'FProceduralLayerData::Heightmaps' has a wrong offset!");
...
static_assert(alignof(FRenderDataPerHeightmap) == 0x000008, "Wrong alignment on FRenderDataPerHeightmap");
static_assert(sizeof(FRenderDataPerHeightmap) == 0x000028, "Wrong size on FRenderDataPerHeightmap");
static_assert(offsetof(FRenderDataPerHeightmap, OriginalHeightmap) == 0x000000, "Member 'FRenderDataPerHeightmap::OriginalHeightmap' has a wrong offset!");
static_assert(offsetof(FRenderDataPerHeightmap, Components) == 0x000010, "Member 'FRenderDataPerHeightmap::Components' has a wrong offset!");
static_assert(offsetof(FRenderDataPerHeightmap, TopLeftSectionBase) == 0x000020, "Member 'FRenderDataPerHeightmap::TopLeftSectionBase' has a wrong offset!");
