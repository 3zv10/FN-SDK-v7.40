...
#include "GCN_Athena_Blade_LeapAttack_Impact_classes.hpp"
#include "GCN_Athena_Blade_LeapAttack_Impact_parameters.hpp"
...
void UGCN_Athena_Blade_LeapAttack_Impact_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Athena_Blade_LeapAttack_Impact_C", "OnBurst");

	Params::GCN_Athena_Blade_LeapAttack_Impact_C_OnBurst Parms{};
