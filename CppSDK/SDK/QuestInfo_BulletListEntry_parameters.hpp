...
static_assert(sizeof(QuestInfo_BulletListEntry_C_InitBrush) == 0x0000A8, "Wrong size on QuestInfo_BulletListEntry_C_InitBrush");
...
static_assert(offsetof(QuestInfo_BulletListEntry_C_InitBrush, CallFunc_CalcBrushSize_ReturnValue) == 0x0000A0, "Member 'QuestInfo_BulletListEntry_C_InitBrush::CallFunc_CalcBrushSize_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(QuestInfo_BulletListEntry_C_CalcBrushSize, CallFunc_BreakVector2D_X1) == 0x00002C, "Member 'QuestInfo_BulletListEntry_C_CalcBrushSize::CallFunc_BreakVector2D_X1' has a wrong offset!");
static_assert(offsetof(QuestInfo_BulletListEntry_C_CalcBrushSize, CallFunc_BreakVector2D_Y1) == 0x000030, "Member 'QuestInfo_BulletListEntry_C_CalcBrushSize::CallFunc_BreakVector2D_Y1' has a wrong offset!");
static_assert(offsetof(QuestInfo_BulletListEntry_C_CalcBrushSize, CallFunc_Divide_FloatFloat_ReturnValue1) == 0x000034, "Member 'QuestInfo_BulletListEntry_C_CalcBrushSize::CallFunc_Divide_FloatFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(QuestInfo_BulletListEntry_C_CalcBrushSize, CallFunc_BreakVector2D_X2) == 0x000038, "Member 'QuestInfo_BulletListEntry_C_CalcBrushSize::CallFunc_BreakVector2D_X2' has a wrong offset!");
static_assert(offsetof(QuestInfo_BulletListEntry_C_CalcBrushSize, CallFunc_BreakVector2D_Y2) == 0x00003C, "Member 'QuestInfo_BulletListEntry_C_CalcBrushSize::CallFunc_BreakVector2D_Y2' has a wrong offset!");
