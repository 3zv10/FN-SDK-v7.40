...
static_assert(sizeof(UIconAndNameWidget_C) == 0x000320, "Wrong size on UIconAndNameWidget_C");
...
static_assert(offsetof(UIconAndNameWidget_C, Text) == 0x0002E8, "Member 'UIconAndNameWidget_C::Text' has a wrong offset!");
static_assert(offsetof(UIconAndNameWidget_C, BorderStyle) == 0x000300, "Member 'UIconAndNameWidget_C::BorderStyle' has a wrong offset!");
static_assert(offsetof(UIconAndNameWidget_C, bBorderVisible) == 0x000308, "Member 'UIconAndNameWidget_C::bBorderVisible' has a wrong offset!");
static_assert(offsetof(UIconAndNameWidget_C, bMatches) == 0x000309, "Member 'UIconAndNameWidget_C::bMatches' has a wrong offset!");
static_assert(offsetof(UIconAndNameWidget_C, bBorderColorOverride) == 0x00030A, "Member 'UIconAndNameWidget_C::bBorderColorOverride' has a wrong offset!");
static_assert(offsetof(UIconAndNameWidget_C, RGBA0) == 0x00030C, "Member 'UIconAndNameWidget_C::RGBA0' has a wrong offset!");
