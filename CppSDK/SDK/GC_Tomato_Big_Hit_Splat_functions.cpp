...
#include "GC_Tomato_Big_Hit_Splat_classes.hpp"
#include "GC_Tomato_Big_Hit_Splat_parameters.hpp"
...
void UGC_Tomato_Big_Hit_Splat_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Tomato_Big_Hit_Splat_C", "OnBurst");

	Params::GC_Tomato_Big_Hit_Splat_C_OnBurst Parms{};
