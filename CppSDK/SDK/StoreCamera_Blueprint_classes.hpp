...
public:
	...
	class UStaticMeshComponent*                   Mesh_DarkenBG;                                     // 0x0888(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(AStoreCamera_Blueprint_C, Mesh_DarkenBG) == 0x000888, "Member 'AStoreCamera_Blueprint_C::Mesh_DarkenBG' has a wrong offset!");
