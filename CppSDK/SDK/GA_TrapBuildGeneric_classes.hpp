...
static_assert(sizeof(UGA_TrapBuildGeneric_C) == 0x000940, "Wrong size on UGA_TrapBuildGeneric_C");
static_assert(offsetof(UGA_TrapBuildGeneric_C, UberGraphFrame) == 0x000938, "Member 'UGA_TrapBuildGeneric_C::UberGraphFrame' has a wrong offset!");
