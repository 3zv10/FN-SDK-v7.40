...
public:
	...
	class AFortClientAnnouncement_Conversation*   ConversationAnnouncement;                          // 0x0258(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UAnnouncement_ZoneModifiers_C) == 0x000260, "Wrong size on UAnnouncement_ZoneModifiers_C");
...
static_assert(offsetof(UAnnouncement_ZoneModifiers_C, ConversationAnnouncement) == 0x000258, "Member 'UAnnouncement_ZoneModifiers_C::ConversationAnnouncement' has a wrong offset!");
