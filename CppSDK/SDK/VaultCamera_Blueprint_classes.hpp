...
static_assert(sizeof(AVaultCamera_Blueprint_C) == 0x0008A0, "Wrong size on AVaultCamera_Blueprint_C");
static_assert(offsetof(AVaultCamera_Blueprint_C, UberGraphFrame) == 0x000880, "Member 'AVaultCamera_Blueprint_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AVaultCamera_Blueprint_C, CachedPawn) == 0x000888, "Member 'AVaultCamera_Blueprint_C::CachedPawn' has a wrong offset!");
static_assert(offsetof(AVaultCamera_Blueprint_C, MouseDown) == 0x000890, "Member 'AVaultCamera_Blueprint_C::MouseDown' has a wrong offset!");
static_assert(offsetof(AVaultCamera_Blueprint_C, VaultActor) == 0x000898, "Member 'AVaultCamera_Blueprint_C::VaultActor' has a wrong offset!");
