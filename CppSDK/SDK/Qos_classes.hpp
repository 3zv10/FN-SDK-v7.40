...
static_assert(sizeof(AQosBeaconClient) == 0x0003E8, "Wrong size on AQosBeaconClient");
...
static_assert(sizeof(AQosBeaconHost) == 0x000368, "Wrong size on AQosBeaconHost");
