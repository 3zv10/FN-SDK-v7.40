...
static_assert(sizeof(UItemInspectEvolutionIngredientsEntry_C) == 0x0002E8, "Wrong size on UItemInspectEvolutionIngredientsEntry_C");
...
static_assert(offsetof(UItemInspectEvolutionIngredientsEntry_C, NotHaveColor) == 0x000298, "Member 'UItemInspectEvolutionIngredientsEntry_C::NotHaveColor' has a wrong offset!");
static_assert(offsetof(UItemInspectEvolutionIngredientsEntry_C, HaveColor) == 0x0002C0, "Member 'UItemInspectEvolutionIngredientsEntry_C::HaveColor' has a wrong offset!");
