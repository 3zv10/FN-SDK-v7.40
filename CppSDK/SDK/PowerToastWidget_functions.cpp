...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FUniqueNetIdRepl&          NewTeamMemberId                                        (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
...
void UPowerToastWidget_C::HandleToastFinished()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PowerToastWidget_C", "HandleToastFinished");
