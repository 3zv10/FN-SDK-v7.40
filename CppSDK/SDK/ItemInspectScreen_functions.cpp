...
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool*                                   ShouldShowRefundMessage_0                              (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
// class FText*                            RefundDescriptionText                                  (Parm, OutParm)

void UItemInspectScreen_C::ShouldShowRefundMessage(bool* ShouldShowRefundMessage_0, class FText* RefundDescriptionText)
{
	static class UFunction* Func = nullptr;
	...
	if (ShouldShowRefundMessage_0 != nullptr)
		*ShouldShowRefundMessage_0 = Parms.ShouldShowRefundMessage_0;
