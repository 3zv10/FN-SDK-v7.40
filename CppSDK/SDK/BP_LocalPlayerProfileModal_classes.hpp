...
static_assert(sizeof(UBP_LocalPlayerProfileModal_C) == 0x0003B0, "Wrong size on UBP_LocalPlayerProfileModal_C");
static_assert(offsetof(UBP_LocalPlayerProfileModal_C, UberGraphFrame) == 0x000348, "Member 'UBP_LocalPlayerProfileModal_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_LocalPlayerProfileModal_C, BP_LocalPlayerBannerEditor) == 0x000350, "Member 'UBP_LocalPlayerProfileModal_C::BP_LocalPlayerBannerEditor' has a wrong offset!");
static_assert(offsetof(UBP_LocalPlayerProfileModal_C, BP_LocalPlayerProfileManagement) == 0x000358, "Member 'UBP_LocalPlayerProfileModal_C::BP_LocalPlayerProfileManagement' has a wrong offset!");
static_assert(offsetof(UBP_LocalPlayerProfileModal_C, CommonWidgetSwitcher_0) == 0x000360, "Member 'UBP_LocalPlayerProfileModal_C::CommonWidgetSwitcher_0' has a wrong offset!");
static_assert(offsetof(UBP_LocalPlayerProfileModal_C, Lightbox) == 0x000368, "Member 'UBP_LocalPlayerProfileModal_C::Lightbox' has a wrong offset!");
static_assert(offsetof(UBP_LocalPlayerProfileModal_C, CloseAction) == 0x000370, "Member 'UBP_LocalPlayerProfileModal_C::CloseAction' has a wrong offset!");
static_assert(offsetof(UBP_LocalPlayerProfileModal_C, LastChosenIcon) == 0x000380, "Member 'UBP_LocalPlayerProfileModal_C::LastChosenIcon' has a wrong offset!");
static_assert(offsetof(UBP_LocalPlayerProfileModal_C, LastChosenColor) == 0x000388, "Member 'UBP_LocalPlayerProfileModal_C::LastChosenColor' has a wrong offset!");
static_assert(offsetof(UBP_LocalPlayerProfileModal_C, PreviousAction) == 0x000390, "Member 'UBP_LocalPlayerProfileModal_C::PreviousAction' has a wrong offset!");
static_assert(offsetof(UBP_LocalPlayerProfileModal_C, NextAction) == 0x0003A0, "Member 'UBP_LocalPlayerProfileModal_C::NextAction' has a wrong offset!");
