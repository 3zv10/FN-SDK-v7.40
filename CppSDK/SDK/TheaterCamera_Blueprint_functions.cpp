...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FVector&                   HexWorldLoc                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ATheaterCamera_Blueprint_C::InpActEvt_MouseScrollDown_K2Node_InputKeyEvent_0(const struct FKey& Key)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("TheaterCamera_Blueprint_C", "InpActEvt_MouseScrollDown_K2Node_InputKeyEvent_0");

	Params::TheaterCamera_Blueprint_C_InpActEvt_MouseScrollDown_K2Node_InputKeyEvent_0 Parms{};
...
void ATheaterCamera_Blueprint_C::InpActEvt_MouseScrollUp_K2Node_InputKeyEvent_1(const struct FKey& Key)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("TheaterCamera_Blueprint_C", "InpActEvt_MouseScrollUp_K2Node_InputKeyEvent_1");

	Params::TheaterCamera_Blueprint_C_InpActEvt_MouseScrollUp_K2Node_InputKeyEvent_1 Parms{};
...
void ATheaterCamera_Blueprint_C::SetSuspendInput(bool SuspendInput)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("TheaterCamera_Blueprint_C", "SetSuspendInput");

	Params::TheaterCamera_Blueprint_C_SetSuspendInput Parms{};
...
void ATheaterCamera_Blueprint_C::ZoomCameraWithHeldGamepadInput()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("TheaterCamera_Blueprint_C", "ZoomCameraWithHeldGamepadInput");
