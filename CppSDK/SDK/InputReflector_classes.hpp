...
static_assert(sizeof(UInputReflector_C) == 0x000290, "Wrong size on UInputReflector_C");
...
static_assert(offsetof(UInputReflector_C, SizeBoxShell) == 0x000278, "Member 'UInputReflector_C::SizeBoxShell' has a wrong offset!");
static_assert(offsetof(UInputReflector_C, DefaultButtonMargin) == 0x000280, "Member 'UInputReflector_C::DefaultButtonMargin' has a wrong offset!");
