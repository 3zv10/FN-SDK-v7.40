...
static_assert(sizeof(AOnlineBeacon) == 0x000360, "Wrong size on AOnlineBeacon");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionInitialTimeout) == 0x000338, "Member 'AOnlineBeacon::BeaconConnectionInitialTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionTimeout) == 0x00033C, "Member 'AOnlineBeacon::BeaconConnectionTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, NetDriver) == 0x000340, "Member 'AOnlineBeacon::NetDriver' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_371[0x3F];                                     // 0x0371(0x003F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AOnlineBeaconClient) == 0x0003B0, "Wrong size on AOnlineBeaconClient");
static_assert(offsetof(AOnlineBeaconClient, BeaconOwner) == 0x000360, "Member 'AOnlineBeaconClient::BeaconOwner' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, BeaconConnection) == 0x000368, "Member 'AOnlineBeaconClient::BeaconConnection' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, ConnectionState) == 0x000370, "Member 'AOnlineBeaconClient::ConnectionState' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_433[0x2D];                                     // 0x0433(0x002D)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(APartyBeaconClient) == 0x000460, "Wrong size on APartyBeaconClient");
static_assert(offsetof(APartyBeaconClient, DestSessionId) == 0x0003E0, "Member 'APartyBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, PendingReservation) == 0x0003F0, "Member 'APartyBeaconClient::PendingReservation' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, RequestType) == 0x000430, "Member 'APartyBeaconClient::RequestType' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bPendingReservationSent) == 0x000431, "Member 'APartyBeaconClient::bPendingReservationSent' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bCancelReservation) == 0x000432, "Member 'APartyBeaconClient::bCancelReservation' has a wrong offset!");
...
static_assert(sizeof(AOnlineBeaconHostObject) == 0x000358, "Wrong size on AOnlineBeaconHostObject");
static_assert(offsetof(AOnlineBeaconHostObject, BeaconTypeName) == 0x000330, "Member 'AOnlineBeaconHostObject::BeaconTypeName' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientBeaconActorClass) == 0x000340, "Member 'AOnlineBeaconHostObject::ClientBeaconActorClass' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientActors) == 0x000348, "Member 'AOnlineBeaconHostObject::ClientActors' has a wrong offset!");
...
static_assert(sizeof(APartyBeaconHost) == 0x0003D0, "Wrong size on APartyBeaconHost");
static_assert(offsetof(APartyBeaconHost, State) == 0x000358, "Member 'APartyBeaconHost::State' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, bLogoutOnSessionTimeout) == 0x0003C0, "Member 'APartyBeaconHost::bLogoutOnSessionTimeout' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, SessionTimeoutSecs) == 0x0003C4, "Member 'APartyBeaconHost::SessionTimeoutSecs' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, TravelSessionTimeoutSecs) == 0x0003C8, "Member 'APartyBeaconHost::TravelSessionTimeoutSecs' has a wrong offset!");
...
static_assert(sizeof(UConnectionCallbackProxy) == 0x000070, "Wrong size on UConnectionCallbackProxy");
...
static_assert(sizeof(UCreateSessionCallbackProxy) == 0x000090, "Wrong size on UCreateSessionCallbackProxy");
...
static_assert(sizeof(UDestroySessionCallbackProxy) == 0x000070, "Wrong size on UDestroySessionCallbackProxy");
...
static_assert(sizeof(UFindSessionsCallbackProxy) == 0x000088, "Wrong size on UFindSessionsCallbackProxy");
...
{
public:
	uint8                                         Pad_1888[0x60];                                    // 0x1888(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpConnection) == 0x0018E8, "Wrong size on UIpConnection");
...
{
public:
	uint8                                         LogPortUnreach : 1;                                // 0x0730(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         AllowPlayerPortUnreach : 1;                        // 0x0730(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_731[0x3];                                      // 0x0731(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        MaxPortCountToTry;                                 // 0x0734(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_738[0x1C];                                     // 0x0738(0x001C)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        ServerDesiredSocketReceiveBufferBytes;             // 0x0754(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        ServerDesiredSocketSendBufferBytes;                // 0x0758(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        ClientDesiredSocketReceiveBufferBytes;             // 0x075C(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        ClientDesiredSocketSendBufferBytes;                // 0x0760(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UIpNetDriver) == 0x000778, "Wrong size on UIpNetDriver");
static_assert(offsetof(UIpNetDriver, MaxPortCountToTry) == 0x000734, "Member 'UIpNetDriver::MaxPortCountToTry' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketReceiveBufferBytes) == 0x000754, "Member 'UIpNetDriver::ServerDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketSendBufferBytes) == 0x000758, "Member 'UIpNetDriver::ServerDesiredSocketSendBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketReceiveBufferBytes) == 0x00075C, "Member 'UIpNetDriver::ClientDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketSendBufferBytes) == 0x000760, "Member 'UIpNetDriver::ClientDesiredSocketSendBufferBytes' has a wrong offset!");
...
static_assert(sizeof(UJoinSessionCallbackProxy) == 0x000128, "Wrong size on UJoinSessionCallbackProxy");
...
public:
	...
	uint8                                         Pad_378[0xA0];                                     // 0x0378(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AOnlineBeaconHost) == 0x000418, "Wrong size on AOnlineBeaconHost");
static_assert(offsetof(AOnlineBeaconHost, ListenPort) == 0x000360, "Member 'AOnlineBeaconHost::ListenPort' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, ClientActors) == 0x000368, "Member 'AOnlineBeaconHost::ClientActors' has a wrong offset!");
...
static_assert(sizeof(UOnlineEngineInterfaceImpl) == 0x000128, "Wrong size on UOnlineEngineInterfaceImpl");
...
static_assert(sizeof(UOnlineSessionClient) == 0x000190, "Wrong size on UOnlineSessionClient");
static_assert(offsetof(UOnlineSessionClient, bIsFromInvite) == 0x000188, "Member 'UOnlineSessionClient::bIsFromInvite' has a wrong offset!");
static_assert(offsetof(UOnlineSessionClient, bHandlingDisconnect) == 0x000189, "Member 'UOnlineSessionClient::bHandlingDisconnect' has a wrong offset!");
...
static_assert(sizeof(UPartyBeaconState) == 0x000078, "Wrong size on UPartyBeaconState");
...
static_assert(offsetof(UPartyBeaconState, Reservations) == 0x000058, "Member 'UPartyBeaconState::Reservations' has a wrong offset!");
...
static_assert(sizeof(ATestBeaconClient) == 0x0003B0, "Wrong size on ATestBeaconClient");
...
static_assert(sizeof(ATestBeaconHost) == 0x000358, "Wrong size on ATestBeaconHost");
...
static_assert(sizeof(UVoipListenerSynthComponent) == 0x000620, "Wrong size on UVoipListenerSynthComponent");
