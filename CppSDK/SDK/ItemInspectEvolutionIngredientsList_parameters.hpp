...
static_assert(offsetof(ItemInspectEvolutionIngredientsList_C_SetupItemLevelRequirement, CallFunc_Conv_IntToText_ReturnValue1) == 0x000030, "Member 'ItemInspectEvolutionIngredientsList_C_SetupItemLevelRequirement::CallFunc_Conv_IntToText_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(ItemInspectEvolutionIngredientsList_C_SetupItemLevelRequirement, K2Node_MakeStruct_FormatArgumentData1) == 0x000088, "Member 'ItemInspectEvolutionIngredientsList_C_SetupItemLevelRequirement::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
...
static_assert(offsetof(ItemInspectEvolutionIngredientsList_C_SetupItemLevelRequirement, CallFunc_Less_IntInt_ReturnValue1) == 0x0000F0, "Member 'ItemInspectEvolutionIngredientsList_C_SetupItemLevelRequirement::CallFunc_Less_IntInt_ReturnValue1' has a wrong offset!");
