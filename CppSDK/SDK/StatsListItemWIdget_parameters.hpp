...
static_assert(sizeof(StatsListItemWIdget_C_GetListItemTooltipWidget) == 0x0000A0, "Wrong size on StatsListItemWIdget_C_GetListItemTooltipWidget");
...
static_assert(offsetof(StatsListItemWIdget_C_GetListItemTooltipWidget, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000090, "Member 'StatsListItemWIdget_C_GetListItemTooltipWidget::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(StatsListItemWIdget_C_GetListItemTooltipWidget, CallFunc_Create_Basic_Tooltip_Output) == 0x000098, "Member 'StatsListItemWIdget_C_GetListItemTooltipWidget::CallFunc_Create_Basic_Tooltip_Output' has a wrong offset!");
...
static_assert(alignof(StatsListItemWIdget_C_Populate_Update) == 0x000008, "Wrong alignment on StatsListItemWIdget_C_Populate_Update");
static_assert(sizeof(StatsListItemWIdget_C_Populate_Update) == 0x000008, "Wrong size on StatsListItemWIdget_C_Populate_Update");
static_assert(offsetof(StatsListItemWIdget_C_Populate_Update, CallFunc_PlayAnimation_ReturnValue) == 0x000000, "Member 'StatsListItemWIdget_C_Populate_Update::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
