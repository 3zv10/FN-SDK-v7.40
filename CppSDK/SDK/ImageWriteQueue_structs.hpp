...
public:
	...
	TDelegate<void(bool bSuccess)>                OnComplete;                                        // 0x0004(0x0010)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
