...
static_assert(offsetof(GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove, K2Node_Event_EventType) == 0x000010, "Member 'GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove::K2Node_Event_EventType' has a wrong offset!");
static_assert(offsetof(GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove, K2Node_Event_Parameters) == 0x000018, "Member 'GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove::K2Node_Event_Parameters' has a wrong offset!");
static_assert(offsetof(GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove, K2Node_SwitchEnum_CmpSuccess) == 0x0000D0, "Member 'GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove, CallFunc_GetActorBounds_Origin) == 0x0000D4, "Member 'GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove::CallFunc_GetActorBounds_Origin' has a wrong offset!");
static_assert(offsetof(GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove, CallFunc_GetActorBounds_BoxExtent) == 0x0000E0, "Member 'GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove::CallFunc_GetActorBounds_BoxExtent' has a wrong offset!");
static_assert(offsetof(GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove, CallFunc_K2_GetActorLocation_ReturnValue) == 0x0000EC, "Member 'GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove, CallFunc_BreakVector_X) == 0x0000F8, "Member 'GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove::CallFunc_BreakVector_X' has a wrong offset!");
static_assert(offsetof(GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove, CallFunc_BreakVector_Y) == 0x0000FC, "Member 'GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove::CallFunc_BreakVector_Y' has a wrong offset!");
static_assert(offsetof(GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove, CallFunc_BreakVector_Z) == 0x000100, "Member 'GCN_HuskDigger_TunnelMove_C_ExecuteUbergraph_GCN_HuskDigger_TunnelMove::CallFunc_BreakVector_Z' has a wrong offset!");
...
static_assert(alignof(GCN_HuskDigger_TunnelMove_C_K2_HandleGameplayCue) == 0x000008, "Wrong alignment on GCN_HuskDigger_TunnelMove_C_K2_HandleGameplayCue");
static_assert(sizeof(GCN_HuskDigger_TunnelMove_C_K2_HandleGameplayCue) == 0x0000C8, "Wrong size on GCN_HuskDigger_TunnelMove_C_K2_HandleGameplayCue");
static_assert(offsetof(GCN_HuskDigger_TunnelMove_C_K2_HandleGameplayCue, MyTarget) == 0x000000, "Member 'GCN_HuskDigger_TunnelMove_C_K2_HandleGameplayCue::MyTarget' has a wrong offset!");
static_assert(offsetof(GCN_HuskDigger_TunnelMove_C_K2_HandleGameplayCue, EventType) == 0x000008, "Member 'GCN_HuskDigger_TunnelMove_C_K2_HandleGameplayCue::EventType' has a wrong offset!");
static_assert(offsetof(GCN_HuskDigger_TunnelMove_C_K2_HandleGameplayCue, Parameters) == 0x000010, "Member 'GCN_HuskDigger_TunnelMove_C_K2_HandleGameplayCue::Parameters' has a wrong offset!");
