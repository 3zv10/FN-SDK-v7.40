...
static_assert(sizeof(ABP_DamageBalloon_Athena_C) == 0x000C10, "Wrong size on ABP_DamageBalloon_Athena_C");
static_assert(offsetof(ABP_DamageBalloon_Athena_C, UberGraphFrame) == 0x000BE0, "Member 'ABP_DamageBalloon_Athena_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_DamageBalloon_Athena_C, ExplosionParticle) == 0x000BE8, "Member 'ABP_DamageBalloon_Athena_C::ExplosionParticle' has a wrong offset!");
static_assert(offsetof(ABP_DamageBalloon_Athena_C, FortHealthBar) == 0x000BF0, "Member 'ABP_DamageBalloon_Athena_C::FortHealthBar' has a wrong offset!");
static_assert(offsetof(ABP_DamageBalloon_Athena_C, DestroyBalloon) == 0x000BF8, "Member 'ABP_DamageBalloon_Athena_C::DestroyBalloon' has a wrong offset!");
static_assert(offsetof(ABP_DamageBalloon_Athena_C, DontPlayDestroyAudio) == 0x000BF9, "Member 'ABP_DamageBalloon_Athena_C::DontPlayDestroyAudio' has a wrong offset!");
static_assert(offsetof(ABP_DamageBalloon_Athena_C, OnBalloonDestroyed) == 0x000C00, "Member 'ABP_DamageBalloon_Athena_C::OnBalloonDestroyed' has a wrong offset!");
