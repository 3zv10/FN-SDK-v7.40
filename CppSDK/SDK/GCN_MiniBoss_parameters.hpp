...
static_assert(sizeof(GCN_MiniBoss_C_OnActive) == 0x0000D8, "Wrong size on GCN_MiniBoss_C_OnActive");
...
static_assert(offsetof(GCN_MiniBoss_C_OnActive, K2Node_DynamicCast_AsEnemy_Pawn_Parent) == 0x0000C8, "Member 'GCN_MiniBoss_C_OnActive::K2Node_DynamicCast_AsEnemy_Pawn_Parent' has a wrong offset!");
static_assert(offsetof(GCN_MiniBoss_C_OnActive, K2Node_DynamicCast_bSuccess) == 0x0000D0, "Member 'GCN_MiniBoss_C_OnActive::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(GCN_MiniBoss_C_OnActive, CallFunc_K2_AttachToComponent_ReturnValue) == 0x0000D1, "Member 'GCN_MiniBoss_C_OnActive::CallFunc_K2_AttachToComponent_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GCN_MiniBoss_C_OverwriteElementalParticles, CallFunc_IsValid_ReturnValue1) == 0x000082, "Member 'GCN_MiniBoss_C_OverwriteElementalParticles::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
...
static_assert(alignof(GCN_MiniBoss_C_SetMiniBossVisibility) == 0x000001, "Wrong alignment on GCN_MiniBoss_C_SetMiniBossVisibility");
static_assert(sizeof(GCN_MiniBoss_C_SetMiniBossVisibility) == 0x000001, "Wrong size on GCN_MiniBoss_C_SetMiniBossVisibility");
static_assert(offsetof(GCN_MiniBoss_C_SetMiniBossVisibility, Visible) == 0x000000, "Member 'GCN_MiniBoss_C_SetMiniBossVisibility::Visible' has a wrong offset!");
