...
static_assert(sizeof(AGCNL_EnvCampFire_Doused_C) == 0x0008B8, "Wrong size on AGCNL_EnvCampFire_Doused_C");
static_assert(offsetof(AGCNL_EnvCampFire_Doused_C, UberGraphFrame) == 0x000880, "Member 'AGCNL_EnvCampFire_Doused_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCNL_EnvCampFire_Doused_C, Fade_Doused_Smoke_Fade_50A77D974140FDA04967E2BABB987458) == 0x000888, "Member 'AGCNL_EnvCampFire_Doused_C::Fade_Doused_Smoke_Fade_50A77D974140FDA04967E2BABB987458' has a wrong offset!");
static_assert(offsetof(AGCNL_EnvCampFire_Doused_C, Fade_Doused_Smoke__Direction_50A77D974140FDA04967E2BABB987458) == 0x00088C, "Member 'AGCNL_EnvCampFire_Doused_C::Fade_Doused_Smoke__Direction_50A77D974140FDA04967E2BABB987458' has a wrong offset!");
static_assert(offsetof(AGCNL_EnvCampFire_Doused_C, Fade_Doused_Smoke) == 0x000890, "Member 'AGCNL_EnvCampFire_Doused_C::Fade_Doused_Smoke' has a wrong offset!");
static_assert(offsetof(AGCNL_EnvCampFire_Doused_C, Row_Duration) == 0x000898, "Member 'AGCNL_EnvCampFire_Doused_C::Row_Duration' has a wrong offset!");
