...
static_assert(offsetof(AnimNotify_PlayForceFeedback_C_Received_Notify, K2Node_DynamicCast_bSuccess1) == 0x000048, "Member 'AnimNotify_PlayForceFeedback_C_Received_Notify::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
