...
static_assert(sizeof(AWM_PinManager_C) == 0x000360, "Wrong size on AWM_PinManager_C");
static_assert(offsetof(AWM_PinManager_C, UberGraphFrame) == 0x000350, "Member 'AWM_PinManager_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AWM_PinManager_C, DefaultSceneRoot) == 0x000358, "Member 'AWM_PinManager_C::DefaultSceneRoot' has a wrong offset!");
