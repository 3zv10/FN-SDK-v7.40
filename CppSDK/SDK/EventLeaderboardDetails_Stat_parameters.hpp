...
static_assert(offsetof(EventLeaderboardDetails_Stat_C_ExecuteUbergraph_EventLeaderboardDetails_Stat, Temp_float_Variable1) == 0x000018, "Member 'EventLeaderboardDetails_Stat_C_ExecuteUbergraph_EventLeaderboardDetails_Stat::Temp_float_Variable1' has a wrong offset!");
