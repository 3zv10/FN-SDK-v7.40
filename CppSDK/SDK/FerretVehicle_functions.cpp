...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// float                                   SavedHeadlightValueForMID_0                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AFerretVehicle_C::SendHeadlightValueToMaterials(float SavedHeadlightValueForMID_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.SavedHeadlightValueForMID_0 = SavedHeadlightValueForMID_0;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// float                                   SavedDamageValueForMID_0                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AFerretVehicle_C::SendDamageValueToMaterials(float SavedDamageValueForMID_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.SavedDamageValueForMID_0 = SavedDamageValueForMID_0;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// float                                   BoostTimeValueForMID_0                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AFerretVehicle_C::SendBoostTimeToMaterials(float BoostTimeValueForMID_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.BoostTimeValueForMID_0 = BoostTimeValueForMID_0;
