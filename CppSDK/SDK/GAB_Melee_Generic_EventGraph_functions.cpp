...
void UGAB_Melee_Generic_EventGraph_C::Get_Is_Actor_B_Within_HalfAngle_Of_Actor_A_Facing(class AActor* Actor_A, class AActor* Actor_B, float Half_Angle_Of_Actor_A_Facing, bool* IsWithinHalfAngle) const
{
	static class UFunction* Func = nullptr;
