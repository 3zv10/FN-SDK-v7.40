...
static_assert(sizeof(UAnimCustomInstance) == 0x000270, "Wrong size on UAnimCustomInstance");
...
static_assert(sizeof(UAnimSequencerInstance) == 0x000270, "Wrong size on UAnimSequencerInstance");
