...
public:
	...
	TDelegate<void(const TArray<class FText>& Names)> K2Node_CreateDelegate_OutputDelegate3;         // 0x0078(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(sizeof(BP_FortLiveStreamGrantWindowExpires_C_ExecuteUbergraph_BP_FortLiveStreamGrantWindowExpires) == 0x0000E8, "Wrong size on BP_FortLiveStreamGrantWindowExpires_C_ExecuteUbergraph_BP_FortLiveStreamGrantWindowExpires");
...
static_assert(offsetof(BP_FortLiveStreamGrantWindowExpires_C_ExecuteUbergraph_BP_FortLiveStreamGrantWindowExpires, CallFunc_PlayAnimation_ReturnValue) == 0x0000B8, "Member 'BP_FortLiveStreamGrantWindowExpires_C_ExecuteUbergraph_BP_FortLiveStreamGrantWindowExpires::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FortLiveStreamGrantWindowExpires_C_ExecuteUbergraph_BP_FortLiveStreamGrantWindowExpires, K2Node_CreateDelegate_OutputDelegate5) == 0x0000C0, "Member 'BP_FortLiveStreamGrantWindowExpires_C_ExecuteUbergraph_BP_FortLiveStreamGrantWindowExpires::K2Node_CreateDelegate_OutputDelegate5' has a wrong offset!");
static_assert(offsetof(BP_FortLiveStreamGrantWindowExpires_C_ExecuteUbergraph_BP_FortLiveStreamGrantWindowExpires, CallFunc_PlayAnimation_ReturnValue1) == 0x0000D0, "Member 'BP_FortLiveStreamGrantWindowExpires_C_ExecuteUbergraph_BP_FortLiveStreamGrantWindowExpires::CallFunc_PlayAnimation_ReturnValue1' has a wrong offset!");
static_assert(offsetof(BP_FortLiveStreamGrantWindowExpires_C_ExecuteUbergraph_BP_FortLiveStreamGrantWindowExpires, CallFunc_K2_SetTimerDelegate_ReturnValue1) == 0x0000D8, "Member 'BP_FortLiveStreamGrantWindowExpires_C_ExecuteUbergraph_BP_FortLiveStreamGrantWindowExpires::CallFunc_K2_SetTimerDelegate_ReturnValue1' has a wrong offset!");
static_assert(offsetof(BP_FortLiveStreamGrantWindowExpires_C_ExecuteUbergraph_BP_FortLiveStreamGrantWindowExpires, CallFunc_NotEqual_IntInt_ReturnValue) == 0x0000E0, "Member 'BP_FortLiveStreamGrantWindowExpires_C_ExecuteUbergraph_BP_FortLiveStreamGrantWindowExpires::CallFunc_NotEqual_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BP_FortLiveStreamGrantWindowExpires_C_Set_Stream_Brush) == 0x000088, "Wrong size on BP_FortLiveStreamGrantWindowExpires_C_Set_Stream_Brush");
...
static_assert(offsetof(BP_FortLiveStreamGrantWindowExpires_C_Update_Expiration_Text, CallFunc_GetTotalSeconds_ReturnValue1) == 0x000014, "Member 'BP_FortLiveStreamGrantWindowExpires_C_Update_Expiration_Text::CallFunc_GetTotalSeconds_ReturnValue1' has a wrong offset!");
...
static_assert(sizeof(BP_FortLiveStreamGrantWindowExpires_C_GetToolTipWidget_0) == 0x000060, "Wrong size on BP_FortLiveStreamGrantWindowExpires_C_GetToolTipWidget_0");
...
static_assert(offsetof(BP_FortLiveStreamGrantWindowExpires_C_GetToolTipWidget_0, CallFunc_GetCurrentInputType_ReturnValue) == 0x000010, "Member 'BP_FortLiveStreamGrantWindowExpires_C_GetToolTipWidget_0::CallFunc_GetCurrentInputType_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_FortLiveStreamGrantWindowExpires_C_GetToolTipWidget_0, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000020, "Member 'BP_FortLiveStreamGrantWindowExpires_C_GetToolTipWidget_0::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FortLiveStreamGrantWindowExpires_C_GetToolTipWidget_0, CallFunc_MakeLiteralText_ReturnValue) == 0x000028, "Member 'BP_FortLiveStreamGrantWindowExpires_C_GetToolTipWidget_0::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FortLiveStreamGrantWindowExpires_C_GetToolTipWidget_0, CallFunc_MakeLiteralText_ReturnValue1) == 0x000040, "Member 'BP_FortLiveStreamGrantWindowExpires_C_GetToolTipWidget_0::CallFunc_MakeLiteralText_ReturnValue1' has a wrong offset!");
static_assert(offsetof(BP_FortLiveStreamGrantWindowExpires_C_GetToolTipWidget_0, CallFunc_Create_Basic_Tooltip_Output) == 0x000058, "Member 'BP_FortLiveStreamGrantWindowExpires_C_GetToolTipWidget_0::CallFunc_Create_Basic_Tooltip_Output' has a wrong offset!");
