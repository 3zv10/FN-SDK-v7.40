...
static_assert(sizeof(ABP_CameraLens_CrackExit_C) == 0x000400, "Wrong size on ABP_CameraLens_CrackExit_C");
static_assert(offsetof(ABP_CameraLens_CrackExit_C, Portal) == 0x0003F0, "Member 'ABP_CameraLens_CrackExit_C::Portal' has a wrong offset!");
