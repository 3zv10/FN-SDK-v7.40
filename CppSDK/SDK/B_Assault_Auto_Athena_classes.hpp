...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"B_Assault_Auto_Athena_C">();
	}
	static class AB_Assault_Auto_Athena_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AB_Assault_Auto_Athena_C>();
	}
};
static_assert(alignof(AB_Assault_Auto_Athena_C) == 0x000008, "Wrong alignment on AB_Assault_Auto_Athena_C");
static_assert(sizeof(AB_Assault_Auto_Athena_C) == 0x000DE8, "Wrong size on AB_Assault_Auto_Athena_C");
