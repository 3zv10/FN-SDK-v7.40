...
static_assert(sizeof(ItemInspectEvolveRarityIngredientsList_C_SetIngredients) == 0x000088, "Wrong size on ItemInspectEvolveRarityIngredientsList_C_SetIngredients");
...
static_assert(offsetof(ItemInspectEvolveRarityIngredientsList_C_SetIngredients, CallFunc_Create_ReturnValue) == 0x000070, "Member 'ItemInspectEvolveRarityIngredientsList_C_SetIngredients::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInspectEvolveRarityIngredientsList_C_SetIngredients, CallFunc_Array_Length_ReturnValue) == 0x000078, "Member 'ItemInspectEvolveRarityIngredientsList_C_SetIngredients::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInspectEvolveRarityIngredientsList_C_SetIngredients, CallFunc_Less_IntInt_ReturnValue) == 0x00007C, "Member 'ItemInspectEvolveRarityIngredientsList_C_SetIngredients::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInspectEvolveRarityIngredientsList_C_SetIngredients, CallFunc_AddChild_ReturnValue) == 0x000080, "Member 'ItemInspectEvolveRarityIngredientsList_C_SetIngredients::CallFunc_AddChild_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(ItemInspectEvolveRarityIngredientsList_C_Add_XP_Cost_to_Upgrade) == 0x000080, "Wrong size on ItemInspectEvolveRarityIngredientsList_C_Add_XP_Cost_to_Upgrade");
...
static_assert(offsetof(ItemInspectEvolveRarityIngredientsList_C_Add_XP_Cost_to_Upgrade, CallFunc_Create_ReturnValue) == 0x000070, "Member 'ItemInspectEvolveRarityIngredientsList_C_Add_XP_Cost_to_Upgrade::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInspectEvolveRarityIngredientsList_C_Add_XP_Cost_to_Upgrade, CallFunc_AddChild_ReturnValue) == 0x000078, "Member 'ItemInspectEvolveRarityIngredientsList_C_Add_XP_Cost_to_Upgrade::CallFunc_AddChild_ReturnValue' has a wrong offset!");
