...
static_assert(sizeof(UGameplayTasksComponent) == 0x000168, "Wrong size on UGameplayTasksComponent");
...
static_assert(offsetof(UGameplayTasksComponent, TaskPriorityQueue) == 0x000118, "Member 'UGameplayTasksComponent::TaskPriorityQueue' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, TickingTasks) == 0x000138, "Member 'UGameplayTasksComponent::TickingTasks' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, KnownTasks) == 0x000148, "Member 'UGameplayTasksComponent::KnownTasks' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, OnClaimedResourcesChange) == 0x000158, "Member 'UGameplayTasksComponent::OnClaimedResourcesChange' has a wrong offset!");
