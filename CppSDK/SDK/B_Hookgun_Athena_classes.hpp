...
static_assert(sizeof(AB_Hookgun_Athena_C) == 0x000E00, "Wrong size on AB_Hookgun_Athena_C");
static_assert(offsetof(AB_Hookgun_Athena_C, Timer) == 0x000DE8, "Member 'AB_Hookgun_Athena_C::Timer' has a wrong offset!");
static_assert(offsetof(AB_Hookgun_Athena_C, Player_Pawn) == 0x000DF0, "Member 'AB_Hookgun_Athena_C::Player_Pawn' has a wrong offset!");
static_assert(offsetof(AB_Hookgun_Athena_C, Debug) == 0x000DF8, "Member 'AB_Hookgun_Athena_C::Debug' has a wrong offset!");
