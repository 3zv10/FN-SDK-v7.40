...
public:
	...
	uint8                                         Pad_5A8[0x68];                                     // 0x05A8(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMotionControllerComponent, Hand) == 0x000574, "Member 'UMotionControllerComponent::Hand' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, MotionSource) == 0x000578, "Member 'UMotionControllerComponent::MotionSource' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, CurrentTrackingStatus) == 0x000584, "Member 'UMotionControllerComponent::CurrentTrackingStatus' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, bDisplayDeviceModel) == 0x000585, "Member 'UMotionControllerComponent::bDisplayDeviceModel' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, DisplayModelSource) == 0x000588, "Member 'UMotionControllerComponent::DisplayModelSource' has a wrong offset!");
...
static_assert(offsetof(UMotionControllerComponent, DisplayComponent) == 0x000610, "Member 'UMotionControllerComponent::DisplayComponent' has a wrong offset!");
