...
static_assert(sizeof(UJoinServer_C) == 0x0003E0, "Wrong size on UJoinServer_C");
static_assert(offsetof(UJoinServer_C, UberGraphFrame) == 0x000360, "Member 'UJoinServer_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, BuildWatermark) == 0x000368, "Member 'UJoinServer_C::BuildWatermark' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, MainContentStack) == 0x000370, "Member 'UJoinServer_C::MainContentStack' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, ManualStart) == 0x000378, "Member 'UJoinServer_C::ManualStart' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, TutorialCanceledConfirmActions) == 0x000380, "Member 'UJoinServer_C::TutorialCanceledConfirmActions' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, NoneAction) == 0x000390, "Member 'UJoinServer_C::NoneAction' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, SoundPromptTutorial) == 0x000398, "Member 'UJoinServer_C::SoundPromptTutorial' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, MatchmakingAttempts) == 0x0003A0, "Member 'UJoinServer_C::MatchmakingAttempts' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, TutorialMatchmakingStarted) == 0x0003A4, "Member 'UJoinServer_C::TutorialMatchmakingStarted' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, ProgressWidget) == 0x0003A8, "Member 'UJoinServer_C::ProgressWidget' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, TutorialWindow) == 0x0003B0, "Member 'UJoinServer_C::TutorialWindow' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, AbandonSession) == 0x0003B8, "Member 'UJoinServer_C::AbandonSession' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, MenuWidget) == 0x0003C0, "Member 'UJoinServer_C::MenuWidget' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, MaxMatchmakingAttempts) == 0x0003C8, "Member 'UJoinServer_C::MaxMatchmakingAttempts' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, RejoinWindow) == 0x0003D0, "Member 'UJoinServer_C::RejoinWindow' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, RejoinAttemptCount) == 0x0003D8, "Member 'UJoinServer_C::RejoinAttemptCount' has a wrong offset!");
